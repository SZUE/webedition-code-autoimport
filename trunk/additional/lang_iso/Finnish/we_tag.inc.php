...
$l_we_tag['ifHasShopVariants']['description'] = "we:ifHasShopVariants voi n‰ytt‰‰ sis‰ltˆ‰ riippuen muuttujien olemassaolosta objektissa tai dokumentissa. Voidaan kontrolloida we:listview type='shopVariant'.";
...
$l_we_tag['navigationField']['description'] = "we:navigationField:i‰ k‰ytet‰‰n we:navigationEntryn sis‰ll‰ tulostettaessa navigaation eri arvoja.";
...
$l_we_tag['votingField']['description'] = "The we:votingField -tagia tarvitaan esitt‰m‰‰n ‰‰nestys. \"Nimi\" m‰‰rittelee mit‰ esitet‰‰n. \"Tyyppi\", m‰‰rittelee kuinka se esitet‰‰n. Hyv‰ksytt‰v‰t nimi-tyyppi yhdistelm‰t ovat: kysymys - teksti; vastaus - teksti, radio, valinta; vastaus - lukum‰‰r‰, prosentti, yhteens‰; id - vastaus, valinta, radio, ‰‰nestys;";
