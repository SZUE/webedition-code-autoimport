...
$GLOBALS["l_rebuild"]["rebuild_tmptable"] = "Bewaar tijdelijke tabel opnieuw";
$GLOBALS["l_rebuild"]["rebuild_objects"] = "Objecten";
$GLOBALS["l_rebuild"]["rebuild_index"] = "Index-tabel";
$GLOBALS["l_rebuild"]["rebuild_all"] = "Alle documenten en sjablonen";
$GLOBALS["l_rebuild"]["rebuild_templates"] = "Alle sjablonen";
$GLOBALS["l_rebuild"]["rebuild_filter"] = "Statische webEdition pagina's";
$GLOBALS["l_rebuild"]["rebuild_thumbnails"] = "Herbouw - genereer thumbnails";
$GLOBALS["l_rebuild"]["txt_rebuild_documents"] = "Met deze optie worden de documenten en sjablonen die opgeslagen zijn in de database geschreven naar het bestandssysteem.";
$GLOBALS["l_rebuild"]["txt_rebuild_objects"] = "Kies deze optie om de object tabellen te herschrijven. Dit is alleen nodig wanneer de object tabellen incorrect zijn.";
$GLOBALS["l_rebuild"]["txt_rebuild_index"] = "Indien na een zoekopdracht sommmige documenten niet gevonden kunnen worden of meerdere keren gevonden worden, dan kunt u de index tabel hier herschrijven.";
$GLOBALS["l_rebuild"]["txt_rebuild_thumbnails"] = "Hier kunt u de thumbnails van uw afbeeldingen herschrijven.";
$GLOBALS["l_rebuild"]["txt_rebuild_all"] = "Met deze optie worden alle documenten en sjablonen herschreven.";
...
$GLOBALS["l_rebuild"]["catAnd"] = "EN aaneenschakeling";
$GLOBALS["l_rebuild"]["finished"] = "Het heropbouwen was succesvol!";
$GLOBALS["l_rebuild"]["nothing_to_rebuild"] = "Er zijn geen documenten die voldoen aan de criteria!";
$GLOBALS["l_rebuild"]["no_thumbs_selected"] = "Kies a.u.b. tenminste ייn thumbnail!";
