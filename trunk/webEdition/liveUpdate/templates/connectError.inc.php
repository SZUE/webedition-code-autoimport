...
$errorMessage .= "</li>";
$errorMessage .= "<li>".g_l('liveUpdate','[connect][addressResolution]')." ".g_l('liveUpdate','[connect][updateServer]').":</li>";
$errorMessage .= "<ul>";
$errorMessage .= "<li>".g_l('liveUpdate','[connect][hostName]').": ".LIVEUPDATE_SERVER."</li>";
