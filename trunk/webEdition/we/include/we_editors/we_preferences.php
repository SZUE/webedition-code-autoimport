...
EOF;
				...
				$_information = htmlAlertAttentionBox($l_prefs["langlink_abandoned_options"], 2, 450, false);
...
$_needed_JavaScript .= "
			...
			if (we_hasPerm("ADMINISTRATOR")) {
				...
				$_template_error_handling_table->setCol(0, 0, null, we_forms::checkbox(1, get_value("disable_template_tag_check"), "disable_template_tag_check", $l_prefs["disable_template_tag_check"]));
				$_template_error_handling_table->setCol(1, 0, null,we_forms::checkbox(1, get_value("disable_template_code_check"), "disable_template_code_check", $l_prefs["disable_template_code_check"]));
			...
			$_error_display_table->setCol(0, 0, array('class' => 'defaultfont', 'style' => 'padding-left: 25px;'), htmlAlertAttentionBox($l_prefs['error_notices_warning'],1,260));

			$_error_display_table->setCol(1, 0, null, we_forms::checkbox(1, get_value("error_display_errors"), "error_display_errors", $l_prefs["error_display"], false, "defaultfont", "", !get_value("we_error_handler")));
			$_error_display_table->setCol(2, 0, null, getPixel(1, 5));
			$_error_display_table->setCol(3, 0, null, we_forms::checkbox(1, get_value("error_log_errors"), "error_log_errors", $l_prefs["error_log"], false, "defaultfont", "", !get_value("we_error_handler")));
			$_error_display_table->setCol(4, 0, null, getPixel(1, 5));
			$_error_display_table->setCol(5, 0, null, we_forms::checkbox(1, get_value("error_mail_errors"), "error_mail_errors", $l_prefs["error_mail"], false, "defaultfont", "set_state_mail();", !get_value("we_error_handler")));
