...
//key => type,default-val, permission. default true
	...
	'conf' => array(
		...
		'DB_HOST' => array('Domain or IP address of the database server', we_base_request::RAW, 'localhost'),
		'DB_DATABASE' => array('Name of database being used by webEdition', we_base_request::STRING, 'webedition'),
		'DB_USER' => array('Username to access the database', we_base_request::STRING, 'root'),
		'DB_PASSWORD' => array('Password to access the database', we_base_request::RAW, 'root'),
		'DB_SET_CHARSET' => array('connection charset to db', we_base_request::STRING, 'utf8'),
		'TBL_PREFIX' => array('Prefix of tables in database for this webEdition.', we_base_request::STRING, ''),
		'DB_CHARSET' => array('Charset of tables in database for this webEdition.', we_base_request::STRING, ''),
		'DB_COLLATION' => array('Collation of tables in database for this webEdition.', we_base_request::STRING, ''),
		'WE_LANGUAGE' => array('Original language of this version of webEdition, used for login-screen', we_base_request::STRING, 'English'),
		'WE_BACKENDCHARSET' => array('Original backend charset of this version of webEdition, used for login-screen', we_base_request::STRING, 'UTF-8'),
	),
	'other' => array(
