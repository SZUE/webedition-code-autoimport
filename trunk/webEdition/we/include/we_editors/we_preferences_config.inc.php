...
//system
		...
		'SYSTEM_WE_SESSION_CRYPT' => array('crypt we session before save', we_base_request::BOOL, true),
// accessibility
...
//key => type,default-val, permission. default true
		...
		'editorFont' => array(we_base_request::STRING, ''),
		...
		'editorTooltips' => array(we_base_request::STRING, false), //tags
		'editorTooltipsIDs' => array(we_base_request::BOOL, false), //IDS
		'editorTooltipFont' => array(we_base_request::STRING, ''),
		...
		'seem_start_weapp' => array(we_base_request::STRING, 0),
		...
		//'FileFilter' => array(we_base_request::RAW, 0), //????
		...
		'juploadPath' => array(we_base_request::FILE, ''),
