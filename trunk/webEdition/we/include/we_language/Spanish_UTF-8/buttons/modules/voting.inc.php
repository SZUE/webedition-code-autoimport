...
$l_button['new_voting']['value'] = 'Nueva votación';
$l_button['new_voting']['alt']   = 'Crear nueva votación ...';
$l_button['new_voting']['width'] = 150;

$l_button['new_voting_group']['value'] = 'New group';
$l_button['new_voting_group']['alt']   = 'Crear nuevo grupo ...';
$l_button['new_voting_group']['width'] = 150;

$l_button['reset_score']['value'] = 'Reset scores';
$l_button['reset_score']['alt']   = 'Restaurar resultados ...';
