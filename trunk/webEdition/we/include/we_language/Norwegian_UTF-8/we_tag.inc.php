...
$l_we_tag['answers']['description'] = "This tag displays the response possibilities of a voting.";
...
$l_we_tag['back']['description'] = "The we:back tag creates an HTML link tag that references the previous we:listview page. The tag links any content found between the start tag and the end tag.";
...
$l_we_tag['colorChooser']['description'] = "The we:colorChooser tag creates an input field for choosing a color value.";
$l_we_tag['condition']['description'] = "This tag is used together with &lt;we:conditionAdd&gt; to dynamically add a condition to the attribute \"condition\" in a &lt;we:listview type=\"object\"&gt;. Conditions may be interlaced.";
$l_we_tag['condition']['defaultvalue'] = "&lt;we:conditionAdd field=\"Type\" var=\"type\" compare=\"=\"/&gt;";
$l_we_tag['conditionAdd']['description'] = "This tag is used to add a new rule or condition within a &lt;we:condition&gt; block.";
$l_we_tag['conditionAnd']['description'] = "This tag is used to add conditions within a &lt;we:condition&gt;. This is a logical AND, meaning that both existing conditions must be fulfilled.";
$l_we_tag['conditionOr']['description'] = "This tag is used to add conditions within a &lt;we:condition&gt;. This is a logical OR, meaning that either one or the other of the conditions must be fulfilled.";
$l_we_tag['content']['description'] = "&lt;we:content /&gt; is only used inside a mastertemplate. It determines the place where the content of the template is used in the mastertemplate.";
$l_we_tag['controlElement']['description'] = "The tag we:controlElement can maniluate control elements in the edit view of a document. Buttons can be hidden. Checkboxes can be disabled, checked and/or hidden.";
...
$l_we_tag['delete']['description'] = "This tag is used to delete webEdition documents accessed via &lt;we:a edit=\"document\" delete=\"true\"&gt; or &lt;we:a edit=\"object\" delete=\"true\"&gt;.";
$l_we_tag['deleteShop']['description'] = "The we:deleteShop tag deletes the complete shopping cart.";
$l_we_tag['description']['description'] = "The we:description tag generates a description meta tag. If the description field in the Properties view is empty, the content placed between the start tag and the end tag will be used as the default description.";
$l_we_tag['description']['defaultvalue'] = "";
$l_we_tag['DID']['description'] = "This tag returns the ID of a webEdition document.";
$l_we_tag['docType']['description'] = "This tag returns the document type of a webEdition document.";
$l_we_tag['else']['description'] = "This tag is used to add alternative conditions within an if-type tag e.g. &lt;we:ifEditmode&gt;, &lt;we:ifNotVar&gt;, &lt;we:ifNotEmpty&gt;, &lt;we:ifFieldNotEmpty&gt;";
$l_we_tag['field']['description'] = "This tag inserts the content of the field that has the name defined in the \"name\" attribute into listviews. It may only be used between the start tag and end tag of we:repeat.";
...
$l_we_tag['form']['description'] = "The we:form tag is used to search and mail forms. It works in the same fashion as the normal HTML form tag, but allows the parser to insert additional hidden fields.";
$l_we_tag['form']['defaultvalue'] = "";
$l_we_tag['formfield']['description'] = "This tag is used to generate fields in a front end form.";
...
$l_we_tag['hidden']['description'] = "The we:hidden tag creates a hidden input tag holding the value of the global PHP variable with the same name. Use this tag if you want to forward incoming variables.";
$l_we_tag['hidePages']['description'] = "The we:hidePages tag allows to disable some modes of a document. You can use this tag i.e. , to restrict access to the properity page of a document. In this case, it is not possible to park this document any more.";
$l_we_tag['href']['description'] = "The we:href tag creates a URL that can be entered in edit mode.";
$l_we_tag['icon']['description'] = "The we:icon tag creates an HTML tag that references an internal webEdition icon that has the ID listed below. With this tag, you can include an icon that is displayed in the Internet Explorer, Mozilla, Safari and Opera while book marking your home page.";
$l_we_tag['ifBack']['description'] = "This tag is used between the start and end tags of &lt;we:listview&gt;. Everything between the start and end tags of this tag is displayed only if a previous page exists. For example, you can use this tag on the second page of a 20 item listview where 5 items are displayed per page.";
...
$l_we_tag['ifCurrentDate']['description'] = "This tag highlights the current day within a calendar-listview.";
...
$l_we_tag['ifEditmode']['description'] = "This tag is used to display the enclosed content only in edit mode.";
$l_we_tag['ifEditmode']['defaultvalue'] = "";
$l_we_tag['ifEmailExists']['description'] = "Contents enclosed by this tag are only displayed if a specified email address is in the newsletter address list.";
$l_we_tag['ifEmailExists']['defaultvalue'] = "";
$l_we_tag['ifEmailInvalid']['description'] = "Content enclosed by this tag is only visible if a particular email is incorrect in its syntax.";
$l_we_tag['ifEmailInvalid']['defaultvalue'] = "";
$l_we_tag['ifEmailNotExists']['description'] = "Contents enclosed by this tag are only displayed if the email address in question is not in the newsletter address list.";
$l_we_tag['ifEmailNotExists']['defaultvalue'] = "";
$l_we_tag['ifEmpty']['description'] = "The we:ifEmpty tag ensures that everything located between the start tag and the end tag is only displayed if the field having the same name as entered under \"match\" is empty. The type of field must be specified in the attribute \"type\" if it is an \"img\", \"flashmovie\" or \"href\" field.";
...
$l_we_tag['ifFemale']['description'] = "Content enclosed by this tag only appears if the user selects the female salutation.";
$l_we_tag['ifFemale']['defaultvalue'] = "";
$l_we_tag['ifField']['description'] = "This tag is used between the start tag and end tag of we:repeat. Everything between the start and end tags of this tag is displayed only if the value of the attribut \"match\" is identical with the value of database field of the associated listview entry.";
$l_we_tag['ifField']['defaultvalue'] = "";
$l_we_tag['ifFieldEmpty']['description'] = "The we:ifFieldEmpty tag ensures that everything located between the start tag and the end tag is only displayed if the listview field with the name listed in \"match\" is empty. The type of field must be specified in the attribute \"type\" if it is an \"img\", \"flashmovie\" or \"href\" field.";
$l_we_tag['ifFieldEmpty']['defaultvalue'] = "";
$l_we_tag['ifFieldNotEmpty']['description'] = "The we:ifFieldNotEmpty tag ensures that everything located between the start tag and the end tag is only displayed if the listview field with the name listed in \"match\" is not empty. The type of field must be specified in the attribute \"type\" if it is an \"img\", \"flashmovie\" or \"href\" field.";
$l_we_tag['ifFieldNotEmpty']['defaultvalue'] = "";
$l_we_tag['ifFound']['description'] = "Content enclosed by this tag is only displayed if documents are found within a &lt;we:listview&gt;.";
$l_we_tag['ifFound']['defaultvalue'] = "";
$l_we_tag['ifHasChildren']['description'] = "Within the &lt;we:repeat&gt; tag &lt;we:ifHasChildren&gt; is used to query if a category(folder) has child categories.";
$l_we_tag['ifHasChildren']['defaultvalue'] = "";
$l_we_tag['ifHasCurrentEntry']['description'] = "we:ifHasCurrentEntry can be used within we:navigationEntry type=\"folder\" to show content, only if the navigation folder contains the activ entry";
$l_we_tag['ifHasCurrentEntry']['defaultvalue'] = "";
$l_we_tag['ifHasEntries']['description'] = "we:ifHasEntries can be used within we:navigationEntry to show content only, if the navigation entry contains entries.";
$l_we_tag['ifHasEntries']['defaultvalue'] = "";
$l_we_tag['ifHasShopVariants']['description'] = "The tag we:ifHasShopVariants can display content depending on the existance of variants in an object or document. With this, it can be controlled whether a &lt;we:listview type=\"shopVariant\"&gt; should be displayed at all.";
$l_we_tag['ifHasShopVariants']['defaultvalue'] = "";
$l_we_tag['ifHtmlMail']['description'] = "Content enclosed by this tag is only displayed if the format of a newsletter is HTML.";
...
$l_we_tag['ifLastCol']['description'] = "&lt;we:ifLastCol&gt; can detect the last col of a table row, when using the table functions of a &lt;we:listview&gt;";
$l_we_tag['ifLastCol']['defaultvalue'] = "";
$l_we_tag['ifLoginFailed']['description'] = "Content enclosed by this tag is only displayed if a login failed.";
$l_we_tag['ifLoginFailed']['defaultvalue'] = "";
$l_we_tag['ifMailingListEmpty']['description'] = "Content enclosed by this tag is only displayed if the user has not selected any newsletter.";
$l_we_tag['ifMailingListEmpty']['defaultvalue'] = "";
$l_we_tag['ifMale']['description'] = "Content enclosed by this tag is only displayed if the user is male. This tag is used for the salutation in newsletters.";
$l_we_tag['ifMale']['defaultvalue'] = "";
$l_we_tag['ifNew']['description'] = "Content enclosed by this tag is only displayed in a new webEdition document or object.";
$l_we_tag['ifNew']['defaultvalue'] = "";
$l_we_tag['ifNext']['description'] = "Content enclosed by this tag is displayed only if a next page of items is available in a &lt;we:listview&gt;";
$l_we_tag['ifNext']['defaultvalue'] = "";
$l_we_tag['ifNoJavaScript']['description'] = "This tag redirects a page to a specified ID if the browser used does not provide JavaScript support or if JavaScript support is deactivated. This tag can only appear in the &lt;head&gt; section of the template.";
$l_we_tag['ifNotCaptcha']['description'] = "Content enclosed by this tag is only displayed if the code entered by the user is not valid.";
$l_we_tag['ifNotCaptcha']['defaultvalue'] = "";
$l_we_tag['ifNotDeleted']['description'] = "Content enclosed by this tag is only displayed if a webEdition document or object could not be deleted by &lt;we:delete/&gt;";
$l_we_tag['ifNotDeleted']['defaultvalue'] = "";
$l_we_tag['ifNotDoctype']['description'] = "";
$l_we_tag['ifNotDoctype']['defaultvalue'] = "";
$l_we_tag['ifNotEditmode']['description'] = "Content enclosed by this tag is not displayed in edit mode.";
$l_we_tag['ifNotEditmode']['defaultvalue'] = "";
$l_we_tag['ifNotEmpty']['description'] = "The we:ifNotEmpty tag ensures that everything located between the start tag and the end tag is only displayed if the field having the same name as entered under \"match\" is not empty. The type of field must be specified in the attribute \"type\", if it is a \"img\", \"flashmovie\" or \"href\" field.";
...
$l_we_tag['ifNotField']['description'] = "This tag is used between the start tag and end tag of we:repeat. Everything between the start and end tags of this tag is displayed only if the value of the attribut \"match\" is not identical with the value of database field of the associated listview entry.";
$l_we_tag['ifNotField']['defaultvalue'] = "";
$l_we_tag['ifNotFound']['description'] = "Content enclosed by this tag is displayed only if nothing is found by a &lt;we:listview&gt;.";
$l_we_tag['ifNotFound']['defaultvalue'] = "";
$l_we_tag['ifNotHtmlMail']['description'] = "Content enclosed by this tag is only displayed in an HTML newsletter document.";
$l_we_tag['ifNotHtmlMail']['defaultvalue'] = "";
$l_we_tag['ifNotNew']['description'] = "Content enclosed by this tag is only displayed in an old webEdition document or object.";
...
$l_we_tag['ifNotRegisteredUser']['description'] = "Checks, if user is not registered.";
$l_we_tag['ifNotRegisteredUser']['defaultvalue'] = "";
$l_we_tag['ifNotReturnPage']['description'] = "Content enclosed by this tag will only be displayed after creation / modification and if the return value \"return\" from &lt;we:a edit=\"true\"&gt; is \"false\" or not set.";
$l_we_tag['ifNotReturnPage']['defaultvalue'] = "";
$l_we_tag['ifNotSearch']['description'] = "By setting the &lt;we:ifNotSearch&gt;-tag, the contents between the start- and endtag are only displayed, if no search term has been transmitted by &lt;we:search&gt; or was empty. If the attribute \"set\" is set to \"true\", only the request-variable of &lt;we:search&gt; is validatetd for not being set.";
$l_we_tag['ifNotSearch']['defaultvalue'] = "";
$l_we_tag['ifNotSeeMode']['description'] = "This tag is used to display the enclosed content only outside the seeMode.";
...
$l_we_tag['ifNotTemplate']['description'] = "Show enclosed content only if the current document is not based on the given template.<br /><br />You'll find further information in the reference of the tag we:ifTemplate.";
$l_we_tag['ifNotTemplate']['defaultvalue'] = "";
$l_we_tag['ifNotTop']['description'] = "The enclosed content is only displayed if this tag is located in an included document.";
$l_we_tag['ifNotTop']['defaultvalue'] = "";
$l_we_tag['ifNotUnsubscribe']['description'] = "Content enclosed by this tag is only displayed if an unsubscribe request does not work as it should. This tag must appear in the template (for unsubscription) after a &lt;we:addDellnewsletterEmail&gt;.";
$l_we_tag['ifNotUnsubscribe']['defaultvalue'] = "";
$l_we_tag['ifNotVar']['description'] = "The we:ifNotVar tag ensures that everything located between the start tag and the end tag is not displayed if the variable with the name \"name\" has the same value as entered under \"match\". The type of variable can be specified in the attribute \"type\".";
$l_we_tag['ifNotVar']['defaultvalue'] = "";
$l_we_tag['ifNotVarSet']['description'] = "Contents enclosed by this tag are only displayed if the variable named \"name\" is not set. Note: \"Not set\" is not the same as \"empty\"!";
$l_we_tag['ifNotVarSet']['defaultvalue'] = "";
$l_we_tag['ifNotVote']['description'] = "Everything in between the start- and endtag is only displayed, if the voting was not saved. The attribute type specifies the type of the error.";
$l_we_tag['ifNotVote']['defaultvalue'] = "";
$l_we_tag['ifNotWebEdition']['description'] = "Content enclosed by this tag is only visible from outside webEdition.";
$l_we_tag['ifNotWebEdition']['defaultvalue'] = "";
$l_we_tag['ifNotWorkspace']['description'] = "Checks, whether the document is NOT located in the workspace specified in \"path\".";
$l_we_tag['ifNotWorkspace']['defaultvalue'] = "";
$l_we_tag['ifNotWritten']['description'] = "Contents enclosed by this tag are only displayed if an error occurs while writing a webEdition document or object using the &lt;we:write&gt; tag.";
$l_we_tag['ifNotWritten']['defaultvalue'] = "";
$l_we_tag['ifObject']['description'] = "Content enclosed by this tag is only displayed if the indvidual entry found by &lt;we:listview type=\"search\"&gt; is an object.";
...
$l_we_tag['ifRegisteredUser']['description'] = "Checks, if user is registered.";
$l_we_tag['ifRegisteredUser']['defaultvalue'] = "";
$l_we_tag['ifRegisteredUserCanChange']['description'] = "Content enclosed by this tag will only be displayed if a registered used who is logged in is allowed to edit the current webEdition document or object. In a listview the current document or object itteration is used.";
$l_we_tag['ifRegisteredUserCanChange']['defaultvalue'] = "";
$l_we_tag['ifReturnPage']['description'] = "Content enclosed by this tag is only displayed after a webEdition document or object is created or modified and the returned result \"return\" from &lt;we:a edit=\"document\"&gt; or &lt;we:a edit=\"object\"&gt; is \"true\".";
$l_we_tag['ifReturnPage']['defaultvalue'] = "";
$l_we_tag['ifSearch']['description'] = "By setting the &lt;we:ifSearch&gt;-tag, the contents between start- and endtag are only displayed, if a search term has been transmitted by &lt;we:search&gt; and is not empty. If the attribute \"set\" is set to \"true\", only the request-variable of &lt;we:search&gt; is validatetd for not being set.";
$l_we_tag['ifSearch']['defaultvalue'] = "";
$l_we_tag['ifSeeMode']['description'] = "This tag is used to display the enclosed content only in seeMode.";
$l_we_tag['ifSeeMode']['defaultvalue'] = "";
$l_we_tag['ifSelf']['description'] = "The we:ifSelf tag ensures that the content located between the start tag and the end tag will only be displayed if the document in question is specified with the attribute ID in the tag. If the tag is not located within we:linklist or we:listdir tags, \"id\" is a required field!";
$l_we_tag['ifSelf']['defaultvalue'] = "";
$l_we_tag['ifShopEmpty']['description'] = "Everything between the start- and endtag will be shown if the shopping cart is empty.";
$l_we_tag['ifShopEmpty']['defaultvalue'] = "";
$l_we_tag['ifShopNotEmpty']['description'] = "Everything between the start- and endtag will be shown if the shopping cart is not empty.";
...
$l_we_tag['ifTop']['description'] = "The enclosed content is only displayed if this tag is not located in an included document.";
$l_we_tag['ifTop']['defaultvalue'] = "";
$l_we_tag['ifUnsubscribe']['description'] = "Content enclosed by this tag is only displayed if unsubscription of the newsletter was successful. It must be used in a subscription template after a &lt;we:addDellnewsletterEmail&gt; tag.";
$l_we_tag['ifUnsubscribe']['defaultvalue'] = "";
$l_we_tag['ifUserInputEmpty']['description'] = "Contents enclosed by this tag is only displayed is the target user input field is empty.";
$l_we_tag['ifUserInputEmpty']['defaultvalue'] = "";
$l_we_tag['ifUserInputNotEmpty']['description'] = "Contents enclosed by this tag is only displayed is the target user input field is not empty.";
$l_we_tag['ifUserInputNotEmpty']['defaultvalue'] = "";
$l_we_tag['ifVar']['description'] = "The we:ifVar tag ensures that everything located between the start tag and the end tag is only displayed if the variable with the name \"name\" has the same value as entered under \"match\". The type of variable can be specified in the attribute \"type\".";
$l_we_tag['ifVar']['defaultvalue'] = "";
$l_we_tag['ifVarEmpty']['description'] = "Content enclosed by this tag is only displayed if the variable named in attribute \"match\" is empty.";
$l_we_tag['ifVarEmpty']['defaultvalue'] = "";
$l_we_tag['ifVarNotEmpty']['description'] = "Content enclosed by this tag is only displayed if the variable named in attribute \"match\" is not empty.";
$l_we_tag['ifVarNotEmpty']['defaultvalue'] = "";
$l_we_tag['ifVarSet']['description'] = "Content enclosed by this tag is only displayed if the target variable is set. Note: \"Set\" is not the same as \"not empty\"!";
$l_we_tag['ifVarSet']['defaultvalue'] = "";
$l_we_tag['ifVote']['description'] = "Everything in between the start- and endtag is only displayed, if the voting was successfully saved.";
$l_we_tag['ifVote']['defaultvalue'] = "";
$l_we_tag['ifVoteActive']['description'] = "Any content between the start- and endtag is only displayed, if the voting has not expired.";
$l_we_tag['ifVoteActive']['defaultvalue'] = "";
$l_we_tag['ifWebEdition']['description'] = "Content enclosed by this tag is only displayed within webEdition, but not on the finished document. This tag is used for user prompts, etc.";
$l_we_tag['ifWebEdition']['defaultvalue'] = "";
$l_we_tag['ifWorkspace']['description'] = "Checks, whether the document is located in the workspace specified in \"path\".";
...
$l_we_tag['js']['description'] = "The we:js tag creates an HTML tag that references an internal webEdition JavaScript document that has the ID listed below. You can define JavaScripts in a separate file.";
$l_we_tag['keywords']['description'] = "The we:keywords tag generates a keywords meta tag. If the keywords field in the \"Property\" view is empty, the content placed between the start tag and the end tag will be used as the default keywords. Otherwise, the keywords from the Properties view will be entered.";
...
$l_we_tag['listviewPageNr']['description'] = "This tag returns the number of the current page of a &lt;we:listview&gt;.";
$l_we_tag['listviewPages']['description'] = "This tag returns the number of pages of a &lt;we:listview&gt;.";
$l_we_tag['listviewRows']['description'] = "This tag returns the number of entries found in a &lt;we:listview&gt;.";
$l_we_tag['listviewStart']['description'] = "This tag displays the number of the first entry of the current &lt;we:listview&gt; page.";
$l_we_tag['makeMail']['description'] = "This tag must be in the first line of every template in order to generate a webEdition document that is to be sent by &lt;we:sendMail/&gt;.";
...
$l_we_tag['navigation']['description'] = "we:navigation is used to initialise a navigation made with the  navigation-tool.";
...
$l_we_tag['noCache']['description'] = "PHP-Code enclosed by this tag will be executed each time the cached document will be requested (Exception: Full-Cache)";
...
$l_we_tag['prelink']['description'] = "The we:prelink tag ensures that everything located between the start tag and the end tag will not be displayed for the first link in the link list.";
$l_we_tag['prelink']['defaultvalue'] = "";
$l_we_tag['printVersion']['description'] = "The we:printVersion tag creates an HTML link tag that references to the same document, but with a different template. The attribute \"tid\" determines the ID of the template. The tag links any content between the start tag and the end tag.";
$l_we_tag['printVersion']['defaultvalue'] = "";
$l_we_tag['processDateSelect']['description'] = "The tag &lt;we:processDateSelect&gt; processes the 3 values from the select boxes of the tag we:dateSelect into a UNIX timestamp. The value will be saved in a global variable with the name which was entered in the attribute \"name&quuot;.";
...
$l_we_tag['registeredUser']['description'] = "This tag is used to print customer data stored in the customer modules.";
$l_we_tag['registerSwitch']['description'] = "This tag generates a switch with which you can shift between the status of a registered and an unregistered user while in edit-mode. If you have used the &lt;we:ifRegisteredUser&gt; and &lt;we:ifNotRgisteredUser&gt; tags, this tag allows you to see the different views and and to keep control of the layout.";
$l_we_tag['repeat']['description'] = "Content enclosed within this tag is repeated for every entry found by a &lt;we:listview&gt;. This tag is only used within a &lt;we:listview&gt; section.";
$l_we_tag['repeat']['defaultvalue'] = "";
$l_we_tag['repeatShopItem']['description'] = "This tag displays all articles in the shopping cart.";
$l_we_tag['repeatShopItem']['defaultvalue'] = "";
$l_we_tag['returnPage']['description'] = "This tag is used to display the referring url of the source page, if the value of the attribute \"return\" was \"true\" when used in the tags: &lt;we:a edit=\"document\"&gt; or &lt;we:a edit=\"object\"&gt;";
$l_we_tag['saferpay']['description'] = "we:saferpay implements an interface to the payment provider saferpay. To ensure that this tag works properly, add additional information in the backend of the shop module.";
$l_we_tag['saveRegisteredUser']['description'] = "This tag saves all customer data entered by session fields.";
$l_we_tag['search']['description'] = "The we:search tag creates an input box or a text box that is intended to be used for search queries. The search field has the internal name \"we_search\". When the search form is submitted, the PHP variable \"we_search\" on the receiving web page will be filled with the content from the input box.";
...
$l_we_tag['setVar']['description'] = "This tag is used to set the values of various types of varibles.";
...
$l_we_tag['shopField']['description'] = "This tag saves various input fields directly from an article or in the shopping cart (order). The administrator can define some values from which the customer can choose or enter an own value. It is therefore possible to map many article variants in a simple way.";
$l_we_tag['shopVat']['description'] = "This tag is used to determine the VAT for an article. To adminstrate different VAT rates use the Shop Module. A given Id directly prints the VAT-Rate for this article.";
...
$l_we_tag['write']['description'] = "This tag stores a document/object generated by &lt;we:form type=\"document/object&gt;";
$l_we_tag['writeShopData']['description'] = "The we:writeShopData tag writes all current shopping cart data into the database.";
$l_we_tag['writeVoting']['description'] = "This tag writes a voting into the database. If the attribute \"id\" is defined, only the voting with the respective id will be saved.<br /><br />Note:  Please note the &lt;we:writeVoting /&gt; tag has to be in the very first line of your template!";
