...
$l_javaMenu["file"] = "Archief";
$l_javaMenu["new"] = "Nieuw";
	...
	$l_javaMenu["webEdition_page"] = "webEdition Pagina";
	$l_javaMenu["empty_page"] = "Lege Pagina";

	$l_javaMenu["image"] = "Afbeelding";
	$l_javaMenu["other"] = "Anders";

		##################################
		### SubMenu Datei/Neu/Sonstige ###
		##################################

		$l_javaMenu["html_page"] = "HTML Pagina";
	...
	$l_javaMenu["template"] = "Sjabloon";

		##################################
		## SubMenu Datei/Neu/Verzeichnis #
		##################################

		$l_javaMenu["document_directory"] = "Document directorie";
		$l_javaMenu["template_directory"] = "Sjabloon directorie";

		#################################################
		######## End Submenu Datei/Neu/Verzeichnis  #####
		#################################################

	$l_javaMenu["directory"] = "Directorie";
	$l_javaMenu["wizards"] = "Hulp";

		##################################
		## SubMenu Datei/Neu/Wizards #####
		##################################

		$l_javaMenu["first_steps_wizard"] = "Eerste Stappen Assistent";
...
$l_javaMenu["publish"] = "Publiceer";
$l_javaMenu["delete"] = "Verwijder";
...
$l_javaMenu["move"] = "Verplaats";

	#########################################
	#####   	 Import/export		    #####
    #########################################

    $l_javaMenu["import_export"] = "Importeer/Exporteer";

    $l_javaMenu["import"]        = "Importeer";
    $l_javaMenu["export"]        = "Exporteer";
...
$l_javaMenu["rebuild"] = "Herbouw";
$l_javaMenu["clear_cache"] = "Leeg cache";

$l_javaMenu["browse_server"] = "Doorzoek Server";
$l_javaMenu["quit"] = "Stop";

		##################################
		### SubMenu Cockpit           ####
		##################################

		$l_javaMenu["display"] = "Toon";
		$l_javaMenu["new_widget"] = "Voeg widget toe";
...
$l_javaMenu["not_installed_modules"] = "Modules niet geinstalleerd";

$l_javaMenu["search"] = "Zoeken";
