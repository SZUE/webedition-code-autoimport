...
$l_shop["user_deleted"] = "Der Benutzer '%s' wurde erfolgreich gelöscht!";
...
$l_shop["delete_alert"] = "Alle Benutzerdaten von Benutzer '%s' werden gelöscht.\\n Sind Sie sicher?";

$l_shop["created_by"] = "Erstellt von";
$l_shop["changed_by"] = "Geändert von";
...
$l_shop["del_shop"] = "Sind Sie sicher, dass Sie diese Bestellung löschen wollen?";
...
$l_shop["artPub"] = "Veröffentlicht am";
...
$l_shop["saferpayDelivery"] = "zusätzl. Formular?";
$l_shop["saferpayDeliveryTxt"] = "* für Lieferadresse";
$l_shop["saferpayUnotify"] = "Bestätigung";
$l_shop["saferpayUnotifyTxt"] = "* Bestätigungsmail an Kunden";
...
$l_shop["NoRevenue"] = "Im ausgewählten Zeitraum existieren keine Umsätze";
                                                 ...
                                                 // bis hier neu
$l_shop["FormFieldsTxt"] = "Auswahl der Felder zur Übermittlung an den Payment Provider";
...
$l_shop["selectYear"] = "Jahr auswählen";
$l_shop["selectMonth"] = "Monat auswählen";
...
$l_shop["jsloeschen"] = "Sind Sie sicher, dass Sie diesen Artikel wirklich löschen wollen? Dieser Vorgang ist nicht umkehrbar.";
$l_shop["Preis"] = "Preis";
$l_shop["MwSt"] = "MwSt.";
$l_shop["gesamtpreis"] = "Gesamtpreis";
$l_shop["plusVat"] = "zuzüglich Mehrwertsteuer";
...
$l_shop["order_view"] = "Bestellungsübersicht";
...
$l_shop['vat']['delete_success'] = 'Mehrwertsteuersatz erfolgreich gelöscht.';
$l_shop['vat']['delete_error'] = 'Konnte Mehrwertsteuersatz nicht löschen.';

$l_shop['vat']['new_vat_name'] = 'Neuer Steuersatz';
$l_shop['vat']['js_confirm_delete'] = 'Soll der ausgewählte Mehrwertsteuersatz wirklich gelöscht werden?';
...
$l_shop['vat']['vat_edit_form_headline_box'] = 'Mehrwertsteuersätze bearbeiten';
$l_shop['vat']['vat_edit_form_yes'] = 'Ja';
$l_shop['vat']['vat_edit_form_no'] = 'Nein';

// vat_country dialog
$l_shop['vat_country']['box_headline'] = 'Regelwerk: Kunden welcher Länder müssen Mehrwertsteuer zahlen';
$l_shop['vat_country']['defaultReturn'] = 'Standardwert';
$l_shop['vat_country']['defaultReturn_desc'] = 'Mit dem Standardwert wird festgelegt, was we:ifShopPayVat zurückliefert, wenn keine der folgenden Regeln zutrifft. Wird keine Regel definiert, wird automatisch der Standardwert verwendet.';
$l_shop['vat_country']['stateField'] = 'Feld mit Landangaben';
$l_shop['vat_country']['stateField_desc'] = 'In dieses Feld tragen Sie bitte das Feld in der Kundenverwaltung ein, das das Herkunftsland (Rechnungsadresse) des Kunden enthält. Es wird verwendet, um zu ermitteln ob der Kunde Mehrwertsteuern zahlen muss oder nicht.';
$l_shop['vat_country']['statesLiableToVat'] = 'Mehrwertsteuerpflichtige Länder';
$l_shop['vat_country']['statesLiableToVat_desc'] = 'Bei Kunden aus diesen Ländern, wird die Mehrwertsteuer berücksichtigt.';
$l_shop['vat_country']['statesNotLiableToVat'] = 'Nicht mehrwertsteuerpflichtige Länder';
$l_shop['vat_country']['statesNotLiableToVat_desc'] = 'Bei Kunden aus diesen Ländern wird die Mehrwertsteuer nicht berücksichtigt.';

$l_shop['vat_country']['statesSpecialRules'] = 'Länder mit Sonderregeln';
$l_shop['vat_country']['statesSpecialRules_desc'] = 'Kunden aus Ländern, die hier eingetragen sind, wird die Mehrwertsteuer nur berechnet, wenn zusätzlich eine bestimmte Bedingung erfüllt ist.';
$l_shop['vat_country']['statesSpecialRules_condition'] = 'zusätzliche Bedingung';
...
$l_shop['order']['open_customer'] = 'Kunde in Kundenverwaltung öffnen.';

$l_shop['edit_order']['shipping_costs'] = 'Versandkosten';
$l_shop['edit_order']['js_edit_custom_cart_field'] = 'Neuer Wert für %s:.';
...
$l_shop['edit_order']['js_delete_cart_field'] = 'Soll das Feld %s aus der Bestellung gelöscht werden?';
$l_shop['edit_order']['js_delete_cart_field_success'] = 'Das Feld %s wurde aus der Bestellung gelöscht.';
$l_shop['edit_order']['js_delete_cart_field_error'] = 'Das Feld %s konnte nicht aus der Bestellung gelöscht werden.';
...
$l_shop['edit_order']['js_saved_calculateVat_success'] = 'Änderung gespeichert.';
$l_shop['edit_order']['js_saved_calculateVat_error'] = 'Konnte Änderung nicht speichern.';
...
$l_shop['add_article']['title'] = 'Artikel hinzufügen';
...
$l_shop['edit_shipping_cost']['title'] = 'Versandkosten ändern';
$l_shop['edit_shipping_cost']['vatRate'] = 'Mehrwertsteuersatz';
$l_shop['edit_shipping_cost']['isNet'] = 'Netto Angabe';

$l_shop['add_shop_field'] = 'Angabe zu der Bestellung hinzufügen';
$l_shop['field_name'] = 'Name';
$l_shop['field_value'] = 'Wert';
$l_shop['field_empty_js_alert'] = 'Sie müssen einen Feldnamen angeben.';
...
$l_paypal['redirect_auto'] = 'Bitte warten Sie, Ihre Zahlung wird verabeitet und Sie werden zu PayPal weitergeleitet.';
