...
$GLOBALS["l_wysiwyg"]["inserthorizontalrule"] = "Вставить горизонтальную линию";
$GLOBALS["l_wysiwyg"]["insertspecialchar"] = "Ввести особый символ";
$GLOBALS["l_wysiwyg"]["inserttable"] = "Вставить таблицу";
$GLOBALS["l_wysiwyg"]["editcell"] = "Редактировать ячейку таблицы";
$GLOBALS["l_wysiwyg"]["edittable"] = "Редактировать таблицу";
$GLOBALS["l_wysiwyg"]["cut2"] = "Вырезать";
$GLOBALS["l_wysiwyg"]["copy2"] = "Копировать";
$GLOBALS["l_wysiwyg"]["paste2"] = "Вставить";
...
$GLOBALS["l_wysiwyg"]["visible_borders"] = "Показать границы";
...
$GLOBALS["l_wysiwyg"]["edit_hyperlink"] = "Редактировать гиперссылку";
$GLOBALS["l_wysiwyg"]["edit_image"] = "Редактировать графику";
...
$GLOBALS["l_wysiwyg"]["insert_table"] = "Вставить таблицу";
$GLOBALS["l_wysiwyg"]["insert_image"] = "Вставить графику";
$GLOBALS["l_wysiwyg"]["insert_hyperlink"] = "Вставить гиперссылку";
$GLOBALS["l_wysiwyg"]["edit_cell"] = "Редактировать ячейку";
...
$GLOBALS["l_wysiwyg"]["undo"] = "Отменить действие";
$GLOBALS["l_wysiwyg"]["redo"] = "Восстановить действие";
$GLOBALS["l_wysiwyg"]["parent_class"] = "Исходная область";
$GLOBALS["l_wysiwyg"]["region_class"] = "Только выбор";
$GLOBALS["l_wysiwyg"]["none"] = "без";
...
$GLOBALS["l_wysiwyg"]["insertcolumnright"] = "Вставить столбец справа";
$GLOBALS["l_wysiwyg"]["insertcolumnleft"] = "Вставить столбец слева";
$GLOBALS["l_wysiwyg"]["insertrowabove"] = "Вставить строку вверху";
$GLOBALS["l_wysiwyg"]["insertrowbelow"] = "Вставить строку внизу";
$GLOBALS["l_wysiwyg"]["deleterow"] = "Удалить строку";
$GLOBALS["l_wysiwyg"]["deletecol"] = "Удалить столбец";
$GLOBALS["l_wysiwyg"]["increasecolspan"] = "Увеличить ширину столбца";
$GLOBALS["l_wysiwyg"]["decreasecolspan"] = "Уменьшить ширину столбца";
$GLOBALS["l_wysiwyg"]["caption"] = "Надпись";
$GLOBALS["l_wysiwyg"]["addcaption"] = "Добавить надпись";
$GLOBALS["l_wysiwyg"]["removecaption"] = "Удалить надпись";
$GLOBALS["l_wysiwyg"]["insert_edit_anchor"] = "Вставить/редактировать якорь";
$GLOBALS["l_wysiwyg"]["insert_anchor"] = "Вставить якорь";
$GLOBALS["l_wysiwyg"]["edit_anchor"] = "Редактировать якорь";
