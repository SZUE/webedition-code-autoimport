...
$l_alert=array(
	...
	'field_input_contains_incorrect_length'=>'The maximum length of a field of the type `Text input` is 4095 characters. If you need more characters, use a field of the type `Textarea`.',
