...
abstract class we_html_element{
	...
	public static function htmlIFrame($name, $src, $style = '', $iframestyle = '', $onload = '', $scroll = true, $class = ''){
		static $isApple = -1;
		$isApple = ($isApple !== -1 ? $isApple : ((we_base_browserDetect::inst()->getBrowser() == we_base_browserDetect::APPLE) || we_base_browserDetect::inst()->isSafari() || (we_base_browserDetect::inst()->getSystem() == we_base_browserDetect::SYS_IPHONE)));
