...
class we_chooser_multiDirExtended extends we_chooser_multiDir{
	...
	<td class="buttons">' . ((($this->isEditable() && $this->cmd_del) || $this->CanDelete) ?
						we_html_button::create_button(we_html_button::TRASH, "javascript:" . $this->getJsSetHot() . ($this->extraDelFn ? : "") . "; " . $_catFieldJS, true, 26) :
						"") . '</td>
</tr>';
		}
		return '';
	...
	<td class="buttons">' . ((($this->isEditable() && $this->cmd_del) || $this->CanDelete) ?
						we_html_button::create_button(we_html_button::TRASH, "javascript:" . $this->getJsSetHot() . ($this->extraDelFn ? : "") . ";we_cmd('" . $this->cmd_del . "','0');", true, 26) :
						'') . '</td>
</tr>';
		}
		return '';
