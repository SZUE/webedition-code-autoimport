...
$this->TypeAttribute = new weTagData_typeAttribute('type', array(
	...
	new weTagDataOption('email', false, 'customer', array($required,$customerEmailField,$expireToken), array($required,$customerEmailField)),
	new weTagDataOption('emailPassword', false, 'customer', array($required,$expireToken), array($required)),
