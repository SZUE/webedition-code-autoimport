...
$this->TypeAttribute = new weTagData_typeAttribute('type', array(
	new weTagDataOption('document', false, '', array($name, $doc, $htmlspecialchars, $format), array($name)),
	new weTagDataOption('property', false, '', array($name, $doc, $format), array($name)),
	new weTagDataOption('global', false, '', array($name, $htmlspecialchars, $format), array($name)),
	...
	new weTagDataOption('date', false, '', array($name, $doc, $htmlspecialchars, $format), array($name)),
	...
	new weTagDataOption('request', false, '', array($name, $htmlspecialchars, $format), array($name)),
	new weTagDataOption('post', false, '', array($name, $htmlspecialchars, $format), array($name)),
	new weTagDataOption('get', false, '', array($name, $htmlspecialchars, $format), array($name)),
	new weTagDataOption('select', false, '', array($name, $doc, $htmlspecialchars, $key), array($name)),
	new weTagDataOption('session', false, '', array($name, $htmlspecialchars, $format), array($name)),
