...
if($tool == "weSearch"){
	...
	switch(($cmd2 = we_base_request::_(we_base_request::TABLE, 'we_cmd', FILE_TABLE, 2))){//FIXME: bad to have different types at one query
		case FILE_TABLE:
			$tab = 1;
		...
		default:
			$tab = we_base_request::_(we_base_request::INT, 'we_cmd', 1, 2);
	}
