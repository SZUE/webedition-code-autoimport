...
font-style			: italic;
font-weight			: bold;
font-size			: <?php print (we_base_browserDetect::isMAC()) ? "22px" : ((we_base_browserDetect::isUNIX()) ? "24px" : "23px"); ?>;
line-height			: <?php print (we_base_browserDetect::isMAC()) ? "24px" : ((we_base_browserDetect::isUNIX()) ? "26px" : "25px"); ?>;
z-index				: 3;
}
...
line-height			: <?php print (we_base_browserDetect::isMAC()) ? "15px" : ((we_base_browserDetect::isUNIX()) ? "17px" : "16px"); ?>;
z-index				: 3;
}
...
font-size			: <?php print (we_base_browserDetect::isMAC()) ? "18px" : ((we_base_browserDetect::isUNIX()) ? "20px" : "19px"); ?>;
z-index				: 3;
}
