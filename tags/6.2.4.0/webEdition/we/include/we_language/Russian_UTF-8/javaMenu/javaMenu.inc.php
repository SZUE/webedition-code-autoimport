...
$l_javaMenu["file"] = "Файл";
$l_javaMenu["new"] = "Новый";
	...
	$l_javaMenu["webEdition_page"] = "Страница webEdition";
	$l_javaMenu["empty_page"] = "Новая страница";

	$l_javaMenu["image"] = "Графика";
	$l_javaMenu["other"] = "Другое";

		##################################
		### SubMenu Datei/Neu/Sonstige ###
		##################################

		$l_javaMenu["html_page"] = "Страница HTML";
	...
	$l_javaMenu["template"] = "Шаблон";
		...
		$l_javaMenu["document_directory"] = "Директория документов";
		$l_javaMenu["template_directory"] = "Директория шаблонов";
	...
	$l_javaMenu["open"] = "Открыть";


	##################################
	###### SubMenu Datei/Open ########
	##################################
	$l_javaMenu["open_document"] = "Документ";
	$l_javaMenu["open_template"] = "Шаблон";
...
$l_javaMenu["move"] = "Move"; // TRANSLATE
    ...
    $l_javaMenu["import_export"] = "Импорт/экспорт";
...
$l_javaMenu["backup"] = "Backup"; // TRANSLATE
	...
	$l_javaMenu["make_backup"] = "Создать Backup";
	$l_javaMenu["recover_backup"] = "Восстановить Backup";
...
$l_javaMenu["rebuild"] = "Перестроить";
$l_javaMenu["clear_cache"] = "Clear cache"; // TRANSLATE

$l_javaMenu["browse_server"] = "Поиск по серверу";
$l_javaMenu["quit"] = "Завершить работу";
