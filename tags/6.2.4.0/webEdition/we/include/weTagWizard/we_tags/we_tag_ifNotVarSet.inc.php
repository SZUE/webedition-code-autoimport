...
$GLOBALS['weTagWizard']['attribute']['id250_type'] = new weTagData_selectAttribute('250', 'type', array(new weTagDataOption('href', false, ''), new weTagDataOption('request', false, ''), new weTagDataOption('post', false, ''),new weTagDataOption('get', false, ''), new weTagDataOption('global', false, ''), new weTagDataOption('session', false, ''), new weTagDataOption('sessionfield', false, ''), new weTagDataOption('sum', false, ''), new weTagDataOption('shopField', false, '')), false, '');
