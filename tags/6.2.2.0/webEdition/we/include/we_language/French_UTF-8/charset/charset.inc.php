...
$_charset["error"]["no_charset_tag"] = "Aucun we:charset-Tag dans le modèle";
$_charset["error"]["no_charset_available"] = "--Sans--";
...
$_charset["titles"]["extended_european"] = "Européenne (élargi)";   // ISO-8859-15
