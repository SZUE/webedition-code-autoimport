...
/* query separator */
###UPDATEONLY###SELECT @vid:=ID FROM ###TBLPREFIX###tblsearchtool WHERE Path='/Versionen' LIMIT 0,1;
/* query separator */
###UPDATEONLY###INSERT IGNORE INTO ###TBLPREFIX###tblsearchtool (`ParentID`, `IsFolder`, `Icon`, `Path`, `Text`, `predefined`, `folderIDDoc`, `folderIDTmpl`, `searchDocSearch`, `searchTmplSearch`, `searchForTextDocSearch`, `searchForTitleDocSearch`, `searchForContentDocSearch`, `searchForTextTmplSearch`, `searchForContentTmplSearch`, `anzahlDocSearch`, `anzahlTmplSearch`, `anzahlAdvSearch`, `setViewDocSearch`, `setViewTmplSearch`, `setViewAdvSearch`, `OrderDocSearch`, `OrderTmplSearch`, `OrderAdvSearch`, `searchAdvSearch`, `locationAdvSearch`, `searchFieldsAdvSearch`, `search_tables_advSearch`, `activTab`) VALUES
...
/* query separator */
###UPDATEONLY###SELECT @vdid:=ID FROM ###TBLPREFIX###tblsearchtool WHERE Path='/Versionen/Dokumente' LIMIT 0,1;
/* query separator */
###UPDATEONLY###SELECT @void:=ID FROM ###TBLPREFIX###tblsearchtool WHERE Path='/Versionen/Objekte' LIMIT 0,1;
/* query separator */
###UPDATEONLY###INSERT IGNORE INTO ###TBLPREFIX###tblsearchtool (`ParentID`, `IsFolder`, `Icon`, `Path`, `Text`, `predefined`, `folderIDDoc`, `folderIDTmpl`, `searchDocSearch`, `searchTmplSearch`, `searchForTextDocSearch`, `searchForTitleDocSearch`, `searchForContentDocSearch`, `searchForTextTmplSearch`, `searchForContentTmplSearch`, `anzahlDocSearch`, `anzahlTmplSearch`, `anzahlAdvSearch`, `setViewDocSearch`, `setViewTmplSearch`, `setViewAdvSearch`, `OrderDocSearch`, `OrderTmplSearch`, `OrderAdvSearch`, `searchAdvSearch`, `locationAdvSearch`, `searchFieldsAdvSearch`, `search_tables_advSearch`, `activTab`) VALUES
