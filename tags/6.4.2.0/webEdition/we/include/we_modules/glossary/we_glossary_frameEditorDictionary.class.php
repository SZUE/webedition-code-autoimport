...
class we_glossary_frameEditorDictionary extends we_glossary_frameEditor{
	...
	function Footer($weGlossaryFrames){
		...
		$table2->setCol(0, 1, array("nowrap" => null), we_html_button::create_button("save", "javascript:top.opener.top.we_cmd('save_dictionary')", true, 100, 22, '', '', (!permissionhandler::hasPerm('NEW_GLOSSARY') && !permissionhandler::hasPerm('EDIT_GLOSSARY'))));
