...
$we_menu_glossary["001000"]["text"] = g_l('modules_glossary',"[glossary]");
$we_menu_glossary["001000"]["parent"] = "000000";
$we_menu_glossary["001000"]["perm"] = "";
$we_menu_glossary["001000"]["enabled"] = "1";

$we_menu_glossary["002000"]["text"] = g_l('modules_glossary',"[menu_new]");
...
foreach ($langs as $key => $language) {
	...
	$we_menu_glossary["00" . $nr . "5"]["text"] = g_l('modules_glossary','[textreplacement]');
...
$we_menu_glossary["005000"]["text"] = g_l('modules_glossary',"[menu_save]");
...
$we_menu_glossary["006000"]["text"] = g_l('modules_glossary',"[menu_delete]");
...
$we_menu_glossary["020000"]["text"] = g_l('modules_glossary',"[menu_exit]");
...
$we_menu_glossary["010000"]["text"] = g_l('modules_glossary',"[menu_options]");
$we_menu_glossary["010000"]["parent"] = "000000";
$we_menu_glossary["010000"]["perm"] = "ADMINISTRATOR";
$we_menu_glossary["010000"]["enabled"] = "1";

	$we_menu_glossary["012000"]["text"] = g_l('modules_glossary',"[menu_settings]");
...
$we_menu_glossary["021000"]["text"] = g_l('modules_glossary',"[menu_help]");
$we_menu_glossary["021000"]["parent"] = "000000";
$we_menu_glossary["021000"]["perm"] = "";
$we_menu_glossary["021000"]["enabled"] = "1";

	$we_menu_glossary["022000"]["text"] = g_l('modules_glossary',"[menu_help]")."...";
	...
	$we_menu_glossary["023000"]["text"] = g_l('modules_glossary',"[menu_info]")."...";
