...
['id742_id'] = new weTagData_selectorAttribute('742', 'id',FILE_TABLE, 'folder', false, ''); } $GLOBALS['weTagWizard']['attribute']['id297_doc'] = new weTagData_selectAttribute('297', 'doc', array(new weTagDataOption('top', false, ''), new weTagDataOption('self', false, '')), false, ''); ?>
