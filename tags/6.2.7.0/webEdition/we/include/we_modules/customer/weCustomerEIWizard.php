	...
	function getHTMLImportStep3() {
		...
		if(is_file($filesource) && is_readable($filesource)){
			if($type=="csv"){
				...
				$_importCharset = htmlTextInput('the_charset', 8, DEFAULT_CHARSET, 255, "", "text", 100);
				$_importCharsetChooser = htmlSelect("ImportCharsetSelect", $_charsets, 1, DEFAULT_CHARSET, false,"onChange=\"document.forms[0].elements['the_charset'].value=this.options[this.selectedIndex].value;this.selectedIndex=-1;\"","value",160,"defaultfont",false);
