CREATE TABLE ###TBLPREFIX###tblUser (
  ...
  ParentPerms tinyint(4) unsigned NOT NULL default '0',
  Alias bigint(20) unsigned NOT NULL default '0',
  ...
  ParentWs tinyint(4) unsigned NOT NULL default '0',
  ParentWst tinyint(4) unsigned NOT NULL default '0',
  ParentWsn tinyint(4) unsigned NOT NULL default '0',
  ParentWso tinyint(4) unsigned NOT NULL default '0',
  ParentWsnl tinyint(4) unsigned NOT NULL default '0',
