...
$l_backup["charset_warning"] = "Sollte es Probleme beim Wiederherstellen eines Backups geben, achten Sie bitte darauf, dass <strong>im Zielsystem derselbe Zeichensatz (Charset) wie im Quellsystem verwendet</strong> wird. Dies gilt sowohl für den Zeichensatz der Datenbank (collation) als auch für den Zeichensatz der verwendeten Oberflächensprache!";
$l_backup["defaultcharset_warning"] = '<span style="color:ff0000">Achtung! Es ist keinen Standard-Zeichensatz definiert.</span> Dies kann bei bestimmten Server-Konfigurationen zu Problemen beim Wiederherstellen des Backups führen!';
...
$l_backup["finish"] = "Die Backup-Datei wurde erstellt.";
