...
$l_javaMenu["module_information"]["users"]["text"] = "Управление пользователями";
...
$l_javaMenu["module_information"]["shop"]["not_installed"] = "Вы не установили модуль webEdition «Интернет-магазин». Данный модуль поддерживает работу интернет-магазина на Вашей веб-странице.<br> Модуль и более подробную информацию о нем Вы найдете здесь: %s";

$l_javaMenu["module_information"]["editor"]["text"] = "Плагин-редактор";
$l_javaMenu["module_information"]["editor"]["text_short"] = "Плагин-редактор";
$l_javaMenu["module_information"]["editor"]["not_installed"] = "Если Вы приобрели модуль «Плагин-редактор», Вы можете активировать его в главном меню в <a href=\"javascript:opener.top.we_cmd('openPreferences');\">Опции => Персональные настройки</a>. Установка произойдет автоматически при переходе в &quot;редактировать&quot; в режиме «Шаблоны».<br>Подробнее о модуле «Плагин-редактор» здесь: %s.";

$l_javaMenu["module_information"]["object"]["text"] = "База данных/объект";
$l_javaMenu["module_information"]["object"]["text_short"] = "Объекты";
$l_javaMenu["module_information"]["object"]["not_installed"] = "Вы не установили модуль «База данных/объект» системы webEdition.<br> Модуль и более подробную информацию о нем Вы найдете здесь: %s";
...
$l_javaMenu["module_information"]["workflow"]["not_installed"] = "Вы не установили модуль «Электронный документооборот» системы webEdition. <br> Модуль и более подробную информацию о нем Вы найдете здесь: %s";

$l_javaMenu["module_information"]["newsletter"]["text"] = "Лист рассылки";
$l_javaMenu["module_information"]["newsletter"]["text_short"] = "Лист рассылки";
$l_javaMenu["module_information"]["newsletter"]["not_installed"] = "Вы не установили модуль webEdition «Лист рассылки». <br> Модуль и более подробную информацию о нем Вы найдете здесь: %s";

$l_javaMenu["module_information"]["banner"]["text"] = "Баннер/статистика";
$l_javaMenu["module_information"]["banner"]["text_short"] = "Баннер";
$l_javaMenu["module_information"]["banner"]["not_installed"] = "Вы не установили модуль «Баннер/статистика» системы webEdition. Модуль и более подробную информацию о нем Вы найдете здесь: %s";

$l_javaMenu["module_information"]["export"]["text"] = "Модуль экспорта";
$l_javaMenu["module_information"]["export"]["text_short"] = "Экспорт";
$l_javaMenu["module_information"]["export"]["not_installed"] = "Вы не установили модуль webEdition «Модуль экспорта». Модуль и более подробную информацию о нем Вы найдете здесь: %s";

$l_javaMenu["module_information"]["voting"]["text"] = "Модуль голосования";
