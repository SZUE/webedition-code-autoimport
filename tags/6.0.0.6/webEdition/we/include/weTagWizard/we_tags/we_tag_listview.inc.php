...
$GLOBALS['weTagWizard']['attribute']['id353_type'] = new weTagData_typeAttribute('353', 'type', array(new weTagDataOption('-', false, '', array('id353_type'), array()), new weTagDataOption('document', false, '', array('id353_type','id354_name','id355_doctype','id356_categories','id357_catOr','id358_rows','id360_order','id361_desc','id362_offset','id373_searchable','id707_workspaceID','id743_cfilter','id746_recursive','id799_customers','id800_contenttypes','id805_id','id811_calendar'), array()), new weTagDataOption('search', false, '', array('id353_type','id354_name','id355_doctype','id356_categories','id357_catOr','id358_rows','id360_order','id361_desc','id363_casesensitive','id364_classid','id707_workspaceID','id743_cfilter'), array()), new weTagDataOption('category', false, '', array('id353_type','id354_name','id356_categories','id358_rows','id360_order','id361_desc','id362_offset','id370_parentid','id371_parentidname','id644_categoryids'), array()), new weTagDataOption('object', false, '', array('id353_type','id354_name','id356_categories','id357_catOr','id358_rows','id360_order','id361_desc','id362_offset','id364_classid','id365_condition','id366_triggerid','id373_searchable','id707_workspaceID','id743_cfilter','id747_docid','id799_customers','id805_id','id811_calendar','id818_predefinedSQL'), array()), new weTagDataOption('multiobject', false, '', array('id353_type','id354_name','id356_categories','id357_catOr','id358_rows','id360_order','id361_desc','id362_offset','id364_classid','id365_condition','id366_triggerid','id373_searchable','id743_cfilter','id811_calendar'), array()), new weTagDataOption('banner', false, 'banner', array('id353_type','id354_name','id358_rows','id360_order','id754_customer'), array()), new weTagDataOption('shopVariant', false, '', array('id353_type','id354_name','id374_defaultname','id375_documentid','id376_objectid'), array()), new weTagDataOption('customer', false, 'customer', array('id353_type','id354_name','id358_rows','id359_cols','id360_order','id361_desc','id362_offset','id365_condition','id747_docid'), array())), false, '');
...
$GLOBALS['weTagWizard']['attribute']['id360_order'] = new weTagData_choiceAttribute('360', 'order', array(new weTagDataOption('random()', false, ''), new weTagDataOption('we_creationdate', false, ''), new weTagDataOption('we_filename', false, ''), new weTagDataOption('we_id', false, ''), new weTagDataOption('we_published', false, '')), false,false, '');
