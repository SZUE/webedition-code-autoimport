...
$l_we_editor["object"]["response_save_ok"] = "Luokka '%s' on tallennettu!";
$l_we_editor["object"]["response_publish_ok"] = "Luokka '%s' on julkaistu!";
$l_we_editor["object"]["response_unpublish_ok"] = "Luokka '%s' on poistettu julkaisusta!";
...
$l_we_editor["objectFile"]["response_save_ok"] = "Objekti '%s' on tallennettu!";
$l_we_editor["objectFile"]["response_publish_ok"] = "Objekti '%s' on julkaistu!";
$l_we_editor["objectFile"]["response_publish_notok"] = "Virhe julkaistaessa objektia '%s'!";
$l_we_editor["objectFile"]["response_unpublish_ok"] = "Objekti '%s' on poistettu julkaisusta!";
$l_we_editor["objectFile"]["response_unpublish_notok"] = "Virhe poistettaessa objektia '%s' julkaisusta!";
...
$l_we_editor["objectFile"]["response_save_noperms_to_create_folders"] = "Objektia ei voitu tallentaa, koska sinulla ei ole riittäviä oikeuksia luoda hakemistoja (%s)!";
$l_we_editor["objectFile"]["autoschedule"] = "Objekti julkaistaan automaattisesti %s.";
?>