...
$_sysinfo["short_open_tag warning"] = 'WARNUNG: short_open_tag can lead to severe problems with the processing of xml-files, i.e. for backup files. We strongly recommend to turn off this feature!!';// TRANSLATE
$_sysinfo["not_active"] = 'not active';
$_sysinfo["not_set"] = 'Nicht gesetzt (off)';
