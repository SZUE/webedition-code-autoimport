		...
		<td class="weEditmodeStyle" colspan="2" align="left">
			...
			case "textarea" :
				...
				if($pure){
					...
					$ret = we_forms::weTextarea($fieldname, $content, $attribs, $autobr, "autobr", $showAutobr, $GLOBALS['we_doc']->getHttpPath(), false, false, $xml, $removeFirstParagraph, $charset, false, true, $name);
