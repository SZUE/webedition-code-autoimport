...
$l_javaMenu["module_information"]["users"]["text_short"] = "Gebruiker";
$l_javaMenu["module_information"]["users"]["not_installed"] = "Sorry, maar u heeft de webEdition Gebruikers Beheer Module nog niet geinstalleerd. De Gebruikers Beheer Module geeft u de mogelijkheid om webEdition editors rechten en werkgebieden toe te kennen.<br>U vindt de module en meer informatie onder: %s";

$l_javaMenu["module_information"]["customer"]["text"] = "Klanten Beheer";
$l_javaMenu["module_information"]["customer"]["text_short"] = "Klant";
$l_javaMenu["module_information"]["customer"]["not_installed"] = "Sorry, maar u heeft de webEdition Klanten Beheer Module nog niet geinstalleerd. De Klanten Beheer Module geeft u de mogelijkheid om externe gebruikers te beheren, het verstrekken van speciale informatie speciaal voor geregistreerde gebruikers en voor het vestigen van gesloten gebruikers groepen.(periode)<br>U vindt de module en meer informatie onder: %s";

$l_javaMenu["module_information"]["schedule"]["text"] = "Planner";
$l_javaMenu["module_information"]["schedule"]["text_short"] = "Planner";
$l_javaMenu["module_information"]["schedule"]["not_installed"] = "Sorry, maar u heeft de webEdition Planner Module nog niet geinstalleerd. De Planner Module geeft u de mogelijkheid om informatie te publiceren en depubliceren op vastgestelde momenten.<br>U vindt de module en meer informatie onder: %s";

$l_javaMenu["module_information"]["shop"]["text"] = "Winkel";
...
$l_javaMenu["module_information"]["object"]["text"] = "Database/Object Module";
$l_javaMenu["module_information"]["object"]["text_short"] = "Objecten";
$l_javaMenu["module_information"]["object"]["not_installed"] = "Sorry, maar u heeft de webEdition Database/Object Module nog niet geinstalleerd. U vindt de module en meer informatie onder: %s";

$l_javaMenu["module_information"]["messaging"]["text"] = "Taak/Berichten Module";
...
$l_javaMenu["module_information"]["newsletter"]["text_short"] = "Nieuwsbrief";
...
$l_javaMenu["module_information"]["export"]["text_short"] = "Exporteer";
$l_javaMenu["module_information"]["export"]["not_installed"] = "Sorry, maar u heeft de webEdition Export Module nog niet geinstalleerd. U vindt de module en meer informatie onder: %s";

$l_javaMenu["module_information"]["voting"]["text"] = "Peiling Module";
$l_javaMenu["module_information"]["voting"]["text_short"] = "Peiling";
$l_javaMenu["module_information"]["voting"]["not_installed"] = "Sorry, maar u heeft de webEdition Peiling Module nog niet geinstalleerd. U vindt de module en meer informatie onder: %s";

$l_javaMenu["module_information"]["glossary"]["text"] = "Verklarende woordenlijst";
