...
if (version_compare(PHP_VERSION, '5.4') < 0) {
	include __DIR__ . '/oldsrc/Colors.php';
	include __DIR__ . '/oldsrc/Compiler.php';
	include __DIR__ . '/oldsrc/Formatter.php';
	include __DIR__ . '/oldsrc/Formatter/Compressed.php';
	include __DIR__ . '/oldsrc/Formatter/Crunched.php';
	include __DIR__ . '/oldsrc/Formatter/Expanded.php';
	include __DIR__ . '/oldsrc/Formatter/Nested.php';
	include __DIR__ . '/oldsrc/Parser.php';
	include __DIR__ . '/oldsrc/Server.php';
}elseif (! class_exists('scssc', false)) {
