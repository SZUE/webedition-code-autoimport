...
tinymce.PluginManager.add('anchor', function(editor) {
	...
	// IMI: added onNodeVChange: move to custom plugs or add this menu editor.onInit
		...
		onPostRender: function() {
			...
			editor.on('NodeChange', function(e) {
				...
				if (n && n.nodeName) { // we check for lang spans recursive
					do {
						if(n.nodeName.toLowerCase() === 'a' && ((n.getAttribute('name') && n.getAttribute('name') !== '') || (n.getAttribute('id') && n.getAttribute('id') !== ''))){
							ctrl.active(true);
							break;
						}
