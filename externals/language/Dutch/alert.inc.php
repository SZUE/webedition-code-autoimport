...
$l_alert=array(
	...
	'field_input_contains_incorrect_length'=>'De maximale lengte van een veld met het type `Text input` is 1023 karakters. Indien u meer karakters nodig hebt, maak dan gebruik van het veld met het type `Textarea`.',
