...
$l_backup=array(
	...
	'customer_import_file_found'=>'El archivo parece un archivo de importación con datos del cliente. Por favor use la opción "Importación/Exportación" del módulo Gestión de Cliente para importar los datos.',
