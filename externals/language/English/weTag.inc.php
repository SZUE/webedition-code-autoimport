...
$l_weTag=array(
	...
	'ifShopVat'=>array(
		'description'=>'Everything between the start and end tags of this tag is displayed only if the shop vat of the actual article matches a given id or (when using shop categories) does have certain properties.',
	),
	'ifSidebar'=>array(
	...
	'include'=>array(
		'description'=>'This tag allows you to include a document (type=document) or a template (type=template). This is particularly useful for navigation features or for sections that are the same on every template. If you work with the we:include tag, you do not need to change the navigation system in all the templates, changing it in the document you want to include will suffice.
Users can only change document-type includes where the name attribute is set. Includes using the template type can only be changed in the template itself.',
	),
	'input'=>array(
	...
	'sendMail'=>array(
		'description'=>'This tag sends a webEdition page as an email to the addresses which are defined in the attribute "recipient".',
	),
	'sessionField'=>array(
	...
	'unsubscribe'=>array(
		'description'=>'This tag is used to generate a single input field in a webEdition document so that a user can enter his or her email address to unsubscribe from a news-letter.',
	),
	'url'=>array(
