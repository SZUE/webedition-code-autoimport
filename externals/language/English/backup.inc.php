...
$l_backup=array(
	...
	'customer_import_file_found'=>'The file looks like import file with customer`s data. Please use the "Import/Export" option from the customer module to import the data.',
