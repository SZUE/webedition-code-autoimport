...
$l_weTag=array(
	...
	'include'=>array(
		'description'=>'Mit diesem Tag können Sie entweder ein Dokument (type=document) oder eine andere Vorlage (type=template) einbinden.
Dies ist besonders für Navigationen oder Teile, die auf jeder Vorlage gleich sind, zu empfehlen. Wenn Sie mit dem we:include-Tag arbeiten, brauchen Sie eine Änderung der Navigation nicht in allen Vorlagen ändern, sondern nur im einzubindenden Dokument.
In der Benutzereingabe können lediglich Dokumente geändert werden, sofern das name-Attribut gesetzt wurde. Eingebundene Vorlagen können nur in der Vorlage selbst geändert werden.',
	),
	'input'=>array(
