...
Erlaubte Zeichen sind allle außer <>?":|\\/* .',
	...
	'video/*'=>array(
		'filename_empty'=>'Sie haben noch keinen Dateinamen eingegeben!',
		'response_path_exists'=>'Das Video `%s` konnte nicht gespeichert werden, da es bereits eine andere Datei oder ein anderes Verzeichnis an dieser Stelle gibt!',
		'response_publish_ok'=>'Das Video `%s` wurde erfolgreich veröffentlicht!',
		'response_save_noperms_to_create_folders'=>'Die Datei konnte nicht gespeichert werden, da Sie nicht die notwendigen Rechte besitzen, um neue Verzeichnisse (%s) anzulegen!',
		'response_save_notok'=>'Fehler beim Speichern des Videos `%s`!',
		'response_save_ok'=>'Das Video `%s` wurde erfolgreich gespeichert!',
		'response_unpublish_ok'=>'Das Video `%s` wurde erfolgreich geparkt!',
		'we_filename_notAllowed'=>'Der eingegebene Dateiname ist nicht erlaubt!',
		'we_filename_notValid'=>'Der eingegebene Dateiname ist nicht gültig!\nErlaubte Zeichen sind allle außer <>?":|\\/* .',
	),
