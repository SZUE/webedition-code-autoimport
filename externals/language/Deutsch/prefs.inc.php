...
Zur Umstellung auf den Standard "nein" ersetzen Sie in allen Vorlagen einfach in Ihrem PHP-Kode nach folgendem Muster: aus $x=1; wird $GLOBALS["x"]=1; aus &lt;we:tag attribute="$variablenname"/&gt; wird &lt;we:tag attribute="\$variablenname"/&gt;.<br/><br/>Wir empfehlen dringend auf den Standard-Wert "nein" und &lt;we:tag attribute="\$variablenname"/&gt; umzustellen.',
	...
	'session_crypt'=>'Sitzung für jeden Benutzer transparent verschlüsseln',
	'session_information'=>'webEdition kann selbst die Verwaltung von php-Sessions übernehmen. Die Sitzungen werden dann in der Datenbank gespeichert. Zusätzlich besteht die Möglichkeit die Sitzungsdaten pro Sitzung transparent zu verschlüsseln (empfohlen). Beachten Sie daß jede Änderung der Einstellungen hier ALLE angemeldeten Benutzer UND Kunden aus dem System wirft!',
	'show'=>'anzeigen',
