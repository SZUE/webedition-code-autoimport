...
EOF;
	...
	$Template->addJavascript(\'top.leForm.setFocus("le_serial");\');

	//$Template->addError($this->Language[\'serialNotValid\']);
	$Template->addError("' . $GLOBALS['updateServerTemplateData']['licenceError'] . '");
