...
$lang["installer"]["amountFilesDownloaded"] = "Files %s to %s downloaded.";

// installerDownload::getPrepareInstallerFilesResponse()
$lang["installer"]["amountFilesPrepared"] = "Files %s to %s prepared.";

// installApplication::getUpdateApplicationDatabaseResponse()
$lang["installer"]["amountDatabaseQueries"] = "Queries %s to %s executed.";
...
$lang["installerDemo"]["prepareSnippetFiles"] = "Prepare additional files";
$lang["installerDemo"]["importSnippetFiles"] = "Import additional files";

// installer::getErrorMessage()
$lang["installerDemo"]["determineSnippetFilesError"] = $lang["installer"]["errorAtStep"] . $lang["installerDemo"]["determineSnippetFiles"];
$lang["installerDemo"]["downloadSnippetFilesError"] = $lang["installer"]["errorAtStep"] . $lang["installerDemo"]["downloadSnippetFiles"];
$lang["installerDemo"]["prepareSnippetFilesError"] = $lang["installer"]["errorAtStep"] . $lang["installerDemo"]["prepareSnippetFiles"];
$lang["installerDemo"]["importSnippetFilesError"] = $lang["installer"]["errorAtStep"] . $lang["installerDemo"]["importSnippetFiles"];
