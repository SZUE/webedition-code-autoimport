...
$lang['register']['repeatRegistration'] = 'Ihre Produkt-Id konnte nicht gefunden werden.<br /><br />Die Registrierungsdaten auf unserem Server weichen von den Informationen auf Ihrer Domain ab. Dies kann bspw. passieren, wenn Module f&uuml;r die Domain registriert, aber nicht mehr installiert sind (nach Neuinstallation). Bitte geben Sie Ihre Seriennummer erneut ein, um die Registrierungsdaten anzugleichen. Sie k&ouml;nnen dann mit dem Update/ der Modulinstallation fortfahren.';
$lang['register']['reInstallModules'] = 'Die Registrierung konnte nicht abgeschlossen werden. Einige f&uuml;r diese Domain registrierte Module sind nicht installiert. Um die Registrierung abzuschliessen, werden diese Module nun installiert.';
$lang['register']['errorWithSerial'] = 'Die Registrierung konnte nicht duchgef&uuml;hrt werden!';
$lang['register']['registerSuccess'] = 'webEdition wurde erfolgreich registriert. Um alle Funktionen von webEdition nutzen zu k&ouml;nnen, wird webEdition nun neu gestartet.';
$lang['register']['registerError'] = 'Die Registrierung konnte nicht abgeschlossen werden. Folgender Fehler trat auf.';
$lang['register']['registerErrorDetail'] = 'Die zur Registrierung ben&ouml;tigten Dateien konnten nicht geschrieben werden!';
...
$lang['upgrade']['registerBeforeUpgrade'] = 'Die Registrierungsdaten Ihrer webEdition 5 Installation weichen von den auf unserem Server gespeicherten Daten ab. Dies kann bspw. passieren, wenn Module f&uuml;r die Domain registriert, aber nicht mehr installiert sind (nach Neuinstallation). Bitte korrigieren Sie diese Informationen &uuml;ber die Update Funktionen von webEdition 5.';
$lang['upgrade']['registerBeforeUpgrade_we4'] = 'Die Registrierungsdaten Ihrer webEdition 4 Installation weichen von den auf unserem Server gespeicherten Daten ab. Dies kann bspw. passieren, wenn Module f&uuml;r die Domain registriert, aber nicht mehr installiert sind (nach Neuinstallation). Bitte korrigieren Sie diese Informationen &uuml;ber die Update Funktionen von webEdition 4.';
$lang['upgrade']['registerBeforeUpgrade_we5light'] = 'Die Registrierungsdaten Ihrer webEdition 5 light Installation weichen von den auf unserem Server gespeicherten Daten ab. Bitte korrigieren Sie diese Informationen &uuml;ber die Update Funktionen von webEdition 5 light.';
