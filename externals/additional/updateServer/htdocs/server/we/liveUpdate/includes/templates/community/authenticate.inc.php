...
//$retryButton = $we_button->create_button("back", $_SERVER[\'PHP_SELF\'] . "?update_cmd=community&detail=authenticateForm");
...
if($authenticated === true) {	
	...
	$content = \'
	<form name="we_form">
	' . updateUtil::getCommonFormFields('community', 'reauthenticateForm') . '
