...
$GLOBALS['lang'] = array('license' =>
	...
	array('headline' => 'Upgrade von webEdition',
		...
		'confirmUpgradeWarningTitle' => 'Zum Fortfahren bitte best&auml;tigen:',
		...
		'repeatUpdateDiskquotaWarning1' => '<br/>Sie haben nur noch <b>',
		'repeatUpdateDiskquotaWarning2' => 'MB</b> freien WebSpace (Quota), <br/><b>Dies wird f&uuml;r eine Updatewiederholung nicht ausreichen!</b>',
		'confirmUpdateWarningEnd' => '',
		'confirmUpdateWarningTitle' => 'Zum Fortfahren bitte best&auml;tigen:',
		'confirmUpdateWarningCheckbox' => 'Hiermit best&auml;tige ich, dass ich die oben stehenden Hinweise gelesen habe.',
		'pleaseSelectVersion' => 'Bitte w&auml;hlen Sie eine Zielversion f&uuml;r das Update.',
		'noUpgradeForLanguages' => 'Ein Update ist momentan nicht m&ouml;glich. Eine oder mehrere installierte Sprachen verhindern das Update.',
		'copyFilesSuccess' => 'Alle ben&ouml;tigten webEdition Dateien wurden angelegt.',
		'copyFilesError' => 'Konnte das alte webEdition Verzeichnis nicht verschieben',
		'copyFilesVersionError' => 'Konnte die Datei version.php nicht anlegen',
		'copyFilesConfError' => 'Konnte die Konfigurationsdatei nicht abspeichern',
		'copyFilesBackupError' => 'Konnte die Backup Ordner nicht Kopieren',
		'copyFilesDirectoryError' => 'Konnte den Ordner %s nicht anlegen',
		'copyFilesMoveDirectoryError' => 'Konnte den Ordner %s nicht verschieben',
		'copyFilesFileError' => 'Konnte die Datei %s nicht kopieren',
		'executePatchesDatabase' => 'Fehler beim Anpassen der Datenbank. Folgende Tabellen konnten nicht angepasst werden.',
		'finishInstallationError' => 'Beim Abschlie&szlig;en des Updates von webEdition ist ein Fehler aufgetreten.<br />\\\\nBitte pr&uuml;fen Sie, ob<br />\\\\n<ul><li>Der webEdition Ordner in webEdition5 umbenannt werden konnte (Gibt es den Ordner /webEdition5 ?)</li>\\\\n<li>Der webEdition6 Ordner in webEdition umbenannt werden konnte (Gibt es den Ordner /webEdition)</li><br />\\\\n<li>Der Backup Ordner nach webEdition/we_backup verschoben werden konnte (Gibt es den Ordner /webEdition/we_backup ?)</li><br />\\\\n<li>Das site Verzeichnis nach /webEdition/site Verzeichnis verschoben werden konnte. (Gibt es den Ordner /webEdition/site ?)</li></ul><br />\\\\nBitte versuchen Sie zun&auml;chst den Aktualisieren Button zu dr&uuml;cken, f&uuml;hren Sie die genannten Ver&auml;nderungen notfalls von Hand aus, bzw. verst&auml;ndigen Sie den Support',
		'finished' => 'Update auf Version 6 abgeschlossen',
		'finished_note' => 'Die Installation ist beendet. Um alle &Auml;nderungen zu &uuml;bernehmen, wird webEdition nun neu gestartet.<br /><strong>Bitte l&ouml;schen Sie vor der n&auml;chsten Anmeldung Ihren Browsercache und f&uuml;hren dann einen Rebuild durch.</strong>',
