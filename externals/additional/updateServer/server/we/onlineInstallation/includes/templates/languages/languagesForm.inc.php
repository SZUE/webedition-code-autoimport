<?php
/**
 * $Id: languagesForm.inc.php 13540 2017-03-12 11:48:37Z mokraemer $
 */
...
document.getElementById('le_extraLanguages[" . $i . "]').disabled = this.checked;";
	...
	$DefaultRadio = str_replace(['"', "'"], ["###", "***"], 'leCheckbox::get("le_defaultLanguage",
	...
	$AdditionalCheckbox = str_replace(['"', "'"], ["###", "***"], 'leCheckbox::get(
								"le_extraLanguages[' . $i . ']",
								"' . $installAbleLanguages[$i] . '",
								' . $Disabled . ',
								"",
