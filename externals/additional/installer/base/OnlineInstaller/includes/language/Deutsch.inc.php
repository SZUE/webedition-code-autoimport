...
$lang["Step"]["HintAboutOnlineInstallation"]["content"] = "Während der Online-Installation werden Daten zu Ihrem Server gesammelt und an den webEdition Server übertragen, um die für Sie relevanten Daten zusammen zu stellen. Anonymisierte Daten zu PHP-Version und installierten PHP-Extensions sowie zur verwendeten Webserver-Version werden dabei für statistische Zwecke gespeichert. Sollten Sie damit nicht einverstanden sein, so steht Ihnen der Tarball-Setup zur Verfügung, den Sie unter download.webedition.org/releases/ herunterladen können.";
...
$lang["Step"]["ConnectionCheck"]["ipResolutionTest"] = "IP-Auflösungstest";
$lang["Step"]["ConnectionCheck"]["dnsResolutionTest"] = "DNS-Auflösungstest";
...
$lang["Step"]["SessionAndCookieTest"]["content"] = "In diesem Schritt wird Ihre PHP-Version überprüft und getestet, ob eine Session auf dem Server gestartet und ein Cookie gesetzt werden kann.";
...
$lang["Step"]["SessionAndCookieTest"]["phpWarning"] = "Für die Installation von webEdition-Versionen neuer als 6.3.9.0 wird PHP mindestens in der Version 5.3.7 benötigt";
