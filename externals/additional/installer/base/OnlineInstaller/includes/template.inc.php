...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<!-- JavaScript Effects -->
		<script id="leJSEffects" src="<?php echo LE_ONLINE_INSTALLER_URL; ?>/js/leEffects.js"></script>

		<!-- JavaScript Form -->
		<script id="leJSForm" src="<?php echo LE_ONLINE_INSTALLER_URL; ?>/js/leForm.js"></script>

		<!-- JavaScript Content -->
		<script id="leJSContent" src="<?php echo LE_ONLINE_INSTALLER_URL; ?>/js/leContent.js"></script>

		<!-- JavaScript Buttons -->
		<script id="leJSButton" src="<?php echo LE_ONLINE_INSTALLER_URL; ?>/js/leButton.js"></script>

		<!-- JavaScript Progress Bar -->
		<script id="leJSProgressBar" src="<?php echo LE_ONLINE_INSTALLER_URL; ?>/js/leProgressBar.js"></script>

		<!-- JavaScript Status Bar -->
		<script id="leJSStatus" src="<?php echo LE_ONLINE_INSTALLER_URL; ?>/js/leStatus.js"></script>

		<!-- external Javascript libraries -->
		<script src="<?php echo LE_ONLINE_INSTALLER_URL; ?>/js/external/prototype.js"></script>
		<script src="<?php echo LE_ONLINE_INSTALLER_URL; ?>/js/external/scriptaculous.js?load=effects"></script>
	...
	<body>
		...
		<form action="<?php print LE_INSTALLER_ADAPTER_URL ?>" target="leLoadFrame" method="post" name="leWebForm">
			...
			if(isset($_SESSION['testUpdate']) && $_SESSION['testUpdate']){
				echo '<input type="hidden" name="testUpdate" value="1" />';
				$_REQUEST['testUpdate'] = 1;
			} else {
				echo '<input type="hidden" name="testUpdate" value="0" />';
