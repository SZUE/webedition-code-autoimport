...
leEffect._runSwitchTheme = function (startColor, endColor, Path, Title, Steps) {
	...
	if (Steps >= 3) {
		...
		window.setTimeout(function () {
			leEffect._runSwitchTheme(startColor, endColor, Path, Title, --Steps);
		}, 1);
		...
		window.setTimeout(function () {
			document.getElementById('leTitle').style.display = "block"
		}, 510);

		new Effect.Appear(document.getElementById('leProduct'), {duration: 0.4});
		window.setTimeout(function () {
			document.getElementById('leProduct').style.display = "block"
		}, 410);
		...
		window.setTimeout(function () {
			document.getElementById('leLogo').style.display = "block"
		}, 210);
...
leEffect._startResizeWide = function (endWidth) {
	...
	window.setTimeout(function () {
		leEffect._runResizeWide(endWidth);
	}, 500);
	...
	window.setTimeout(function () {
		document.getElementById('leCategories').style.display = "block"
	}, 310);
...
leEffect._finishResizeSmall = function () {
	...
	window.setTimeout(function () {
		document.getElementById('leStatus').style.display = "block"
	}, 310);
