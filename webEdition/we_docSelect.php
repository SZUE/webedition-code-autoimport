...
$fs = new we_selector_document(weRequest('int', "id", 0), weRequest('table', "table", (defined('FILE_TABLE') ? FILE_TABLE : 'FF')), weRequest('string', "JSIDName", ""), weRequest('string', "JSTextName", ""), weRequest('raw', "JSCommand", ""), weRequest('raw', "order", ""), 0, weRequest('int', "we_editDirID", 0), weRequest('raw', "we_FolderText", ""), weRequest('raw', "filter", ""), weRequest('int', "rootDirID", 0), weRequest('bool', "open_doc") ? ($table == (defined('FILE_TABLE') ? FILE_TABLE : 'FF') ? permissionhandler::hasPerm("CAN_SELECT_OTHER_USERS_FILES") : ($table == (defined('OBJECT_FILES_TABLE') ? OBJECT_FILES_TABLE : 'OF') ? permissionhandler::hasPerm("CAN_SELECT_OTHER_USERS_OBJECTS") : false)) : false, weRequest('bool', "multiple"), weRequest('bool', "canSelectDir"));
