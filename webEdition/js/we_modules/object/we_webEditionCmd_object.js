...
we_cmd_modules.object = function (args, url) {
	switch (args[0]) {
		...
		case "edit_object":
			new (WE().util.jsWindow)(window, url, "edit_module", 380, 250, true, true, true, true);
			break;
		case "new_objectFile":
		...
		case "object_preview_objectFile":
			new (WE().util.jsWindow)(window, url, "preview_object", 1600, 1200, true, true, true, true);
			break;
		case "object_create_tmpfromClass":
			new (WE().util.jsWindow)(window, url, "tmpfromClass", 580, 200, true, false, true, false);
			break;
		case "open_object":
			...
			new (WE().util.jsWindow)(window, url, "we_dirChooser", WE().consts.size.docSelect.width, WE().consts.size.docSelect.height, true, true, true);
			break;
