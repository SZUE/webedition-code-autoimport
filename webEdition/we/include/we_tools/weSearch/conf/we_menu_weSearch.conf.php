...
$we_menu_weSearch['000200']['text'] = g_l('searchtool', '[menu_new]');
...
if(we_hasPerm('CAN_SEE_DOCUMENTS')){
	$we_menu_weSearch['000300']['text'] = g_l('searchtool', '[forDocuments]');
...
if($_SESSION["we_mode"] != "seem" && we_hasPerm('CAN_SEE_TEMPLATES')){
	$we_menu_weSearch['000400']['text'] = g_l('searchtool', '[forTemplates]');
...
if(defined('OBJECT_FILES_TABLE') && defined('OBJECT_TABLE') && we_hasPerm('CAN_SEE_OBJECTFILES')){
	$we_menu_weSearch['000500']['text'] = g_l('searchtool', '[forObjects]');
...
$we_menu_weSearch['000600']['text'] = g_l('searchtool', '[menu_advSearch]');
...
//$we_menu_weSearch['000700']['text'] = g_l('searchtool','[menu_new_group]');
...
$we_menu_weSearch['000800']['text'] = g_l('searchtool', '[menu_save]');
...
$we_menu_weSearch['000900']['text'] = g_l('searchtool', '[menu_delete]');
...
$we_menu_weSearch['001000']['text'] = g_l('searchtool', '[menu_exit]');
...
$we_menu_weSearch['003000']['text'] = g_l('searchtool', '[menu_help]');
$we_menu_weSearch['003000']['parent'] = '000000';
$we_menu_weSearch['003000']['perm'] = '';
$we_menu_weSearch['003000']['enabled'] = '1';

$we_menu_weSearch['003100']['text'] = g_l('searchtool', '[menu_help]') . '...';
...
$we_menu_weSearch['003200']['text'] = g_l('searchtool', '[menu_info]') . '...';
