...
$_credits = '<br /><span style="line-height:160%">'
			...
			.$l_global["with"].' <b><a href="http://www.webedition.org/credits/?&language='.$GLOBALS["WE_LANGUAGE"].'" target="_blank" >'.$l_global["credits_team"].'</a></b></span><br/>';
//version='.str_replace(".","",WE_VERSION).'
