...
if(isset($GLOBALS["loginpage"]) && $GLOBALS["loginpage"]){
	...
	$_loginTable->setCol($loginRow++, 0, array("width" => $_leftPart), we_html_tools::htmlTextInput('username', 25, '', 255, 'id="username" style="width: 250px;" onkeydown="if (event.keyCode == 13||event.keyCode == 10){form.submit();}" ', 'text', 0, 0));
