...
$l_alert=array(
	...
	'field_input_contains_incorrect_length'=>'Die maximale Länge eines Feldes vom Typ `Textinput` beträgt 4095 Zeichen. Wenn Sie mehr Zeichen benötigen, dann verwenden Sie ein Feld vom Typ `Textarea`.',
