...
$l_button['new_voting']['value'] = 'Nouveau vote';
$l_button['new_voting']['alt']   = 'Créer un nouveau vote ...';
$l_button['new_voting']['width'] = 150;

$l_button['new_voting_group']['value'] = 'New group';
$l_button['new_voting_group']['alt']   = 'Créer un groupe ...';
$l_button['new_voting_group']['width'] = 150;

$l_button['reset_score']['value'] = 'Reset scores';
$l_button['reset_score']['alt']   = 'Remettre les scores ...';
