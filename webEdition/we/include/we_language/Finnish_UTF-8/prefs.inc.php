...
$l_prefs = array(
		 ...
		 * LANGUAGE
		 */
		'choose_language' => "Kieli",
		'language_notice' => "Kielenmuutos tulee voimaan webEditionin uudelleenkäynnistyksen jälkeen.",
		/**
		 * CHARSET
		 */
		...
		'seem_start_type_weapp' => "WE-App",// TRANSLATE
	...
	Lisää tietoa löytyy Online-dokumentaatiosta.<br /><br />Salli koukkujen käyttö?",
		...
		'disable_template_code_check' => "Deactivate check for invalid<br />code (php)",//TRANSLATE
		/**
		 * ERROR HANDLER
		 */
