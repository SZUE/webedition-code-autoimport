...
<td class="middlefont">' . g_l('prefs', '[language_notice]') . '
			...
			case 'language':
				...
				return self::create_dialog('', $settings) . $postJs;
...
// Check if we need to save settings
		...
		if($doSave && !$acError){
			...
			$form = we_html_element::htmlForm(['onSubmit' => 'return false;', 'name' => 'we_form', 'method' => 'post', 'action' => $_SERVER['SCRIPT_NAME']], we_html_element::htmlHidden('save_settings', 0) . self::render_dialog());
