...
' . ( $_SESSION['weS']['weBackupVars']['options']['rebuild'] ?
	...
	case 'rebuild':
		echo we_html_element::jsElement('
new (WE().util.jsWindow)(top.opener, top.opener.top.openWindow(WE().consts.dirs.WEBEDITION_DIR+"we_cmd.php?we_cmd[0]=rebuild&step=2&btype=rebuild_all&responseText=' . g_l('backup', '[finished_success]') . '", "rebuildwin", 600, 130,true, 0, true);
top.close();
');
		break;
