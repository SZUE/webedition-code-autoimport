...
'), we_html_element::htmlBody(array('class' => 'weDialogBody', 'onload' => 'self.focus();'), we_html_element::htmlExIFrame('passwdcontent', getContent(), 'position:absolute;top:0px;bottom:1px;left:0px;right:0px;') .
		getLoad()
));
