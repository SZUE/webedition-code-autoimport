		...
		if($we_doc->ID){
			switch($we_doc->ContentType){
				...
				case we_base_ContentTypes::OBJECT:
					$normalTable->addCol(2);
					$normalTable->setColContent(0, $pos++, we_html_button::create_button('fat:make_new_object,fa-lg fa-file', "javascript:top.we_cmd('new','" . OBJECT_FILES_TABLE . "','','" . we_base_ContentTypes::OBJECT_FILE . "','" . $we_doc->ID . "');WE().layout.weEditorFrameController.getActiveEditorFrame().setEditorMakeNewDoc(false);"));
					break;
			}
		}
