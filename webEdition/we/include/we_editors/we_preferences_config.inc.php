...
// Variables for thumbnails
		'WE_THUMBNAIL_DIRECTORY' => array('Directory in which to save thumbnails', '/_thumbnails_'),
...
//versions
		...
		'VERSIONING_TEXT_WETMPL' => array('Versioning status for ContentType text/weTmpl', 1),
		'VERSIONING_TEXT_JS' => array('Versioning status for ContentType text/js', 1),
		'VERSIONING_TEXT_CSS' => array('Versioning status for ContentType text/css', 1),
		...
		'VERSIONS_ANZAHL' => array('Versioning Number of Versions', 3),
...
//security
		...
		'SECURITY_ENCRYPTION_TYPE_PASSWORD' => array('Determines how passwords are handled', (defined('CUSTOMER_TABLE') && (f('SELECT COUNT(1)  FROM ' . CUSTOMER_TABLE) > 5) ? we_customer_customer::ENCRYPT_NONE : we_customer_customer::ENCRYPT_HASH)),
...
//key => default-val, permission. default true
		...
		'editorHighlightCurrentLine' => array(1),
		'editorTheme' => array('elegant'),
