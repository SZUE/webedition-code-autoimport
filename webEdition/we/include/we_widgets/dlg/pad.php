...
$parts[] = array(
	"headline" => g_l('cockpit', '[default_priority]'), "html" => $prio->getHTML(), 'space' => we_html_multiIconBox::SPACE_SMALL
);
...
$parts[] = array(
	"headline" => g_l('cockpit', '[default_validity]'), "html" => $oSctValid, 'space' => we_html_multiIconBox::SPACE_SMALL
);
...
$parts[] = array(
	"headline" => g_l('cockpit', '[title]'), "html" => $oSctTitle, 'space' => we_html_multiIconBox::SPACE_SMALL
);
$parts[] = array(
	"headline" => g_l('cockpit', '[bg_color]'), "html" => $oSctCls->getHTML(), 'space' => we_html_multiIconBox::SPACE_SMALL
);
