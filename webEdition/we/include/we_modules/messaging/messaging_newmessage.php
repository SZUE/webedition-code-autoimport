...
<script><!--
	...
	function selectRecipient() {
		...
		new (WE().util.jsWindow)(window, WE().consts.dirs.WE_MESSAGING_MODULE_DIR + "messaging_usel.php?we_transaction=<?= $transaction; ?>&rs=" + rs, "messaging_usel", 530, 420, true, false, true, false);
