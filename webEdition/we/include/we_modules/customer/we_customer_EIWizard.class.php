...
class we_customer_EIWizard{
	...
	function getHTMLCustomer(){
		...
		$custs = new we_chooser_multiDir(400, ($customers ? $customers : array()), "del_customer", we_html_button::create_button_table(array($delallbut, $addbut)), "", "Icon,Path", CUSTOMER_TABLE);
