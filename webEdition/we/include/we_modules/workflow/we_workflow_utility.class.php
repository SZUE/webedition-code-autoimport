...
abstract class we_workflow_utility{
	...
	static function getLogButton($docID, $table){
		$type = self::getTypeForTable($table);
		return we_html_button::create_button('logbook', "javascript:new (WE().util.jsWindow)(window, WE().consts.dirs.WEBEDITION_DIR + 'we_showMod.php?mod=workflow&pnt=log&art=" . $docID . "&type=" . $type . "','workflow_history',640,480,true,false,true);");
	}
