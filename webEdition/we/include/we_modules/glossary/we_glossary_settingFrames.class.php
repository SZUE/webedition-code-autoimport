...
class we_glossary_settingFrames{
	...
	function getHTMLFrameset(){
		return
			we_html_tools::getHtmlTop(''/* FIXME: missing title */, '', '', we_html_element::jsScript(JS_DIR . 'formFunctions.js'), we_html_element::htmlBody(array('class' => 'weDialogBody')
	...
	' . we_html_element::htmlHidden('cmd', 'save_glossary_setting') . '
