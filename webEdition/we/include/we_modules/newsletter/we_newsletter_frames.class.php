...
top.content.treeData.add(top.content.node.prototype.rootEntry(\'' . $pid . '\',\'root\',\'root\'));'
	...
	function getHTMLCustomer($group){
		...
		if($this->View->newsletter->groups[$group]->SendAll == 0){
			...
			$addbut = we_html_button::create_button(we_html_button::ADD, "javascript:we_cmd('we_customer_selector','','" . CUSTOMER_TABLE . "','','','opener.we_cmd(\'add_customer\',top.fileSelect.data.allIDs.join(\',\')," . $group . ");','','','',1)");
