...
class we_cache_file implements we_cache_base{
	...
	public static function save($entry, array $data, $expiry = 3600, $serializer = SERIALIZE_PHP){
		$ser = we_serialize($data, $serializer); //keep this php, since encoding etc. works better & faster in all modes
