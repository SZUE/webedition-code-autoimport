...
abstract class we_base_jsConstants{
	...
	private static function getMainJSLangConsts(){
		...
		return 'WE().consts.g_l=JSON.parse("' . we_base_util::setLangString(
				[
					'main' => [
					...
					'alert' => [
						...
						'apply_filter_isHot' => g_l('modules_customerFilter', '[apply_filter_isHot]'),
						...
						'copy_folders_no_id' => g_l('alert', '[copy_folders_no_id]'),
						...
						'notCheckedContentType' => g_l('versions', '[notCheckedContentType]'),
						'notCheckedDate' => g_l('versions', '[notCheckedDate]'),
