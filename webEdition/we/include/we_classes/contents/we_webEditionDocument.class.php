...
// tag we:control exists
	...
	public function getPropertyPage(we_base_jsCmd $jsCmd){
		...
		return we_html_multiIconBox::getHTML('PropertyPage', [
				...
				['icon' => we_html_multiIconBox::PROP_META, 'headline' => g_l('weClass', '[metainfo]'), 'html' => $this->formMetaInfos(), 'space' => we_html_multiIconBox::SPACE_MED2],
				...
				['icon' => we_html_multiIconBox::PROP_COPY, 'headline' => g_l('weClass', '[copyWeDoc]'), 'html' => $this->formCopyDocument(), 'space' => we_html_multiIconBox::SPACE_MED2],
