...
class we_document_video extends we_binaryDocument{
	...
	<tr valign="top">
		<td>' . $this->formSelectElement(155, "autoplay", array(1 => g_l('global', '[true]'), 0 => g_l('global', '[false]')), "attrib", 1, array('onchange' => '_EditorFrame.setEditorIsHot(true);')) . '</td>
		<td>' . we_html_tools::getPixel(18, 2) . '</td>
	...
	<tr valign="top">
		<td>' . $this->formSelectElement(155, "mute", array(1 => g_l('global', '[true]'), 0 => g_l('global', '[false]')), "attrib", 1, array('onchange' => "_EditorFrame.setEditorIsHot(true);")) . '</td>' .
			'<td>' . we_html_tools::getPixel(18, 2) . '</td>
		<td>' . $this->formSelectElement(155, "loop", array(1 => g_l('global', '[true]'), 0 => g_l('global', '[false]')), "attrib", 1, array('onchange' => "_EditorFrame.setEditorIsHot(true);")) . '</td>
		<td>' . we_html_tools::getPixel(18, 2) . '</td>
		<td>' . $this->formInput2(155, "name", 10, "attrib", "onchange=\"_EditorFrame.setEditorIsHot(true);\"") . '</td>
	</tr>
</table>' .
