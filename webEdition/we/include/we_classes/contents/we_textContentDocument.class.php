...
abstract class we_textContentDocument extends we_textDocument{
	...
	function formDocType2($width = 300, $disable = false){
		...
		return $this->formSelect2($width, 'DocType', DOC_TYPES_TABLE, 'ID', 'DocType', g_l('weClass', '[doctype]'), 'WHERE ' . we_docTypes::getDoctypeQuery($this->DB_WE), 1, $this->DocType, false, (($this->DocType !== '') ?
