...
';
	...
	static function formCategory($categories, $catAnd){
		...
		$addbut = we_html_button::create_button(we_html_button::ADD, "javascript:document.we_form.btype[2].checked=true;we_cmd('we_selector_category',-1,'" . CATEGORY_TABLE . "','','','add_cat')", false, 100, 22);
