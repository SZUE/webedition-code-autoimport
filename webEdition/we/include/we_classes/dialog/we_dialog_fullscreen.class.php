 ...
 * $Rev: 13343 $
 * $Author: lukasimhof $
 * $Date: 2017-02-10 17:53:12 +0100 (Fr, 10 Feb 2017) $
 *
 ...
 */
class we_dialog_fullscreen extends we_dialog_base{
	...
	public static function getDialog($noInternals = true){
		$inst = new we_dialog_fullscreen($noInternals);
		$inst->initByHttp();
	...
	protected function getJs(){
		return parent::getJs() .
			...
			we_html_element::jsScript(JS_DIR . 'dialogs/we_dialog_fullscreen.js', 'self.focus();');
	}
