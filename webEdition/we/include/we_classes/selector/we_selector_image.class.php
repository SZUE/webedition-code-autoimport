...
class we_selector_image extends we_selector_document{
	...
	protected function printHeaderTable(we_base_jsCmd $weCmd,$extra = '', $append = true){
		return parent::printHeaderTable($weCmd,
				'<td id="' . we_search_view::VIEW_ICONS . '" style="display:none">' . we_html_button::create_button('fa:iconview,fa-lg fa-th', "javascript:setview('" . we_search_view::VIEW_ICONS . "');", '', 0, "", "", "", false) . '</td>
		<td id="' . we_search_view::VIEW_LIST . '">' . we_html_button::create_button('fa:listview,fa-lg fa-align-justify-lg fa-align-justify', "javascript:setview('" . we_search_view::VIEW_LIST . "');", '', 0, "", "", "", false) . '</td>', true);
	}
