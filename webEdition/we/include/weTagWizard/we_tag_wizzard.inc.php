...
if(strpos($GLOBALS["WE_LANGUAGE"],'Deutsch') !== false) {$GLOBALS['TagRefURL']="docu.webedition.de/de/webedition/tag-reference/";} else {$GLOBALS['TagRefURL']="docu.webedition.de/en/webedition/tag-reference/";}
