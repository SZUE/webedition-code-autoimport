...
if(strpos($GLOBALS["WE_LANGUAGE"],'Deutsch') !== false) {$GLOBALS['TagRefURL']="documentation.webedition.de/de/webedition/tag-reference/";} else {$GLOBALS['TagRefURL']="documentation.webedition.de/en/webedition/tag-reference/";}
