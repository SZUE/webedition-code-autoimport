...
['id817_id'] = new weTagData_selectorAttribute('817', 'id',FILE_TABLE, 'folder', false, ''); } $GLOBALS['weTagWizard']['attribute']['id816_doc'] = new weTagData_selectAttribute('816', 'doc', array(new weTagDataOption('top', false, ''), new weTagDataOption('self', false, '')), false, ''); 
?>