...
if(defined("FILE_TABLE")) { $GLOBALS['weTagWizard']['attribute']['id158_onsuccess'] = new weTagData_selectorAttribute('158', 'onsuccess',FILE_TABLE, 'text/webedition', false, ''); }
if(defined("FILE_TABLE")) { $GLOBALS['weTagWizard']['attribute']['id159_onerror'] = new weTagData_selectorAttribute('159', 'onerror',FILE_TABLE, 'text/webedition', false, ''); }
if(defined("FILE_TABLE")) { $GLOBALS['weTagWizard']['attribute']['id160_onmailerror'] = new weTagData_selectorAttribute('160', 'onmailerror',FILE_TABLE, 'text/webedition', false, ''); }
if(defined("FILE_TABLE")) { $GLOBALS['weTagWizard']['attribute']['id161_onrecipienterror'] = new weTagData_selectorAttribute('161', 'onrecipienterror',FILE_TABLE, 'text/webedition', false, ''); }
...
if(defined("TEMPLATES_TABLE")) { $GLOBALS['weTagWizard']['attribute']['id175_tid'] = new weTagData_selectorAttribute('175', 'tid',TEMPLATES_TABLE, 'text/weTmpl', false, ''); }
if(defined("OBJECT_TABLE")) { $GLOBALS['weTagWizard']['attribute']['id177_classid'] = new weTagData_selectorAttribute('177', 'classid',OBJECT_TABLE, 'object', false, 'object'); }
