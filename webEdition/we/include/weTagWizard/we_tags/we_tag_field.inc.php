...
$onlyImg = new weTagData_selectAttribute('only', array(new weTagDataOption('name', false, ''), new weTagDataOption('path', false, ''), new weTagDataOption('parentpath', false, ''), new weTagDataOption('filename', false, ''), new weTagDataOption('extension', false, ''), new weTagDataOption('filesize', false, ''),new weTagDataOption('width', false, ''),new weTagDataOption('height', false, ''),new weTagDataOption('src', false, ''),new weTagDataOption('alt', false, '')), false, '');
