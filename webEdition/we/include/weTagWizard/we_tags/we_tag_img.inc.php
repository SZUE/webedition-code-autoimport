...
$this->Attributes[] = new weTagData_choiceAttribute('only', [new weTagDataOption('width', false, ''),
...
$this->Attributes[] = new weTagData_selectAttribute('showimage', [new weTagDataOption('false', false, '')], false, '');
...
$this->Attributes[] = new weTagData_selectAttribute('sizingstyle', [new weTagDataOption('none', false, ''), new weTagDataOption('em', false, ''), new weTagDataOption('ex', false, ''), new weTagDataOption('%', false, ''), new weTagDataOption('px', false, '')], false, '');
