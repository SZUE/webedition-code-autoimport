...
$this->Attributes[] = new weTagData_choiceAttribute('browser', [new weTagDataOption(we_base_browserDetect::IE),
...
$this->Attributes[] = new weTagData_choiceAttribute('system', [new weTagDataOption(we_base_browserDetect::SYS_WIN),
