...
$fs = new we_<?php echo $TOOLNAME; ?>DirSelector(we_base_request::_(we_base_request::INT,'id',we_base_request::_(we_base_request::INT,'we_cmd',0,1)),
							isset($JSIDName) ? $JSIDName : we_base_request::_(we_base_request::STRING,'we_cmd','',2),
							isset($JSTextName) ? $JSTextName : we_base_request::_(we_base_request::STRING,'we_cmd','',3),
