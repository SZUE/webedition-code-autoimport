...
var specialUnload =<?php echo intval(!(we_base_browserDetect::isChrome() || we_base_browserDetect::isSafari())); ?>;
	...
	var WebEdition = {
		...
		consts: {
			...
			g_l: {
				main: {
					unable_to_call_setpagenr: '<?php echo we_message_reporting::prepareMsgForJS(g_l('global', '[unable_to_call_setpagenr]')); ?>',
					...
					eplugin_exit_doc: "<?php echo we_message_reporting::prepareMsgForJS(g_l('alert', '[eplugin_exit_doc]')); ?>",
					delete_single_confirm_delete: "<?php echo we_message_reporting::prepareMsgForJS(g_l('alert', '[delete_single][confirm_delete]')); ?>\n",
					...
					unable_to_call_ping: '<?php echo we_message_reporting::prepareMsgForJS(g_l('global', '[unable_to_call_ping]')); ?>',
				...
				message_reporting: {
					notice: "<?php echo we_message_reporting::prepareMsgForJS(g_l('alert', '[notice]')); ?>",
					warning: "<?php echo we_message_reporting::prepareMsgForJS(g_l('alert', '[warning]')); ?>",
					error: "<?php echo we_message_reporting::prepareMsgForJS(g_l('alert', '[error]')); ?>",
					msgNotice: "<?php echo we_message_reporting::prepareMsgForJS(g_l('messageConsole', '[iconBar][notice]')); ?>",
					msgWarning: "<?php echo we_message_reporting::prepareMsgForJS(g_l('messageConsole', '[iconBar][warning]')); ?>",
					msgError: "<?php echo we_message_reporting::prepareMsgForJS(g_l('messageConsole', '[iconBar][error]')); ?>",
				},
				alert: {
					browser_crashed: '<?php echo we_message_reporting::prepareMsgForJS(g_l('alert', '[browser_crashed]')); ?>',
					confirm_applyFilterFolder: "<?php echo we_message_reporting::prepareMsgForJS(g_l('alert', '[confirm][applyWeDocumentCustomerFiltersFolder]')); ?>",
					confirm_applyFilterDocument: "<?php echo we_message_reporting::prepareMsgForJS(g_l('alert', '[confirm][applyWeDocumentCustomerFiltersDocument]')); ?>",
					copy_folder_not_valid: "<?php echo we_message_reporting::prepareMsgForJS(g_l('alert', '[copy_folder_not_valid]')); ?>",
					exit_multi_doc_question: "<?php echo we_message_reporting::prepareMsgForJS(g_l('alert', '[exit_multi_doc_question]')); ?>",
					in_wf_warning: {
				...
				move: "<?php echo we_message_reporting::prepareMsgForJS(g_l('alert', '[move]')); ?>",
				move_exit_open_docs_question: "<?php echo we_message_reporting::prepareMsgForJS(g_l('alert', '[move_exit_open_docs_question]')); ?>",
				move_exit_open_docs_continue: "<?php echo we_message_reporting::prepareMsgForJS(g_l('alert', '[move_exit_open_docs_continue]')); ?>",
				},
				cockpit: {
					increase_size: '<?php echo we_message_reporting::prepareMsgForJS(g_l('cockpit', '[increase_size]')); ?>',
					not_activated: '<?php echo we_message_reporting::prepareMsgForJS(g_l('alert', '[cockpit_not_activated]')); ?>',
					pre_remove: '<?php echo we_message_reporting::prepareMsgForJS(g_l('cockpit', '[pre_remove]')); ?>"',
					post_remove: '" <?php echo we_message_reporting::prepareMsgForJS(g_l('cockpit', '[post_remove]')); ?>',
					reduce_size: '<?php echo we_message_reporting::prepareMsgForJS(g_l('cockpit', '[reduce_size]')); ?>',
					reset_settings: '<?php echo we_message_reporting::prepareMsgForJS(g_l('alert', '[cockpit_reset_settings]')); ?>',
				},
				editorScript: {
					confirm_navDel: "<?php echo we_message_reporting::prepareMsgForJS(g_l('navigation', '[del_question]')); ?>",
					gdTypeNotSupported: "<?php echo we_message_reporting::prepareMsgForJS(g_l('weClass', '[type_not_supported_hint]')); ?>",
					noRotate: "<?php echo we_message_reporting::prepareMsgForJS(g_l('weClass', '[rotate_hint]')); ?>",
					field_int_value_to_height: "<?php echo we_message_reporting::prepareMsgForJS(g_l('alert', '[field_int_value_to_height]')); ?>",
					field_contains_incorrect_chars: '<?php echo we_message_reporting::prepareMsgForJS(g_l('alert', '[field_contains_incorrect_chars]')); ?>',
					field_input_contains_incorrect_length: '<?php echo we_message_reporting::prepareMsgForJS(g_l('alert', '[field_input_contains_incorrect_length]')); ?>',
					field_int_contains_incorrect_length: '<?php echo we_message_reporting::prepareMsgForJS(g_l('alert', '[field_int_contains_incorrect_length]')); ?>',
					fieldNameNotValid: '<?php echo we_message_reporting::prepareMsgForJS(g_l('modules_object', '[fieldNameNotValid]')); ?>',
					fieldNameNotTitleDesc: '<?php echo we_message_reporting::prepareMsgForJS(g_l('modules_object', '[fieldNameNotTitleDesc]')); ?>',
					fieldNameEmpty: '<?php echo we_message_reporting::prepareMsgForJS(g_l('modules_object', '[fieldNameEmpty]')); ?>'
				},
				selectors: {
				},
...
?>
	...
	<body id="weMainBody" onload="initWE();
		top.start('<?php echo $table_to_load; ?>');
		startMsg();
		updateCheck();" onbeforeunload ="return doUnload();">
