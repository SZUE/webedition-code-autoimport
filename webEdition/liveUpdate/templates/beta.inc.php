...
<tr>
	<td></td><td><form name="betaform" action="'.$_SERVER['PHP_SELF'] . '?section=beta" method="post">'.we_forms::checkboxWithHidden($_REQUEST["testUpdate"], 'setTestUpdate', $GLOBALS['l_liveUpdate']['beta']['lookForUpdate'], '','defaultfont' , 'betaform.submit()').'</form>
		<br />
		<br />
	</td>
</tr>
