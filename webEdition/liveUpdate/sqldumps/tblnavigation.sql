...
CREATE TABLE ###TBLPREFIX###tblnavigation (
  ...
  DocTypeID smallint(6) unsigned NOT NULL default '0',
  ...
  CatParameter smalltext NOT NULL,
  Parameter smalltext NOT NULL,
  LinkSelection smalltext NOT NULL,
  Url smalltext NOT NULL,
  ...
  FolderParameter smalltext NOT NULL,
  FolderUrl smalltext NOT NULL,
  LimitAccess tinyint(1) unsigned NOT NULL default '0',
  AllCustomers tinyint(1) unsigned NOT NULL default '1',
  ApplyFilter tinyint(1) unsigned NOT NULL default '0',
