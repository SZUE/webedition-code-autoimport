...
$ac3->setContentType(we_base_ContentTypes::TEMPLATE);
$ac3->setWidth(320);
//$ac3->setOnChange('');
...
$ac7->setContentType('folder,' . we_base_ContentTypes::IMAGE);
$ac7->setWidth(360);
//$ac7->setOnChange('');
...
$ac9->setContentType('folder,' . we_base_ContentTypes::IMAGE);
$ac9->setWidth(380);
//$ac9->setOnChange('');
...
$htmlPage->addHTML('<br><br>Grafik-Selektor (ContentType=folder,' . we_base_ContentTypes::IMAGE . ')<br>');
...
$htmlPage->addHTML('<br><br>Grafik-Selektor 2 (ContentType=folder,' . we_base_ContentTypes::IMAGE . ')<br>');
