...
class we_ui_controls_Button extends we_ui_abstract_AbstractFormElement{
	...
	public function _renderHTML(){
		...
		//FIXME: make css
		return we_html_element::htmlDiv(['style' => 'margin: ' . $this->_margin . ';'], we_html_button::create_button($this->getButtonContent(), $this->getHref(), '', 0, 0, $this->getOnClick(), $this->getTarget(), $this->getDisabled(), false, '', false, $this->getTitle(), $this->getClass(), $this->getId(), $this->_isTextReady, array_filter($dimensions)));
	}
