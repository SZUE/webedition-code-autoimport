...
class we_ui_controls_SelectCustomerfield extends we_ui_controls_Select{
	...
	public function __construct($properties = null){
		...
		if(in_array('customer', $GLOBALS['_we_active_integrated_modules'])){
			if(file_exists(WE_INCLUDES_PATH . 'we_modules/customer/we_conf_customer.inc.php')){
				include_once (WE_INCLUDES_PATH . 'we_modules/customer/we_conf_customer.inc.php');
				$db = new DB_WE();
