...
$l_import['import_templates'] = 'Template import'; // TRANSLATE
...
$l_import['txt_file_import'] = 'Import one or more files from the local hard drive.'; // TRANSLATE
...
$l_import['txt_site_import'] = 'Import files from the root-directory of the server. Set filter options to choose if images, HTML pages, Flash, JavaScript, or CSS files, plain-text documents, or other types of files are to be imported.'; // TRANSLATE
