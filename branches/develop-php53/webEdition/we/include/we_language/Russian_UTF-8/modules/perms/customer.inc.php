...
$l_perm['customer']['perm_group_title'] = 'Управление клиентами';

$l_perm['customer']['NEW_CUSTOMER'] = 'Право добавления новых клиентов';
$l_perm['customer']['DELETE_CUSTOMER'] = 'Право удаления клиентов';
