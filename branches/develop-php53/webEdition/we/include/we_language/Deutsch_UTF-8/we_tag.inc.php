...
$l_we_tag['redirectObjectSeoUrls']['description']="Dieser Tag sollte in der Vorlage von einem als ErrorDocument 404 definierten WE-Dokument ganz am Anfang eingesetzt werden und sorgt bei Objekt SEO-Urls dafür, dass das Objekt identifiziert und mit dem richtigen Dokument dargestellt wird. \n Das Attribut 'hiddendirindex=true' sorgt dafür, das auch versteckte DirectoyIndex-Dateien (z.B. index.php) gefunden werden. Wird kein passendes Objekt bzw. das zur Darstellung zu verwendende Dokument gefunden, so wird ein Status 404 not found ausgegeben, ansonsten wird der Status 200 OK ausgegeben.";
