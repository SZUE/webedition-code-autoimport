...
$l_we_editor["object"]["response_save_ok"] = "The class '%s' was successfully saved!";
$l_we_editor["object"]["response_publish_ok"] = "The class '%s' was successfully published!";
$l_we_editor["object"]["response_unpublish_ok"] = "The class '%s' was successfully unpublished!";
...
$l_we_editor["objectFile"]["response_save_ok"] = "The object '%s' was successfully saved!";
$l_we_editor["objectFile"]["response_publish_ok"] = "The object '%s' was successfully published!";
$l_we_editor["objectFile"]["response_publish_notok"] = "Error while publishing object '%s'!";
$l_we_editor["objectFile"]["response_unpublish_ok"] = "The object '%s' was successfully unpublished!";
$l_we_editor["objectFile"]["response_unpublish_notok"] = "Error while unpublishing object '%s'!";
...
$l_we_editor["objectFile"]["response_save_noperms_to_create_folders"] = "The object could not be saved, because you do not have the neccessary rights to create folders (%s)!";
$l_we_editor["objectFile"]["autoschedule"] = "The object will be published automatically on %s.";
?>