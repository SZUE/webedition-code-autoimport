				...
				if(eTable==""){
					...
					switch(eTable){
						case "<?php echo FILE_TABLE; ?>":
								if((isFolder&&wePerms.DELETE_DOC_FOLDER)||wePerms.DELETE_DOCUMENT) {
								hasPerm = 1;
							}
							break;
						case "<?php echo TEMPLATES_TABLE; ?>":
								if((isFolder&&wePerms.DELETE_TEMP_FOLDER)||wePerms.DELETE_TEMPLATE) {
								hasPerm = 1;
							}
							break;
						case "<?php echo defined("OBJECT_FILES_TABLE") ? OBJECT_FILES_TABLE : -1; ?>":
								if((isFolder&&wePerms.DELETE_OBJECTFILE)||wePerms.DELETE_OBJECTFILE) {
								hasPerm = 1;
							}
							break;
						case "<?php echo defined('OBJECT_TABLE') ? OBJECT_TABLE : -2; ?>":
								if(!isFolder&&wePerms.DELETE_OBJECT) {
								hasPerm = 1;
							}
							break;
						}
