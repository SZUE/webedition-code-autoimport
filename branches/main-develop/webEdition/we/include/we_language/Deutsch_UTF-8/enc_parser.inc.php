...
$GLOBALS['l_parser']['wrong_type'] = 'Der Wert von \'type\' ist nicht zulässig!';
...
$GLOBALS['l_parser']['invalid_chars'] =  'Der Name des Tags <code>&lt;we:%s&gt;</code> enthält ungültige Zeichen. Erlaubt sind nur Buchstaben, Zahlen, "-" und "_"!';
