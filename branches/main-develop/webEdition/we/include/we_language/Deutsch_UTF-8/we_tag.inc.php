...
$l_we_tag['addDelNewsletterEmail']['description'] = "Dieses Tag erzeugt, schreibt oder entfernt eine Email aus der Newsletter-Empfänger-Liste. Die Empfänger-Listen werden als CSV-Datei gespeichert und können dann beim Versand im Newslettermodul verwendet werden.";
$l_we_tag['addDelShopItem']['description'] = "Das we:addDelShopItem-Tag ermöglicht das Hinzufügen oder Wegnehmen eines Artikels aus dem Warenkorb.";
$l_we_tag['addPercent']['description'] = "Das we:addPercent-Tag ermöglicht das Addieren eines gewissen Prozentsatzes, beispielsweise für die Mehrwertsteuer.";
$l_we_tag['addPercent']['defaultvalue'] = "";
$l_we_tag['answers']['description'] = "Dieses Tag dient der Ausgabe der Antwortmöglichkeiten eines Votings.";
...
$l_we_tag['bannerSelect']['description'] = "Mit diesem Tag wird ein DropDown-Menü (&lt;select&gt;) erzeugt, um Werbebanner auszuwählen. Wenn customer auf true gesetzt ist (bei installierter Kundenverwaltung), werden nur die Banner des eingeloggten Kunden angezeigt.";
...
$l_we_tag['block']['description'] = "Mit dem we:block-Tag kann man erweiterbare Blöcke/Listen erzeugen. Alles, was zwischen Start- und Endtag steht, wird im Bearbeitungsmodus durch einen Klick auf den Plus-Button angehängt, bzw. eingefügt. Dies können beliebiges HTML sowie fast alle we:tags sein.";
$l_we_tag['block']['defaultvalue'] = "";
$l_we_tag['calculate']['description'] = "Das we:calculate-Tag erlaubt alle möglichen mathematischen Operationen. (*, /, +, -,(), sqrt.....)";
...
$l_we_tag['category']['description'] = "Das we:category Tag wird durch die Kategorie(n) ersetzt, die in der Ansicht \"Eigenschaft\" dem Dokument zugeordnet wurden. Wenn es mehrere Kategorien sind, werden sie durch Kommas getrennt. Wenn Sie ein anderes Trennzeichen verwenden möchten, können Sie dies mit dem Attribut \"delimiter\" zuweisen. Bsp.: delimiter = \" \" (Hier wird ein Leerzeichen verwendet um die Kategorien zu trennen.)";
$l_we_tag['categorySelect']['description'] = "Mit diesem Tag wird ein DropDown-Menü (&lt;select&gt;) erzeugt, um Kategorien auszuwählen. Wenn man gleich nach dem Starttag das Endtag setzt, dann werden automatisch alle in webEdition definierten Kategorien angezeigt.";
$l_we_tag['categorySelect']['defaultvalue'] = "";
$l_we_tag['charset']['description'] = "Das Tag we:charset generiert eine Meta-Angabe, die bestimmt mit welchem Zeichensatz die fertige Seite angezeigt wird. Für deutsche Seiten wird normalerweise der Zeichensatz \"ISO-8859-15\" verwendet. Dieser Tag muss innerhalb der &lt;head&gt;&lt;/head&gt; Tags der HTML-Seite stehen.";
...
$l_we_tag['colorChooser']['description'] = "Das we:colorChooser Tag erzeugt ein Eingabefeld um Farbwerte auszuwählen";
...
$l_we_tag['conditionAdd']['description'] = "Dieses Tag fügt der mit &lt;we:condition&gt; eingeleiteten Bedingung eine neue Regel/Vergleich hinzu.";
$l_we_tag['conditionAnd']['description'] = "Dieses Tag verknüpft Regeln/Vergleiche mit anderen Regeln/Vergleichen innerhalb von &lt;we:condition&gt; mit einer UND Verknüpfung. Beide Regeln/Vergleiche müssen erfüllt sein, damit die Bedingung wahr (true) wird.";
$l_we_tag['conditionOr']['description'] = "Dieses Tag verknüpft Regeln/Vergleiche mit anderen Regeln/Vergleichen innerhalb von &lt;we:condition&gt; mit einer OR Verknüpfung. Eine der beiden Regeln/Vergleiche muß erfüllt sein, damit die Bedingung wahr (true) wird.";
$l_we_tag['content']['description'] = "&lt;we:content /&gt; wird nur innerhalb einer Hauptvorlage eingesetzt. Es markiert die Fläche, in die der Inhalt der Detailvorlage innerhalb der Hauptvorlage eingebunden wird.";
$l_we_tag['controlElement']['description'] = "Mit dem Tag we:controlElement können Schaltflächen in der Bearbeiten-Ansicht eines Dokuments gezielt manipuliert werden. Buttons können ausgeblendet werden. Checkboxen können aktiviert, disabled und/oder versteckt werden.";
$l_we_tag['cookie']['description'] = "Dieser Tag wird vom Voting Modul benötigt und setzt einen Cookie, der Mehrfachabstimmungen eines Besuchers verhindert. Der Tag muss ganz am Anfang der Vorlage stehen, es dürfen sich keine Zeichen (inkl. Leerzeichen und Zeilenumbruch) vor diesem Tag befinden.";
$l_we_tag['createShop']['description'] = "Das we:createShop-Tag wird auf jeder Seite benötigt, die Shop-Daten enthalten soll.";
$l_we_tag['css']['description'] = "Das we:css-Tag erzeugt ein HTML-Tag, das auf ein webEdition-internes CSS Stylesheet mit der unten angegebenen ID verweist. Dadurch können Sie Stylesheets in einer separaten Datei definieren.";
...
$l_we_tag['dateSelect']['description'] = "Das we:dateSelect-Tag gibt ein Auswahlfeld für ein Datum zurück, welches im Zusammenhang mit dem Tag we:processDateSelect in eine Variable als Unix Timestamp eingelesen werden kann.";
...
$l_we_tag['deleteShop']['description'] = "Das we:deleteShop-Tag löscht den kompletten Warenkorb.";
...
$l_we_tag['DID']['description'] = "Dieses Tag gibt die ID eines webEdition-Dokuments zurück.";
$l_we_tag['docType']['description'] = "Dieses Tag gibt den Dokumenttyp eines webEdition-Dokuments zurück.";
...
$l_we_tag['field']['description'] = "Das we:field-Tag wird benötigt, um den Inhalt eines Datenbankfeldes des zugehörigen Listview-Eintrages anzuzeigen. Das we:field-Tag darf nur innerhalb des we:repeat Start- und Endtags stehen.";
...
$l_we_tag['form']['description'] = "Das we:form Tag wird für Such- und Mailformulare eingesetzt. Es funktioniert wie das normale HTML-Form-Tag, jedoch werden zusätzliche Hidden-Fields vom Parser eingefügt.";
$l_we_tag['form']['defaultvalue'] = "";
$l_we_tag['formfield']['description'] = "Dieses Tag dient zum Anlegen und Bearbeiten von Formularfeldern.";
$l_we_tag['formmail']['description'] = "Bei eingeschalteter Einstellung Formmail über webEdition-Dokument aufrufen, erfolgt die Einbindung des Formmail-Scripts über ein webEdition-Dokument. Hierfür wird der neue (derzeit noch parameterlose) we-Tag formmail verwendet.<br />Wird die Captcha-Prüfung eingesetzt, steht &lt;we:formmail/&gt; innerhalb des we-Tags ifCaptcha.";
...
$l_we_tag['hidePages']['description'] = "Das we:hidePages-Tag ermöglicht es, bestimmte Modi eines Dokuments zu deaktivieren. Dieses Tag kann dazu eingesetzt werden, um den Zugriff auf die Eigenschaftsseite eines Dokuments zu verhindern. Dadurch kann dieses Dokument bspw. nicht mehr geparkt werden.";
...
$l_we_tag['ifCaptcha']['description'] = "Dieses Tag dient dazu, den umschlossenen Inhalt nur dann anzuzeigen bzw. auszuführen, wenn der vom User eingegebene Code gültig ist.";
$l_we_tag['ifCaptcha']['defaultvalue'] = "";
$l_we_tag['ifCat']['description'] = "Das we:ifCat-Tag bewirkt, daß alles, was zwischen dem Start- und Endtag steht, nur dann angezeigt wird, wenn die in \"categories\" eingetragenen Kategorien dem Dokument zugewiesen wurden.";
$l_we_tag['ifCat']['defaultvalue'] = "";
$l_we_tag['ifNotCat']['description'] = "Das we:ifNotCat-Tag bewirkt, daß alles, was zwischen dem Start- und Endtag steht, nur dann angezeigt wird, wenn die in \"categories\" eingetragenen Kategorien nicht dem Dokument zugewiesen wurden.";
$l_we_tag['ifNotCat']['defaultvalue'] = "";
$l_we_tag['ifClient']['description'] = "Das we:ifClient-Tag bewirkt, daß alles, was zwischen dem Start- und Endtag steht, nur dann angezeigt wird, wenn der Client (Browser) den vorgegebenen Anforderungen entspricht. Dieses Tag funktioniert nur bei dynamisch abgespeicherten Seiten!";
$l_we_tag['ifClient']['defaultvalue'] = "";
$l_we_tag['ifConfirmFailed']['description'] = "Nutzt man DoubleOptIn bei der Anmeldung zum Newslettermodul, kann mit &lt;we:ifConfirmFailed&gt; überprüft werden, ob die gegebene E-Mail Adresse bestätigt werden konnte.";
...
$l_we_tag['ifDoctype']['description'] = "Das we:ifDoctype-Tag bewirkt, daß alles, was zwischen dem Start- und Endtag steht, nur dann angezeigt wird, wenn der in \"doctype\" eingetragene Dokument-Typ dem Dokument zugewiesen wurde.";
...
$l_we_tag['ifField']['description'] = "Das we:ifField-Tag wird benötigt, um den umschlossenen Inhalt nur dann anzuzeigen, wenn der Wert des Datenbankfeldes des zugehörigen Listview-Eintrages gleich dem Wert des Attributes \"match\" ist. Das we:ifField-Tag darf nur innerhalb des we:repeat Start- und Endtags stehen.";
$l_we_tag['ifField']['defaultvalue'] = "";
$l_we_tag['ifFieldEmpty']['description'] = "Das we:ifFieldEmpty-Tag bewirkt, daß alles, was zwischen dem Start- und Endtag steht, nur dann angezeigt wird, wenn das Feld einer we:listview, das den in \"match\" eingetragenen Namen hat, leer ist. Im Attribut \"type\" muss der Typ des Feldes angegeben werden, wenn es sich um ein \"img\", \"flashmovie\" oder \"href\" Feld handelt.";
...
$l_we_tag['ifFound']['description'] = "Dieses Tag dient dazu, den umschlossenen Inhalt nur dann anzuzeigen, wenn bei einer &lt;we:listview&gt; Einträge gefunden werden.";
$l_we_tag['ifFound']['defaultvalue'] = "";
$l_we_tag['ifHasChildren']['description'] = "Innerhalb des we:repeat Tags kann mit &lt;we:ifHasChildren&gt; abgefragt werden, ob der aktuelle Kategorie-Ordner Kategorien enthält bzw. die Kategorie Kinder hat.";
...
$l_we_tag['ifHasEntries']['description'] = "Mit we:ifHasEntries kann innerhalb eines we:navigationEntry Inhalt nur ausgegeben werden, wenn der auszugebende Navigationseintrag Einträge besitzt";
...
$l_we_tag['ifHtmlMail']['description'] = "Dieses Tag dient dazu, den umschlossenen Inhalt nur dann anzuzeigen, wenn es sich um Inhalt für einen Newsletter im HTML-Format handelt.";
...
$l_we_tag['ifLogin']['description'] = "Dieses Tag dient dazu, den umschlossenen Inhalt nur dann anzuzeigen, wenn ein Login auf der Seite durchgef�hrt wurde und erm�glicht damit Initialisierungen.";
$l_we_tag['ifLogin']['defaultvalue'] = "";
$l_we_tag['ifLogout']['description'] = "Dieses Tag dient dazu, den umschlossenen Inhalt nur dann anzuzeigen, wenn ein Logout auf der Seite durchgef�hrt wurde und erm�glicht damit Aufr�umarbeiten.";
...
$l_we_tag['ifTdNotEmpty']['description'] = "Dieses Tag dient dazu, den umschlossenen Inhalt nur dann anzuzeigen, wenn eine Tabellenzelle in einer Listview nicht leer ist (also Inhalte vorhanden sind).";
$l_we_tag['ifTdNotEmpty']['defaultvalue'] = "";
$l_we_tag['ifMailingListEmpty']['description'] = "Dieses Tag dient dazu, den umschlossenen Inhalt nur dann anzuzeigen, wenn der Newsletterinteressent keinen Newsletter ausgewählt hat.";
$l_we_tag['ifMailingListEmpty']['defaultvalue'] = "";
$l_we_tag['ifMale']['description'] = "Dieses Tag dient dazu, den umschlossenen Inhalt innerhalb eines Newsletters nur dann anzuzeigen, wenn die männliche Anrede angezeigt werden soll.";
...
$l_we_tag['ifNewsletterSalutationEmpty']['description'] = "Dieses Tag dient dazu, den umschlossenen Inhalt innerhalb eines Newsletters nur dann anzuzeigen, wenn das in type definierte Anredefeld leer ist.";
$l_we_tag['ifNewsletterSalutationEmpty']['defaultvalue'] = "";
$l_we_tag['ifNewsletterSalutationNotEmpty']['description'] = "Dieses Tag dient dazu, den umschlossenen Inhalt innerhalb eines Newsletters nur dann anzuzeigen, wenn das in type definierte Anredefeld nicht leer ist.";
$l_we_tag['ifNewsletterSalutationNotEmpty']['defaultvalue'] = "";
$l_we_tag['ifNotNewsletterSalutation']['description'] = "Dieses Tag dient dazu, den umschlossenen Inhalt innerhalb eines Newsletters nur dann anzuzeigen, wenn das in type definierte Anredefeld dem Wert in match nicht entspricht.";
$l_we_tag['ifNotNewsletterSalutation']['defaultvalue'] = "";
$l_we_tag['ifNext']['description'] = "Dieses Tag dient dazu, den umschlossenen Inhalt nur dann anzuzeigen, wenn es bei einer Listview auch eine nächste Seite gibt. Gibt es keine nächste Seite, dann wird der umschlossene Inhalt nicht angezeigt.";
$l_we_tag['ifNext']['defaultvalue'] = "";
$l_we_tag['ifNoJavaScript']['description'] = "Dieses Tag dient dazu, den Browser auf ein webEdition-Dokument umzuleiten, falls im Browser des Users JavaScript deaktiviert bzw. nicht verfügbar ist. Das Tag darf nur im Headerbereich der HTML-Seite (zwischen &lt;head&gt; und &lt;/head&gt;) verwendet werden.";
$l_we_tag['ifNotCaptcha']['description'] = "Dieses Tag dient dazu, den umschlossenen Inhalt nur dann anzuzeigen, wenn der vom User eingegebene Code ungültig ist.";
$l_we_tag['ifNotCaptcha']['defaultvalue'] = "";
$l_we_tag['ifNotDeleted']['description'] = "Wenn ein Dokument/Objekt durch das Tag we:delete gelöscht wurde, wird alles zwischen Start- und Endtag angezeigt, wenn das Löschen nicht erfolgreich war.";
$l_we_tag['ifNotDeleted']['defaultvalue'] = "";
$l_we_tag['ifNotDoctype']['description'] = "Umschlossenen Inhalt nur anzeigen, wenn das Dokument nicht zu einem der im Attribut \"doctypes\" angegebenen Dokumenttypen gehört.";
$l_we_tag['ifNotDoctype']['defaultvalue'] = "";
$l_we_tag['ifNotEditmode']['description'] = "Dieses Tag dient dazu, den umschlossenen Inhalt nur außerhalb des Edit-Modus anzuzeigen.";
$l_we_tag['ifNotEditmode']['defaultvalue'] = "";
$l_we_tag['ifNotEmpty']['description'] = "Das we:ifNotEmpty-Tag bewirkt, daß alles, was zwischen dem Start- und Endtag steht, nur dann angezeigt wird, wenn das Feld, das den in \"match\" eingetragenen Namen hat,  nicht leer ist. Im Attribut \"type\" muss der Typ des Feldes angegeben werden, wenn es sich um ein \"img\", \"flashmovie\" oder \"href\" Feld handelt.";
...
$l_we_tag['ifNotField']['description'] = "Das we:ifNotField-Tag wird benötigt, um den umschlossenen Inhalt nur dann anzuzeigen, wenn der Wert des Datenbankfeldes des zugehörigen Listview-Eintrages nicht gleich dem Wert des Attributes \"match\" ist. Das we:ifNotField-Tag darf nur innerhalb des we:repeat Start- und Endtags stehen.";
$l_we_tag['ifNotField']['defaultvalue'] = "";
$l_we_tag['ifNotFound']['description'] = "Dieses Tag dient dazu, den umschlossenen Inhalt nur dann anzuzeigen, wenn bei einer &lt;we:listview&gt; keine Einträge gefunden werden.";
$l_we_tag['ifNotFound']['defaultvalue'] = "";
$l_we_tag['ifNotHtmlMail']['description'] = "Dieses Tag dient dazu, den umschlossenen Inhalt nur dann anzuzeigen, wenn es sich nicht um Inhalt für einen Newsletter im HTML-Format handelt.";
...
$l_we_tag['ifNotPosition']['description'] = "Mit dem Tag we:ifNotPosition kann man eine Aktion definieren, die an einer bestimmten Position eines Blocks, einer Listview, einer Linklist oder einer Listdir NICHT ausgeführt wird. Der Parameter \"position\" erlaubt eine vielseitige Eingabe der Position. So ist es möglich, die erste (first), letze (last), alle geraden (even), bzw ungeraden (odd), sowie einzelne Positionen (1,2,3, ...) abzuprüfen. Wird der type \"block\", \"linklist\" verwendet, muss zusätzlich der Name (reference) des entsprechenden Blocks/Linklist angegeben werden.";
$l_we_tag['ifNotPosition']['defaultvalue'] = "";
$l_we_tag['ifNotRegisteredUser']['description'] = "Prüft, ob ein User nicht registriert ist.";
$l_we_tag['ifNotRegisteredUser']['defaultvalue'] = "";
$l_we_tag['ifNotReturnPage']['description'] = "Dieses Tag dient dazu, den umschlossenen Inhalt nach dem Ändern/Erzeugen von einem webEdition-Dokument bzw. Objekt nur dann anzuzeigen, wenn der Wert des Attributs \"return\" von &lt;we:a edit=\"true\"&gt; gleich \"false\" ist oder das Attribut nicht gesetzt wurde.";
...
$l_we_tag['ifNotSelf']['description'] = "Das we:ifNotSelf-Tag bewirkt, daß alles, was zwischen dem Start- und Endtag steht, nicht angezeigt wird, wenn das Dokument eine der unten eingetragenen ID's hat. Befindet sich das Tag nicht innerhalb von we:linklist oder we:listdir Tags, dann ist \"id\" ein erforderlicher Eintrag!";
...
$l_we_tag['ifNotVar']['description'] = "Das we:ifNotVar-Tag bewirkt, daß alles, was zwischen dem Start- und Endtag steht, nicht angezeigt wird, wenn die Variable mit dem Namen \"name\" gleich dem Wert ist, welcher in \"match\" eingetragen ist. Im Attribut \"type\" kann angegeben werden, um welchen Typ von Variable es sich handelt.";
$l_we_tag['ifNotVar']['defaultvalue'] = "";
$l_we_tag['ifNotVarSet']['description'] = "Mit diesem Tag kann man prüfen, ob eine Variable mit dem Namen name nicht gesetzt ist. Achtung: Es ist ein Unterschied ob eine Variable leer ist oder nicht gesetzt wurde!";
...
$l_we_tag['ifNotWorkspace']['description'] = "&Uuml;berprüft, ob sich ein Dokument NICHT in dem unter \"path\" angegeben Arbeitsbereich befindet.";
$l_we_tag['ifNotWorkspace']['defaultvalue'] = "";
$l_we_tag['ifNotWritten']['description'] = "Alle was zwischen Start- und Endtag steht, wird nur angezeigt, wenn es einen Fehler beim Schreiben eines Dokuments/Objekts mit dem Tag we:write gab. Bei einem Objekt muß type=\"object\" sein.";
...
$l_we_tag['ifPosition']['description'] = "Mit dem Tag we:ifPosition ist es möglich die aktuelle Position eines Blocks, einer Listview, einer Linklist oder einer Listdir zu kontrollieren. Der Parameter \"position\" erlaubt eine vielseitige Eingabe der Position. So ist es möglich das Erste (first), Letze (last), alle geraden (even), bzw ungeraden (odd), sowie einzelne Positionen (1,2,3, ...) abzuprüfen. Wird der type \"block\", \"linklist\" verwendet, muss zusätzlich der Name (reference) des entsprechenden Blocks/Linklist angegeben werden.";
$l_we_tag['ifPosition']['defaultvalue'] = "";
$l_we_tag['ifRegisteredUser']['description'] = "Prüft, ob ein User registriert ist oder nicht.";
$l_we_tag['ifRegisteredUser']['defaultvalue'] = "";
$l_we_tag['ifRegisteredUserCanChange']['description'] = "Prüft, ob das aktuelle Dokument/Objekt von einem registrierten Kunden verändert werden kann. In einer listview wird das Dokument/Objekt des aktuellen listview-Eintrags benutzt.";
$l_we_tag['ifRegisteredUserCanChange']['defaultvalue'] = "";
$l_we_tag['ifReturnPage']['description'] = "Dieses Tag dient dazu, den umschlossenen Inhalt nach dem Ändern/Erzeugen eines webEdition-Dokuments bzw. Objekts nur dann anzuzeigen, wenn der Wert das Attributs \"return\" von &lt;we:a edit=\"document\"&gt; bzw. &lt;we:a edit=\"object\"&gt; gleich \"true\" ist.";
...
$l_we_tag['ifShopVat']['description'] = "Mit we:ifShopTag kann man den Mehrwertsteuersatz, des aktuellen Artikels des Dokuments, bzw. des Warenkorbs prüfen. Ist Id gesetzt, wird die des Mehrwertsteuersatzes des aktuellen (Dokument oder Warenkorb) Artikels mit der hier angegeben verglichen.";
...
$l_we_tag['ifVar']['description'] = "Das we:ifVar-Tag bewirkt, daß alles, was zwischen dem Start- und Endtag steht, nur dann angezeigt wird, wenn die Variable mit dem Namen \"name\" gleich dem Wert ist, welcher in \"match\" eingetragen ist. Im Attribut \"type\" kann angegeben werden, um welchen Typ von Variable es sich handelt.";
$l_we_tag['ifVar']['defaultvalue'] = "";
$l_we_tag['ifVarEmpty']['description'] = "Prüft, ob eine Variable leer ist. Ist dies der Fall, wird alles zwischen Start- und Endtag angezeigt.";
$l_we_tag['ifVarEmpty']['defaultvalue'] = "";
$l_we_tag['ifVarNotEmpty']['description'] = "Prüft, ob eine Variable nicht leer ist. Ist dies der Fall, wird alles zwischen Start- und Endtag angezeigt.";
$l_we_tag['ifVarNotEmpty']['defaultvalue'] = "";
$l_we_tag['ifVarSet']['description'] = "Mit diesem Tag kann man prüfen, ob eine Variable mit dem Namen name gesetzt ist. Achtung: Es ist ein Unterschied ob eine Variable leer ist oder nicht gesetzt wurde!";
...
$l_we_tag['ifWorkspace']['description'] = "&Uuml;berprüft, ob sich das Dokument in dem unter \"path\" bzw. \"id\" angegeben Arbeitsbereich befindet.";
$l_we_tag['ifWorkspace']['defaultvalue'] = "";
$l_we_tag['ifWritten']['description'] = "Alle was zwischen Start- und Endtag steht, wird nur angezeigt, wenn es keinen Fehler beim Schreiben eines Dokuments/Objekts mit dem Tag we:write gab. Bei einem Objekt muß type=\"object\" sein.";
...
$l_we_tag['input']['description'] = "Das we:input-Tag bewirkt, daß im Bearbeitungsmodus des Dokumentes, das diese Vorlage zugrunde liegen hat, ein einzeiliges Eingabefeld erzeugt wird, wenn der Typ = \"text\" ausgewählt wird. Für die anderen Typen siehe Handbuch oder Hilfe.";
$l_we_tag['js']['description'] = "Das we:js-Tag erzeugt ein HTML-Tag, das auf ein webEdition-internes Javascript-Dokument mit der unten angegebenen ID verweist. Dadurch können Sie Javascripts in einer separaten Datei definieren.";
$l_we_tag['keywords']['description'] = "Das we:keywords-Tag erzeugt ein Schlüsselwort Meta-Tag. Alles zwischen Start- und Endtag wird als default-keywords eingetragen, falls das Schlüsselwortfeld in der Ansicht \"Eigenschaft\" leer ist. Ansonsten werden die Schlüsselworte aus der Ansicht \"Eigenschaft\" eingetragen.";
$l_we_tag['link']['description'] = "Das we:link-Tag erzeugt einen einzelnen Link, der durch einen Button \"edit\" verändert werden kann. Wird das Tag innerhalb von Linklisten verwendet, so darf das Attribut \"name\" nicht angegeben werden. Wird das Tag außerhalb von Linklisten verwendet, dann muß das Attribut \"name\" angegeben werden!Das Attribut only kann dazu eingesetzt werden nur ein einzelnes Attribut  (only=\"Attributname\") oder den Inhalt (only=\"content\") auszugeben.";
...
$l_we_tag['linkToSeeMode']['description'] = "Dieser Tag erzeugt auf der Web-Seite einen Link, der das eben besuchte Dokument im seeMode von webEdition öffnet und somit einfach bearbeitet werden kann.";
$l_we_tag['list']['description'] = "Mit dem we:list-Tag kann man erweiterbare Listen erzeugen. Alles, was zwischen Start- und Endtag steht, wird im Bearbeitungsmodus durch einen Klick auf den Plus-Button angehängt, bzw. eingefügt. Dies können beliebiges HTML sowie fast alle we:tags sein.";
...
$l_we_tag['listviewRows']['description'] = "Dieses Tag gibt die Anzahl aller gefundenen Einträge einer &lt;we:listview&gt; aus.";
...
$l_we_tag['master']['description'] = "Wird in einer Detailvorlage verwendet und fügt den umschlossenen Inhalt beim we:content Tag im Mastertemplate ein. Die Verknüpfung zu we:content wird über das Attribut \"name\" hergestellt. (we:master name=\"head\" =&gt; we:content name=\"head\").<br /><br />Inhalt der Detailvorlage außerhalb des we:master Tags wird weiterhin beim we:content ohne Name eingesetzt.";
$l_we_tag['master']['defaultvalue'] = "";
$l_we_tag['metadata']['description'] = "Das we:metadata-Tag wird benötigt, um die Metadatenfelder von eingebundenen Bildern, Flash-Movies und Quicktime-Movies darzustellen. Innerhalb des we:metadata Start- und Endtags kann man die Metadatenfelder mit we:field-Tags darstellen. Im Attribut \"name\" muss der Name des darzustellenden Elements angegeben werden.";
...
$l_we_tag['navigationEntries']['description'] = "Dient innerhalb eines we:navigationEntry type=\"folder\" als Platzhalter für alle Einträge eines Ordners der Navigation.";
...
$l_we_tag['navigationField']['description'] = "Mit dem Tag &lt;we:navigationField&gt; kann innerhalb eines &lt;we:navigationEntry&gt; ein Wert des aktuellen Navigationseintrags ausgegeben werden.<br/> Wählen Sie dabei <b>entweder</b> einen Eintrag für das Attribut <i>name</i>, <b>oder</b> einen Eintrag für das Attribut <i>attributes</i>, <b>oder</b> einen Eintrag für das Attribut <i>complete</i>";
$l_we_tag['navigationWrite']['description'] = "Wird benutzt um eine we:navigation mit gegebenem Name zu schreiben.";
$l_we_tag['newsletterConfirmLink']['description'] = "Dieser Tag dient dazu, einen Bestätigungs-Link für einen Double-Opt-In zu erstellen. Ein Newsletter-Interessent kann so bestätigen, dass er den Newsletter abonnieren möchte.";
$l_we_tag['newsletterConfirmLink']['defaultvalue'] = "Newsletter bestätigen";
$l_we_tag['newsletterField']['description'] = "Ein Feld aus dem Empfängerdatensatz der Kundenverwaltung innerhalb eines Newsletters anzeigen.";
...
$l_we_tag['next']['description'] = "Das we:next-Tag erzeugt ein HTML-Link-Tag, das auf die nächste we:listview-Seite verweist. Der gesamte Inhalt zwischen Start- und Endtag wird verlinkt.";
$l_we_tag['next']['defaultvalue'] = "";
$l_we_tag['noCache']['description'] = "Innerhalb dieses Tags kann PHP-Code stehen, welcher bei einer gecachten Vorlage (Ausnahme: Full-Cache) immer ausgeführt werden soll.";
$l_we_tag['noCache']['defaultvalue'] = "";
$l_we_tag['object']['description'] = "Das we:object-Tag wird benötigt, um Objekte darzustellen. Innerhalb des we:object Start- und Endtags kann man Felder des Objekts mit we:field-Tags darstellen. Ist nur das Attribut \"name\" gesetzt, erscheint im Edit Mode ein Objekt-Selector, in dem der Redakteur aus allen vorhandenen Objekten aller Klassen auswählen kann. Schränkt man mit dem Attribut \"classid\" durch Angabe der ID einer Klasse die Auswahl ein, können jetzt nur noch Objekte dieser Klasse ausgewählt werden. Im Attribut \"id\" kann man ein festes Objekt der gesetzten classid bestimmen. Das Attribut \"triggerid\" wird gebraucht, um bei einer statisch erzeugten Objekt-Listview ein dynamisches Dokument anzugeben, welches bei Objekt-Links benötigt wird, um das entsprechende Objekt darzustellen.";
$l_we_tag['object']['defaultvalue'] = "";
$l_we_tag['pagelogger']['description'] = "Das we:pagelogger-Tag erzeugt je nach gewähltem Attribut \"type\" den von pageLogger erforderlichen Erfassungscode oder den Fileserver- bzw. Download-Code.";
...
$l_we_tag['paypal']['description'] = "we:paypal stellt eine Schnittstelle zu paypal zur Verfügung. Damit können sie Ihre Verkäufe bequem über einen Payment-Provider abwickeln. Beachten Sie hierbei, dass sie im Backend des Shop Moduls weitere Parameter angeben müssen.";
...
$l_we_tag['postlink']['description'] = "Das we:postlink-Tag wird benötigt, um Code einzugrenzen, welcher beim letzten Durchlauf der Linkliste nicht angezeigt werden soll.";
$l_we_tag['postlink']['defaultvalue'] = "";
$l_we_tag['prelink']['description'] = "Das we:prelink-Tag wird benötigt, um Code einzugrenzen, welcher beim ersten Durchlauf der Linkliste nicht angezeigt werden soll.";
...
$l_we_tag['saferpay']['description'] = "we:saferpay stellt eine Schnittstelle zu saferpay zur Verfügung. Damit können sie Ihre Verkäufe bequem über einen Payment-Provider abwickeln. Beachten Sie hierbei, dass sie im Backend des Shop Moduls weitere Parameter angeben müssen.";
$l_we_tag['saveRegisteredUser']['description'] = "Dieses Tag dient zum Abspeichern von Kundendaten die über Sessionfields eingegeben wurden.";
...
$l_we_tag['sessionField']['description'] = "Das we:sessionField-Tag erzeugt ein HTML Input, Select oder Textarea-Tag, welches für die Eingabe von Session-Feldern (Kundendaten oä.) verwendet wird.";
$l_we_tag['sessionLogout']['description'] = "Das we:sessionLogout-Tag erzeugt ein HTML-Link-Tag, das auf ein webEdition-internes Dokument mit der unten angegebenen ID verweist. Wenn das angegebene Dokument ein we:sessionStart-Tag besitzt und dynamisch gespeichert wurde, dann wird die aktuelle Session gelöscht.";
...
$l_we_tag['setVar']['description'] = "Mit we:setVar können verschiedene Arten von Variablen gesetzt werden.<br/><strong>Achtung:</strong> Ohne gesetztes Attribut <strong>striptags</strong> werden dabei HTML- und PHP-Code mit übertragen, dies ist ein potenzielles <strong>Sicherheitsrisiko!</strong>";
$l_we_tag['shipping']['description'] = "we:shipping ermittelt die bei einem Einkauf fälligen Versandkosten. Dabei wird auf den Wert des Warenkorbs, das Herkunftsland des eingeloggten Kunden und die innerhalb des Shop Moduls eingepflegten Regeln für Porto- und Versandkosten zugegriffen, um die anfallenden Kosten zu ermitteln. Mit dem Parameter \"sum\" übergibt man den Namen einer mit we:sum errechneten Summe. Mit dem Parameter type kann gezielt der Netto- (net), bzw. Brutto- (gros) Betrag sowie der Mehrwertsteueranteil (vat) ermittelt werden.";
$l_we_tag['shopField']['description'] = "Mit we:shopField können verschiedene Felder direkt bei Artikeln, bzw. im Warenkorb (Bestellung) abgespeichert werden. Diese Felder können vom Administrator mit verschiedenen Werten festgelegt werden, die der Endkunde dann einstellen kann. Neben Artikel-Varianten ist es damit möglich, eine Vielzahl von verschiedenen Artikelvariationen auf einfache Weise abzubilden.";
$l_we_tag['ifShopFieldEmpty']['description'] = "Prüft, ob ein shopField leer ist. Ist dies der Fall, wird alles zwischen Start- und Endtag angezeigt.";
$l_we_tag['ifShopFieldNotEmpty']['description'] = "Prüft, ob ein shopField nicht leer ist. Ist dies der Fall, wird alles zwischen Start- und Endtag angezeigt.";
$l_we_tag['ifShopField']['description'] = "Das Tag bewirkt, daß alles, was zwischen dem Start- und Endtag steht, nur dann angezeigt wird, wenn das shopField mit dem Namen \"name\" gleich dem Wert ist, welcher in \"match\" eingetragen ist. Ist dies der Fall, wird alles zwischen Start- und Endtag angezeigt.";
$l_we_tag['ifNotShopField']['description'] = "Das Tag bewirkt, daß alles, was zwischen dem Start- und Endtag steht, nur dann angezeigt wird, wenn das shopField mit dem Namen \"name\" ungleich dem Wert ist, welcher in \"match\" eingetragen ist. Ist dies der Fall, wird alles zwischen Start- und Endtag angezeigt.";


$l_we_tag['shopVat']['description'] = "Mit we:shopVat ist es möglich einen Mehrwertsteuersatz für einen Artikel festzulegen. Mehrwertsteuersätze können direkt im Shop Modul gepflegt werden. Ist Id gesetzt, wird der Mehrwertsteuersatz mit der angegebenen Id ausgegeben.";
...
$l_we_tag['sidebar']['description'] = "Dieses Tag dient dazu einen Button im Bearbeitenmodus eines Dokumentes zum öffnen einer Webseite in der Sidebar zu öffnen einzubinden.";
$l_we_tag['sidebar']['defaultvalue'] = "Sidebar öffnen";
...
$l_we_tag['tr']['description'] = "Das &lt;we:tr&gt; Tag entspricht dem HTML-tag &lt;tr&gt; und dient der Definition einer Tabellenzeile.<br />Beim Einsatz in einer Listview erzwingt der Tag alle x Datensätze eine neue Tabellenzeile, wobei x die Anzahl der im Listview Parameter cols eingestellten Spalten ist.";
...
$l_we_tag['useShopVariant']['description'] = "Das we:shopVariant-Tag übernimmt die Daten einer per Namen übergebenen Artikel-Variante. Existiert kein Artikel-Variante mit gegebenem Namen, wird der Original-Artikel verwendet.";
...
$l_we_tag['xmlfeed']['description'] = "Das we:xmlfeed Tag lädt den XML-Inhalt von der eingegebenen URL.";
...
$l_we_tag['ifbannerexists']['description'] = "Führt den eingeschlossenen Code nur aus, wenn das Banner-Modul nicht deaktiviert wurde (Einstellungsdialog).";
$l_we_tag['ifbannerexists']['defaultvalue'] = "";
$l_we_tag['ifcustomerexists']['description'] = "Führt den eingeschlossenen Code nur aus, wenn das Kundenverwaltungs-Modul nicht deaktiviert wurde (Einstellungsdialog).";
$l_we_tag['ifcustomerexists']['defaultvalue'] = "";
$l_we_tag['ifnewsletterexists']['description'] = "Führt den eingeschlossenen Code nur aus, wenn das Newsletter-Modul nicht deaktiviert wurde (Einstellungsdialog).";
$l_we_tag['ifnewsletterexists']['defaultvalue'] = "";
$l_we_tag['ifobjektexists']['description'] = "Führt den eingeschlossenen Code nur aus, wenn das Objekt/DB-Modul nicht deaktiviert wurde (Einstellungsdialog).";
$l_we_tag['ifobjektexists']['defaultvalue'] = "";
$l_we_tag['ifshopexists']['description'] = "Führt den eingeschlossenen Code nur aus, wenn das Shop-Modul nicht deaktiviert wurde (Einstellungsdialog).";
$l_we_tag['ifshopexists']['defaultvalue'] = "";
$l_we_tag['ifvotingexists']['description'] = "Führt den eingeschlossenen Code nur aus, wenn das Voting-Modul nicht deaktiviert wurde (Einstellungsdialog).";
...
$l_we_tag['ifNotHasChildren']['description'] = "Innerhalb des we:repeat Tags kann mit &lt;we:ifNotHasChildren&gt; abgefragt werden, ob der aktuelle Kategorie-Ordner Kategorien enthält bzw. die Kategorie Kinder hat.";
...
$l_we_tag['ifNotHasEntries']['description'] = "Mit we:ifNotHasEntries kann innerhalb eines we:navigationEntry Inhalt nur ausgegeben werden, wenn der auszugebende Navigationseintrag KEINE Einträge besitzt";
$l_we_tag['ifNotHasEntries']['defaultvalue'] = "";
$l_we_tag['ifPageLanguage']['description'] = "Mit we:ifPageLanguage kann auf die Spracheinstellung des Dokumentes getestet werden, dabei können mehrere Werte durch Komma separiert angegeben werden (oder-Verknüpfung). Die möglichen Werte ergeben sich aus dem Einstellungsdialog, Tab 'Sprachen'.";
$l_we_tag['ifPageLanguage']['defaultvalue'] = "";
$l_we_tag['ifNotPageLanguage']['description'] = "Mit we:ifNotPageLanguage kann auf die Spracheinstellung des Dokumentes getestet werden, dabei können mehrere Werte durch Komma separiert angegeben werden (oder-Verknüpfung). Die möglichen Werte ergeben sich aus dem Einstellungsdialog, Tab 'Sprachen'.";
$l_we_tag['ifNotPageLanguage']['defaultvalue'] = "";
$l_we_tag['ifObjectLanguage']['description'] = "Mit we:ifObjectLanguage kann auf die Spracheinstellung des Objectes getestet werden, dabei können mehrere Werte durch Komma separiert angegeben werden (oder-Verknüpfung). Die möglichen Werte ergeben sich aus dem Einstellungsdialog, Tab 'Sprachen'.";
$l_we_tag['ifObjectLanguage']['defaultvalue'] = "";
$l_we_tag['ifNotObjectLanguage']['description'] = "Mit we:ifObjectLanguage kann auf die Spracheinstellung des Objectes getestet werden, dabei können mehrere Werte durch Komma separiert angegeben werden (oder-Verknüpfung). Die möglichen Werte ergeben sich aus dem Einstellungsdialog, Tab 'Sprachen'.";
$l_we_tag['ifNotObjectLanguage']['defaultvalue'] = "";
$l_we_tag['ifSendMail']['description'] = "Prüft, ob eine Seite gerade mit we:sendMail versendet wird und erlaubt Inhalte dabei aus- und einzublenden";
$l_we_tag['ifSendMail']['defaultvalue'] = "";
$l_we_tag['ifNotSendMail']['description'] = "Prüft, ob eine Seite gerade mit we:sendMail versendet wird und erlaubt Inhalte dabei aus- und einzublenden";
...
$l_we_tag['ifVotingField']['description'] = "&Uuml;berprüft ob ein VotingField einen Wert entsprechend dem Attribut match hat, die Kombinationen von name und type Attributen entsprechen denen des we:votingFiled-Tags";
$l_we_tag['ifNotVotingField']['description'] = "&Uuml;berprüft ob ein VotingField keinen Wert entsprechend dem Attribut match hat, die Kombinationen von name und type Attributen entsprechen denen des we:votingFiled-Tags";
$l_we_tag['ifVotingFieldEmpty']['description'] = "&Uuml;berprüft ob ein VotingField leer ist, die Kombinationen von name und type Attributen entsprechen denen des we:votingFiled-Tags";
$l_we_tag['ifVotingFieldNotEmpty']['description'] = "&Uuml;berprüft ob ein VotingField nicht leer ist, die Kombinationen von name und type Attributen entsprechen denen des we:votingFiled-Tags";
