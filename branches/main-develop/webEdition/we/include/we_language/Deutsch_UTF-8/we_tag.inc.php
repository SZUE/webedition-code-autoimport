...
$l_we_tag['ifNewsletterSalutation']['description'] = "Dieses Tag dient dazu, den umschlossenen Inhalt innerhalb eines Newsletters nur dann anzuzeigen, wenn das in type definierte Anredefeld dem Wert in match entspricht.";
...
$l_we_tag['newsletterField']['description'] = "Ein Feld aus dem Empf&auml;ngerdatensatz der Kundenverwaltung innerhalb eines Newsletters anzeigen.";
...
$l_we_tag['redirectObjectSeoUrls']['description']="Dieser Tag sollte in der Vorlage von einem als ErrorDocument 404 definierten WE-Dokument ganz am Anfang eingesetzt werden und sorgt bei Objekt SEO-Urls daf&uuml;r, dass das Objekt identifiziert und mit dem richtigen Dokument dargestellt wird. \n Das Attribut 'hiddendirindex=true' sorgt daf&uuml;r, das auch versteckte DirectoyIndex-Dateien (z.B. index.php) gefunden werden. Wird kein passendes Objekt bzw. das zur Darstellung zu verwendende Dokument gefunden, so wird ein Status 404 not found ausgegeben, ansonsten wird der Status 200 OK ausgegeben. Das Attibut suppresserrorcode verhindert die Ausgabe eines 404 not found";
...
$l_we_tag['ifShopFieldEmpty']['description'] = "Pr&uuml;ft, ob ein shopField leer ist. Ist dies der Fall, wird alles zwischen Start- und Endtag angezeigt.";
$l_we_tag['ifShopFieldNotEmpty']['description'] = "Pr&uuml;ft, ob ein shopField nicht leer ist. Ist dies der Fall, wird alles zwischen Start- und Endtag angezeigt.";
