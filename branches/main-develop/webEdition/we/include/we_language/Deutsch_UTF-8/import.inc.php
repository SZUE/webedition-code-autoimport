...
$l_import = array(
		...
		'documents_desc' => "Geben Sie bitte das Verzeichnis an, in welches die Dokumente importiert werden sollen. Falls die Option \"" . $l_import['maintain_paths'] . "\" ausgewählt ist, werden die entsprechenden Pfade automatisch wiederhergestellt, anderenfalls werden die Pfade ignoriert.",
		'templates_desc' => "Geben Sie bitte das Verzeichnis an, in welches die Vorlagen importiert werden sollen. Falls die Option \"" . $l_import['maintain_paths'] . "\" ausgewählt ist, werden die entsprechenden Pfade automatisch wiederhergestellt, anderenfalls werden die Pfade ignoriert.",
