...
$l_import = array(
		...
		'documents_desc' => "Podaj katalog, do którego majš zostać zaimportowane dokumenty. W przypadku gdy wybrano opcję \"" . $l_import['maintain_paths'] . "\", to odpowiednie cieżki zostanš ustawione automatycznie, w innym za przypadku, będš one zignorowane.",
		'templates_desc' => "Podaj katalog, do którego majš zostać zaimportowane szablony. W przypadku gdy wybrano opcję \"" . $l_import['maintain_paths'] . "\", to odpowiednie cieżki zostanš ustawione automatycznie, w innym za przypadku, będš one zignorowane.",
