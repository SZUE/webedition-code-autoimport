...
$l_import = array(
		...
		'documents_desc' => "Select the directory where the documents will be imported. If the option \"" . $l_import['maintain_paths'] . "\" is checked, the documents paths will be restored, otherwise the documents paths will be ignored.",
		'templates_desc' => "Select the directory where the templates will be imported. If the option \"" . $l_import['maintain_paths'] . "\" is checked, the template paths will be restored, otherwise the template paths will be ignored.",
