...
$l_alert["we_backup_import_upload_err"] = "Er is een fout opgetreden tijdens het uploaden van het backup bestand! De maximale bestandsgrootte voor uploads is %s. Als uw backup bestand de limiet overschrijdt, upload het dan a.u.b. in de directory webEdition/we_Backup via FTP en kies '".g_l('backup',"[import_from_server]")."'";
