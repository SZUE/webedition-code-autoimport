...
$l_import = array(
		...
		'documents_desc' => "Selecteer de directory waar de documenten geïmporteerd moeten worden. Als de optie \"" . $l_import['maintain_paths'] . "\" is gekozen, worden de document paden hersteld, anders worden de document paden genegeerd.",
		'templates_desc' => "Selecteer de directory waar de sjablonen geïmporteerd moeten worden. Als de optie \"" . $l_import['maintain_paths'] . "\" is gekozen, worden de sjabloon paden hersteld, anders worden de sjabloon paden genegeerd.",
