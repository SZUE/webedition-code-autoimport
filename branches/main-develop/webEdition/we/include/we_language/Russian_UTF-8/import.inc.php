...
$l_import = array(
		...
		'documents_desc' => "Введите, пожалуйста, директорию назначения для импортируемых документов. В случае если отмечена опция \"" . $l_import['maintain_paths'] . "\", соответствующий путь воссоздается автоматически, в противном случае путь игнорируется. ",
		'templates_desc' => " Введите, пожалуйста, директорию назначения для импортируемых объектов. В случае если отмечена опция \"" . $l_import['maintain_paths'] . "\", соответствующий путь воссоздается автоматически, в противном случае путь игнорируется. ",
