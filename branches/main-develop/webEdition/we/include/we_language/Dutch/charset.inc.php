...
//	we/include/charset.inc.php
				...
				'west_european' => "West Europees", // ISO-8859-1
				'central_european' => "Centraal Europees", // ISO-8859-2
				'south_european' => "Zuid Europees", // ISO-8859-3
				'north_european' => "Noord Europees", // ISO-8859-4
				'cyrillic' => "Cyrilisch", // ISO-8859-5
				'arabic' => "Arabisch", // ISO-8859-6
				'greek' => "Grieks", // ISO-8859-7
				'hebrew' => "Hebreeuws", // ISO-8859-8
				'turkish' => "Turks", // ISO-8859-9
				'nordic' => "Noors", // ISO-8859-10
				'thai' => "Thais", // ISO-8859-11
				'baltic' => "Baltisch", // ISO-8859-13
				'keltic' => "Keltisch", // ISO-8859-14
				'extended_european' => "Europees (uitgebreid)", // ISO-8859-15
