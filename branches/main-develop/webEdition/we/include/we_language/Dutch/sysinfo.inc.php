...
$l_sysinfo = array(
		...
		'safe_mode warning' => 'Please deactivate the PHP Safe Mode if you experience problems during installation or update procedures.', // TRANSLATE
		'zend_framework warning' => 'You are currently using a different version of the Zend Framework than the recommended version ' . WE_ZFVERSION . '.', // TRANSLATE
		'suhosin warning' => 'Due to the many configuration options of this PHP extension, we cannot guarenty the full functionality of webEdition.', // TRANSLATE
