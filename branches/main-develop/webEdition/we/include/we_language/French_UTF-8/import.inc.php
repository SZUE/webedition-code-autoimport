...
$l_import = array(
		...
		'documents_desc' => "S\'il vous plaît saisissez un répertoire, dans lequel les documents seront importés . Si l\'option \"" . $l_import['maintain_paths'] . "\" est choisi les chemins correspondant seront réproduit automatiquement, autrement les chemins seront ignorés.",
		'templates_desc' => "S\'il vous plaît saisissez un répertoire, dans lequel les modèles seront importés . Si l\'option \"" . $l_import['maintain_paths'] . "\" est choisi les chemins correspondant seront réproduit automatiquement, autrement les chemins seront ignorés.",
