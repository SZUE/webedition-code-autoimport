...
$we_menu["3000000"]["parent"] = "0000000";
	...
	if(!$userHasAllModules){
		...
		$we_menu["3050000"]["text"] = g_l('javaMenu_global','[not_installed_modules]') . "...";
...
*/
	...
	/*
	// Extras > Search
	$we_menu["4124000"]["text"] = g_l('javaMenu_global','[search]') . "...";
...
//	$we_menu["5030000"]["enabled"] = "1";
	...
	$we_menu["5080000"]["text"] = g_l('javaMenu_global','[info]') . "...";
