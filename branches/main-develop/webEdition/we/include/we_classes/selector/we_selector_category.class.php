...
<table id="footer">
	...
	function printPropertiesHTML(){
		...
		echo we_html_tools::getHtmlTop('', '', '', we_html_element::jsScript(JS_DIR . 'selectors/category_selector.js') . we_wysiwyg_editor::getHTMLHeader(false, true), '<body class="defaultfont weDialogBody" style="padding: 15px 0 0 10px;">
' . ($showPrefs ? '
