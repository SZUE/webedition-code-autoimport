...
class we_selector_multiple extends we_selector_file{
	...
	function __construct($id, $table = FILE_TABLE, $JSIDName = "", $JSTextName = "", $JSCommand = "", $order = "", $sessionID = "", $rootDirID = 0, $multiple = true, $filter = "", $extInstanceId = ''){
		parent::__construct($id, $table, $JSIDName, $JSTextName, $JSCommand, $order, 0, $rootDirID, $filter, $extInstanceId);
