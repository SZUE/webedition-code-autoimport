...
abstract class we_autoloader{
	...
	private static $classes = array(
		'we_classes' => array(
			...
			'copyFolderFinishFrag' => 'copyFolderFinishFrag.class.php',
			'copyFolderFrag' => 'copyFolderFrag.class.php',
			'CSV' => 'csv.inc.php',
		...
		'we_modules' => array(
			...
			'shop' => 'shop/we_conf_shop.inc.php',
			'Basket' => 'shop/we_conf_shop.inc.php',
			'we_listview_order' => 'shop/we_listview_order.class.php',
			'we_listview_orderitem' => 'shop/we_listview_orderitem.class.php',
			'we_listview_shopVariants' => 'shop/we_listview_shopVariants.class.php',
			'we_orderitemtag' => 'shop/we_orderitemtag.inc.php',
			'we_ordertag' => 'shop/we_ordertag.inc.php',
			'blaettern' => 'shop/we_pager_class.inc.php',
			'we_shopDirSelector' => 'shop/we_shopDirSelector.php',
		...
		'we_tools' => array(
			...
			'weNavigationItem' => 'navigation/class/weNavigationItems.class.php',
			...
			'weNavigationRuleFrames' => 'navigation/class/weNavigationRuleFrames.php',
