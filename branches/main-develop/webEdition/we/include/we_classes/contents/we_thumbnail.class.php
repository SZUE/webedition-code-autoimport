...
class we_thumbnail{
	...
	public function getThumb(&$thumbDataPointer){
		...
		$outarr = we_base_imageEdit::edit_image($this->imageData ? $this->imageData : $_SERVER['DOCUMENT_ROOT'] . $this->imagePath, $this->outputFormat, "", $quality, $this->thumbWidth, $this->thumbHeight, $this->options, $this->focus, 0);
		if($outarr[0]){
