...
abstract class we_widget{
	...
	static function create($iId, $sType, $oContent, $aLabel = array("", ""), $sCls = "white", $iRes = 0, $sCsv = "", $w = 0, $h = 0, $resize = true){
		...
		$sIco = ($sType != "_reCloneType_") ? we_html_element::htmlDiv(array(), $$ico_obj->getHtml()) :
