...
abstract class we_autoloader{
	...
	private static $classes = array(
		'we_classes' => array(
			...
			'weAbbrDialog' => 'weAbbrDialog.class.php',
			'weAcronymDialog' => 'weAcronymDialog.class.php',
			'weBinary' => 'base/weBinary.class.php',
			'we_binaryDocument' => 'we_binaryDocument.inc.php',
			'we_button' => 'html/we_button.inc.php',//fixme: change to we_html_button
		...
		'we_modules' => array(
			...
			'objectsearch' => 'object/we_searchobject_class.php',
