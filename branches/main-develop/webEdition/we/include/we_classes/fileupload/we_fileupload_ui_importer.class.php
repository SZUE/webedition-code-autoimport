...
//<div id="imgfocus_point" style="display:none;" draggable="false"></div>
	...
	public static function getBtnImportFiles($parentID = 0, $nextCmd = '', $callback = '', $text = ''){
		return we_html_button::create_button('fa:' . ($text ? : 'btn_import_files') . ',fa-lg fa-upload', "javascript:top.we_cmd('import_files','" . $parentID . "', '" . $nextCmd . "', '" . $callback . "')", true, 62);
	}
