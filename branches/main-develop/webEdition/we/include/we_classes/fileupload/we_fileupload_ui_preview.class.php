...
class we_fileupload_ui_preview extends we_fileupload_ui_base{
	...
	function getFormCategories(){
		...
		$width_size = 378;
		$addbut = we_html_button::create_button(we_html_button::ADD, "javascript:we_cmd('we_selector_category',-1,'" . CATEGORY_TABLE . "','','','fillIDs();opener.addCat(top.fileSelect.data.allPaths);opener.selectCategories();')");
