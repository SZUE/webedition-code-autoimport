...
class we_folder extends we_root{
	...
	<tr><td colspan="3" class="defaultfont">' . $this->formDirChooser(388) . '</td></tr>';
		...
		<tr><td colspan="3" class="defaultfont">' . $this->formTriggerDocument() . '</td></tr>';
			...
			$content .='<table border="0" cellpadding="0" cellspacing="0"><tr><td>' . we_html_tools::htmlAlertAttentionBox(g_l('weClass', "[grant_tid_expl]") . $_disabledNote, we_html_tools::TYPE_INFO, 388, false) . '</td><td>' .
