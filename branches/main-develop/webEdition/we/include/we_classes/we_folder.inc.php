...
';
	...
	function formCopyDocument(){
		...
		$wecmdenc2= '';
		$wecmdenc3= 'WECMDENC_'.base64_encode("var parents = '".$ParentsCSV."';if(parents.indexOf(',' WE_PLUS currentID WE_PLUS ',') > -1){" . we_message_reporting::getShowMessageCall(g_l('alert',"[copy_folders_no_id]"), WE_MESSAGE_ERROR) . "}else{opener.top.we_cmd('copyFolder', currentID,".$this->ID.",1,'".$this->Table."');}");
