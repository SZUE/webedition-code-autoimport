...
$id_document = new we_tagData_selectorAttribute('id', FILE_TABLE, we_base_ContentTypes::WEDOCUMENT . ',' . we_base_ContentTypes::IMAGE . ',' . we_base_ContentTypes::CSS . ',' . we_base_ContentTypes::JS . ',' . we_base_ContentTypes::APPLICATION, true, '');
$id_object = (defined('OBJECT_FILES_TABLE') ? new we_tagData_selectorAttribute('id', OBJECT_FILES_TABLE, we_base_ContentTypes::OBJECT_FILE, true, '') : null);
