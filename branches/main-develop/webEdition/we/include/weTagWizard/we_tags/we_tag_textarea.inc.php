...
$removefirstparagraph = new weTagData_selectAttribute('removefirstparagraph',array(new weTagDataOption('false', false, ''),new weTagDataOption('true', false, '')), false, '');
...
$this->TypeAttribute = new weTagData_typeAttribute('wysiwyg', array(
	new weTagDataOption('true', false, '', array($name,$cols,$rows,$autobr,$importrtf,$width,$height,$bgcolor,$html,$htmlspecialchars,$php,$commands,$fontnames,$abbr,$removefirstparagraph,$inlineedit,$buttonpos,$win2iso,$classes,$spellcheck), array($name)),
	new weTagDataOption('false', false, '', array($name,$cols,$rows,$autobr,$html,$htmlspecialchars,$php,$abbr,$spellcheck), array($name))), false, '');

$this->Attributes=array($name,$cols,$rows,$autobr,$importrtf,$width,$height,$bgcolor,$html,$htmlspecialchars,$php,$commands,$fontnames,$xml,$abbr,
