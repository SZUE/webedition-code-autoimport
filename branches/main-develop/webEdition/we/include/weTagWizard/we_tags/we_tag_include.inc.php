...
$path = (defined("FILE_TABLE") ? new weTagData_selectorAttribute('path', FILE_TABLE, 'text/webedition', false, '', true) : null);
...
$this->TypeAttribute = new weTagData_typeAttribute('type', array(
	new weTagDataOption('document', false, '', array($id, $path, $gethttp, $seeMode, $kind, $name, $rootdir, $description), array()),
	new weTagDataOption('template', false, '', array($path_temp, $id_temp), array())), false, '');

$this->Attributes = array($included, $id, $path, $path_temp, $gethttp, $seeMode, $kind, $name, $id_temp, $rootdir, $description);
