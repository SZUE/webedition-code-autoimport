...
$GLOBALS['weTagWizard']['attribute']['id868_ascountry'] = new weTagData_selectAttribute('868', 'ascountry', array(new weTagDataOption('true', false, ''), new weTagDataOption('false', false, '')), false, '');
$GLOBALS['weTagWizard']['attribute']['id869_aslanguage'] = new weTagData_selectAttribute('869', 'aslanguage', array(new weTagDataOption('true', false, ''), new weTagDataOption('false', false, '')), false, '');
$GLOBALS['weTagWizard']['attribute']['id871_languageautofill'] = new weTagData_selectAttribute('871', 'languageautofill', array(new weTagDataOption('true', false, ''), new weTagDataOption('false', false, '')), false, '');
