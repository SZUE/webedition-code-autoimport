...
$order_customer = new weTagData_choiceAttribute('order', array(new weTagDataOption('random()', false, ''), new weTagDataOption('ID', false, ''), new weTagDataOption('Username', false, ''), new weTagDataOption('Forename', false, ''), new weTagDataOption('Surname', false, '')), false,false, '');
...
$workspaceID_object = new weTagData_multiSelectorAttribute('workspaceID',OBJECT_FILES_TABLE, 'folder', 'ID', false, '');
...
$cfilter = new weTagData_selectAttribute('cfilter', array(new weTagDataOption('false', false, ''), new weTagDataOption('true', false, ''), new weTagDataOption('auto', false, '')), false, 'customer');
...
$customer = new weTagData_textAttribute('customer', false, 'customer');
$customers = new weTagData_textAttribute('customers', false, 'customer');
