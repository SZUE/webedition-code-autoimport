...
$this->Attributes = [
	new weTagData_selectAttribute('name', [new weTagDataOption('name'),
	...
	new weTagData_choiceAttribute('attributes', [new weTagDataOption('position'),
		new weTagDataOption('rel'),
		new weTagDataOption('tabindex'),
		new weTagDataOption('accesskey'),
		new weTagDataOption('hreflang'),
	...
	new weTagData_selectAttribute('complete', [new weTagDataOption('link'),
		new weTagDataOption('image'),
		], false, ''),
];
