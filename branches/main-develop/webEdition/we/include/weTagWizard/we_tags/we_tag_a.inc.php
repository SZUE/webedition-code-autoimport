...
$GLOBALS['weTagWizard']['attribute']['id14_edit'] = new weTagData_typeAttribute('14', 'edit', array(
new weTagDataOption('-', false, '', array('id14_edit','id1_id','id2_target','id3_confirm','id4_button','id5_hrefonly','id6_class','id7_style','id_params','id734_cachelifetime'), array('id1_id')),
new weTagDataOption('document', false, '', array('id14_edit','id1_id','id2_target','id3_confirm','id4_button','id5_hrefonly','id6_class','id7_style','id_params','id15_editself','id16_delete','id734_cachelifetime'), array('id1_id')),
new weTagDataOption('object', false, 'object', array('id14_edit','id1_id','id2_target','id3_confirm','id4_button','id5_hrefonly','id6_class','id7_style','id_params','id15_editself','id16_delete','id734_cachelifetime'), array('id1_id')),
new weTagDataOption('shop', false, 'shop', array('id14_edit','id1_id','id2_target','id3_confirm','id4_button','id5_hrefonly','id6_class','id7_style','id_params','id10_amount','id11_delarticle','id12_delshop','id13_shopname','id734_cachelifetime'), array('id1_id'))), false, '');
...
$GLOBALS['weTagWizard']['attribute']['id_params'] = new weTagData_textAttribute('666', 'params', false, '');
