...
$GLOBALS['weTagWizard']['attribute']['id115_doc'] = new weTagData_selectAttribute('115', 'doc', array(new weTagDataOption('top', false, ''), new weTagDataOption('self', false, ''), new weTagDataOption('listview', false, '')), false, '');
