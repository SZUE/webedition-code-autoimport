...
include($_SERVER['DOCUMENT_ROOT'].'/webEdition/we/include/we_language/' . $GLOBALS['WE_LANGUAGE'] . '/modules/perms/spellchecker.inc.php');

$perm_group_name='spellchecker';
$perm_group_title[$perm_group_name]=$l_perm['spellchecker']['perm_group_title'];
