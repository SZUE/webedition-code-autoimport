        ...
        <td colspan="2" class="defaultfont">' . $selClass . '</td>
				...
				$parts = array(
					array(
						...
						'<tr><td class="defaultfont">' . we_button::create_button("image:btn_shop_pref", "javascript:top.opener.top.we_cmd('pref_shop')", true, -1, -1, "", "", !permissionhandler::hasPerm("NEW_USER")) . '</td></tr>' .
						'</table>',
						'space' => 0
					)
				);
