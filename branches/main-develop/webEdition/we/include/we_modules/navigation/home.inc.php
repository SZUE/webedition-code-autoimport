 ...
 */
$createNavigation = we_button::create_button('new_item', "javascript:we_cmd('module_navigation_new');", true, -1, -1, "", "", !permissionhandler::hasPerm('EDIT_NAVIGATION'));
$createNavigationGroup = we_button::create_button('new_folder', "javascript:we_cmd('module_navigation_new_group');", true, -1, -1, "", "", !permissionhandler::hasPerm('EDIT_NAVIGATION'));
