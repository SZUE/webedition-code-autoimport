 ...
 * $Rev: 5973 $
 * $Author: mokraemer $
 * $Date: 2013-03-18 22:31:13 +0100 (Mo, 18 Mrz 2013) $
 *
 ...
 */
$createNavigation = we_button::create_button('new_item', "javascript:we_cmd('module_navigation_new');", true, -1, -1, "", "", !we_hasPerm('EDIT_NAVIGATION'));
$createNavigationGroup = we_button::create_button('new_folder', "javascript:we_cmd('module_navigation_new_group');", true, -1, -1, "", "", !we_hasPerm('EDIT_NAVIGATION'));
...
<body bgcolor="#F0EFF0" onLoad="loaded = 1;">
	...
	<div id="modimage"><img src="<?php print WE_INCLUDES_DIR . 'we_modules/navigation/layout/home.gif'; ?>" width="335" height="329" /></div>
