...
//FIXME: this is NOT safe!!! Insert entry, and update afterwards
	...
	private function getCollectionFieldHTML($type, $name, array $attribs, $editable = true){
		...
		$btnNewCollection = we_html_button::create_button('fa:btn_add_collection,fa-plus,fa-lg fa-archive', "javascript:top.we_cmd('edit_new_collection','" . $idname . "','" . $textname . "',-1,'" . VFILE_TABLE . "');", true, 0, 0, "", "", false, false);
