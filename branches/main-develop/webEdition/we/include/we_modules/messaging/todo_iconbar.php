...
<script type="text/javascript"><!--
	...
	function launch_msg() {
		if (top.content.resize.right.editor.entries_selected) {
			top.content.cmd.location = '<?php print WE_MESSAGING_MODULE_DIR; ?>edit_messaging_frameset.php?pnt=cmd&mcmd=launch&mode=message&we_transaction=<?php echo $_REQUEST['we_transaction'] ?>';
		}
	}
	//-->
</script>
