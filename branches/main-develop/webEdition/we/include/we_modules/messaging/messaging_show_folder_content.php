...
<script type="text/javascript"><!--
	...
	function showContent(id) {
		top.content.resize.right.msg_work.msg_mfv.messaging_msg_view.location="<?php print WE_MESSAGING_MODULE_DIR; ?>messaging_message_view.php?id=" + id + "&we_transaction=<?php echo $_REQUEST['we_transaction'] ?>";
	}
