...
function getMainDialog(){
	...
	if(!we_base_request::_(we_base_request::BOOL, 'save_thumbnails')){
		return we_html_element::htmlForm(['name' => 'we_form', 'method' => 'get', 'action' => getScriptName()], we_html_element::htmlHiddens(['we_cmd[0]' => 'editThumbs', 'save_thumbnails' => 0]) . render_dialog());
	}
