...
<script language="JavaScript" type="text/javascript" src="<?php print JS_DIR ?>seeMode.php?EditPage=<?php print $GLOBALS["we_doc"]->EditPageNr; ?>&ContentType=<?php print $GLOBALS["we_doc"]->ContentType; ?>"></script>
