...
include_once ($_SERVER['DOCUMENT_ROOT'] . '/webEdition/we/include/we_language/' . $GLOBALS["WE_LANGUAGE"] . '/tools/first_steps_wizard/detail.inc.php');

$WizardCollection = new leWizardCollection('/we/include/we_tools/first_steps_wizard/detail_wizards.inc.php');
