...
$oRdoSort[1] = we_forms::radiobutton(
		...
		$checked = 0,
		$name = "rdo_sort",
		$text = g_l('cockpit','[by_valid_from]'),
		$uniqid = true,
		$class = "defaultfont",
		$onClick = "",
		$disabled = false,
...
$oRdoSort[2] = we_forms::radiobutton(
		...
		$checked = 0,
		$name = "rdo_sort",
		$text = g_l('cockpit','[by_valid_until]'),
		$uniqid = true,
		$class = "defaultfont",
		$onClick = "",
		$disabled = false,
