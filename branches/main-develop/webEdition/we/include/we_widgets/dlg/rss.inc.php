...
$oChbxContEnc = we_forms::checkbox(
		...
		$checked = 0,
		$name = "chbx_conf",
		$text = g_l('cockpit','[content_encoded]'),
		$uniqid = true,
		$class = "defaultfont",
		$onClick = "",
		$disabled = false,
...
$oChbxTb[0] = we_forms::checkbox(
		...
		$checked = 0,
		$name = "chbx_tb",
		$text = g_l('cockpit','[label_rssfeed]'),
		$uniqid = true,
		$class = "defaultfont",
		$onClick = "",
		$disabled = false,
...
$oRdoTitle[0] = we_forms::radiobutton(
		...
		$checked = 0,
		$name = "rdo_title",
		$text = g_l('cockpit','[original_of_rssfeed]'),
		$uniqid = true,
		$class = "defaultfont",
		$onClick = "",
		$disabled = false,
