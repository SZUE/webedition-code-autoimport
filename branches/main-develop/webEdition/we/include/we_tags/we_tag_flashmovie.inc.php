 ...
 */
function we_tag_flashmovie(array $attribs){
	...
	if($showcontrol && $GLOBALS['we_editmode']){
		...
		$button = we_html_button::create_button('fa:btn_edit_flash,fa-lg fa-pencil,fa-lg fa-file-video-o', "javascript:we_cmd('we_selector_document','" . ($id ?: $startid) . "', '" . FILE_TABLE . "','" . $fname . "','','reload_hot_editpage',''," . $parentid . ", '" . we_base_ContentTypes::FLASH . "', " . (permissionhandler::hasPerm("CAN_SELECT_OTHER_USERS_FILES") ? 0 : 1) . ")", true);
