...
function we_tag_subscribe(array $attribs){
	...
	switch($type){
		case "listCheckbox":
			...
			$newAttribs = removeAttribs($attribs, ['name', 'type', 'value']);
		...
		case "listSelect":
			if($values){
				$newAttribs = removeAttribs($attribs, ['name', 'type', 'value', 'values', 'lists', 'maxlength', 'checked']);
		...
		case "htmlCheckbox":
			$newAttribs = removeAttribs($attribs, ['name', 'type', 'value', 'checked', 'values']);
		...
		case "htmlSelect":
			$newAttribs = removeAttribs($attribs, ['name', 'type', 'value', 'size', 'values', 'maxlength', 'checked']);
			$newAttribs['name'] = 'we_subscribe_html__';
		...
		case "firstname":
			$newAttribs = removeAttribs($attribs, ['name', 'type', 'value', 'values']);
