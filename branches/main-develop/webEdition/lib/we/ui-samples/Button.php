...
$buttonHref->setText('go to www.webedition.org');
$buttonHref->setType('href');
$buttonHref->setHref('http://www.webedition.org');
...
//$buttonOnClick->setHref('http://www.webedition.org');
...
//$buttonSubmitForm->setHref('http://www.webedition.org');
...
//$buttonImage->setHref('http://www.webedition.org');
...
//$buttonImage2->setHref('http://www.webedition.org');
...
//$buttonImage3->setHref('http://www.webedition.org');
...
$buttonExtern->setTitle('www.webedition.org');
$buttonExtern->setText('www.webedition.org');
$buttonExtern->setType('href');
$buttonExtern->setHref('http://www.webedition.org');
...
$buttonExtern2->setTitle('www.webedition.org');
$buttonExtern2->setText('www.webedition.org');
$buttonExtern2->setType('href');
$buttonExtern2->setHref('http://www.webedition.org');
...
$buttonExtern3->setTitle('www.webedition.org');
//$buttonExtern3->setText('www.webedition.org');
$buttonExtern3->setType('onClick');
//$buttonExtern3->setHref('http://www.webedition.org');
...
//$newButton->setHref('http://www.webedition.org');
