...
Ext.define('Ext.i18n.Bundle', {
	...
	//@private
	defaultLanguage: 'Deutsch',//IMI: changed from 'en-US'
	...
	config: {
		 ...
		 * IMI: format changed to Xxxx, default set to 'Deutsch'
		 */
	...
	getMsg: function(key, args){//IMI: modified params
        var values = [].splice.call(args, 1),
