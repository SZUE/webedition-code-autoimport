...
we_cmd_modules.shop = function (args, url) {
	switch (args[0]) {
		case "edit_settings_shop":
			new (WE().util.jsWindow)(window, WE().consts.dirs.WEBEDITION_DIR + "we_showMod.php?mod=shop&pnt=pref_shop", "pref_shop", 470, 600, true, false, true);
			break;
		...
		case "edit_shop_status":
			WE().layout.pushCmdToModule(args);
			new (WE().util.jsWindow)(window, WE().consts.dirs.WEBEDITION_DIR + "we_showMod.php?mod=shop&pnt=" + args[0], args[0], 700, 580, true, true, true, false);
			break;
		...
		case "edit_shop_categories":
			WE().layout.pushCmdToModule(args);
			new (WE().util.jsWindow)(window, WE().consts.dirs.WEBEDITION_DIR + "we_showMod.php?mod=shop&pnt=" + args[0], args[0], 740, 650, true, false, true, false);
			break;
		case "edit_shop_vats":
			WE().layout.pushCmdToModule(args);
			new (WE().util.jsWindow)(window, WE().consts.dirs.WEBEDITION_DIR + "we_showMod.php?mod=shop&pnt=" + args[0], args[0], 650, 650, true, false, true, false);
			break;
