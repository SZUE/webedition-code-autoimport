...
we_cmd_modules.shop = function (args, url) {
	switch (args[0]) {
		case "edit_settings_shop":
			new (WE().util.jsWindow)(window, WE().consts.dirs.WEBEDITION_DIR + "we_showMod.php?mod=shop&pnt=pref_shop", "pref_shop", WE().consts.size.dialog.small, WE().consts.size.dialog.small, true, false, true);
			break;
		...
		case "edit_shop_status":
			WE().layout.pushCmdToModule(args);
			new (WE().util.jsWindow)(window, WE().consts.dirs.WEBEDITION_DIR + "we_showMod.php?mod=shop&pnt=" + args[0], args[0], WE().consts.size.dialog.medium, WE().consts.size.dialog.small, true, true, true, false);
			break;
		...
		case "edit_shop_vats":
			WE().layout.pushCmdToModule(args);
			new (WE().util.jsWindow)(window, WE().consts.dirs.WEBEDITION_DIR + "we_showMod.php?mod=shop&pnt=" + args[0], args[0],  WE().consts.size.dialog.medium, WE().consts.size.dialog.medium, true, false, true, false);
			break;
