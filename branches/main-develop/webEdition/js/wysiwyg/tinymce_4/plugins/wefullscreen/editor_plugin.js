 ...
 * $Rev: 13418 $
 * $Author: lukasimhof $
 * $Date: 2017-02-23 12:45:28 +0100 (Do, 23 Feb 2017) $
 *
	...
	tinymce.create('tinymce.plugins.WefullscreenPlugin', {
		init: function (d, e) {
			...
			d.addButton('wefullscreen', {
				title: d.settings.weEditorType === 'inlineTrue' ? tinymce.i18n.data.de.we.tt_wefullscreen : tinymce.i18n.data.de.we.tt_wefullscreen_set,
				icon: 'fa fa-window-maximize',
				cmd: 'mceWefullscreen'
			});

			d.addMenuItem('wefullscreen', {
				text: d.settings.weEditorType === 'inlineTrue' ? tinymce.i18n.data.de.we.tt_wefullscreen : tinymce.i18n.data.de.we.tt_wefullscreen_set,
				icon: 'fa fa-window-maximize',
				context: 'view',
				cmd: 'mceWefullscreen'
			});
