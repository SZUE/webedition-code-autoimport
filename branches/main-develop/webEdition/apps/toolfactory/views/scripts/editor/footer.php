...
$saveButton = new we_ui_controls_Button(
	...
	'type' => 'onClick',
	'width' => 110,
	'disabled' => !we_base_permission::hasPerm('EDIT_APP_TOOLFACTORY'),
...
$unpublishButton = new we_ui_controls_Button(
	...
	'type' => 'onClick',
	'width' => 110,
	'disabled' => !we_base_permission::hasPerm('PUBLISH_APP_TOOLFACTORY'),
	'style' => 'margin:9px 0 0 15px;'
 ]
);
...
$page->setBodyAttributes(['class' => 'weEditorFooter']);
