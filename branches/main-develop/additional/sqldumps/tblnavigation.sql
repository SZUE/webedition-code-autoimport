...
CREATE TABLE ###TBLPREFIX###tblnavigation (
  ...
  Icon enum('folder.gif','link.gif') NOT NULL default '0',
  IsFolder tinyint(1) unsigned NOT NULL default '0',
  TitleField varchar(255) NOT NULL default '',
  IconID bigint(20) unsigned NOT NULL default '0',
  Selection enum('dynamic','nodynamic','static') NOT NULL default '',
  ...
  Sort text NOT NULL,
  ShowCount int(11) unsigned NOT NULL default '0',
  Ordn int(11) unsigned NOT NULL default '0',
  Depended tinyint(4) unsigned NOT NULL default '0',
