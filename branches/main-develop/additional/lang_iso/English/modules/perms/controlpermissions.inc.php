...
$l_perm["controlpermissions"]["perm_group_title"] = "Control permissions";

$l_perm["controlpermissions"]["NEW_GROUP"] = "The user is allowed to create new groups.";
$l_perm["controlpermissions"]["NEW_USER"] = "The user is allowed to create new users.";
$l_perm["controlpermissions"]["SAVE_GROUP"] = "The user is allowed to save groups.";
$l_perm["controlpermissions"]["SAVE_USER"] = "The user is allowed to save users.";
