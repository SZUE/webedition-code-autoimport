...
$l_perm['customer']['perm_group_title'] = 'Kundenverwaltung';

$l_perm['customer']['NEW_CUSTOMER'] = 'Der Benutzer darf neue Kunden erstellen';
$l_perm['customer']['DELETE_CUSTOMER'] = 'Der Benutzer darf Kunden löschen';
