...
<table class="weEditTable padding2 spacing2">
	...
	<tr><td class="weEditmodeStyle" colspan="2" align="center">';
		...
		$out .= we_html_button::create_button_table(
						array(
					$_editButton,
					we_html_button::create_button("image:btn_select_image", "javascript:we_cmd('we_selector_image', '" . ($id ? : $startid) . "', '" . FILE_TABLE . "','" . $wecmdenc1 . "','','" . $wecmdenc3 . "',''," . $parentid . ",'" . we_base_ContentTypes::IMAGE . "', " . (permissionhandler::hasPerm("CAN_SELECT_OTHER_USERS_FILES") ? 0 : 1) . ")", true),
