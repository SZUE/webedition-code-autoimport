...
//	user
		...
		//	spaceholder
		$_messageTbl->setColContent(0, 0, '<span class="fa-stack fa-lg" style="color:yellow;margin-right:5px;"><i class="fa fa-exclamation-triangle fa-stack-2x" ></i><i style="color:black;" class="fa fa-exclamation fa-stack-1x"></i></span>');
...
//	spaceholder
	...
	static function workflow($we_doc){
		if(we_workflow_utility::isUserInWorkflow($we_doc->ID, $we_doc->Table, $_SESSION["user"]["ID"]) || permissionhandler::hasPerm("PUBLISH")){
			...
			$_table->setColContent(0, 0, '<span class="fa-stack fa-lg" style="color:yellow;margin-right:16px;"><i class="fa fa-exclamation-triangle fa-stack-2x" ></i><i style="color:black;" class="fa fa-exclamation fa-stack-1x"></i></span>');
