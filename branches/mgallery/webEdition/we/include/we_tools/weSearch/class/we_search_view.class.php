					...
					array('elem' => 'td', 'attribs' => 'style="' . $standardStyle . 'vertical-align:top;"', 'dat' => array(
							array('elem' => 'table', '' => '', 'dat' => array(
									array('elem' => 'row', 'dat' => array(
											...
											array('elem' => 'td', 'attribs' => 'title="' . ($_result[$f]['media_alt'] ? : 'Alt-Attribut nicht gesetzt" ') . '" style="width:45px;text-align:left;' . $standardStyle . '"', 'dat' => '<img align="bottom" src="' . IMAGE_DIR . 'we_boebbel_' . ($_result[$f]['media_alt'] ? 'green' : 'red') . '.gif">'),
											array('elem' => 'td', 'attribs' => 'title="' . ($_result[$f]['media_title'] ?  : 'Title-Attribut nicht gesetzt" ') . '" style="width:45px;text-align:left;' . $standardStyle . '"', 'dat' => '<img align="bottom" src="' . IMAGE_DIR . 'we_boebbel_' . ($_result[$f]['media_title'] ? 'green' : 'red') . '.gif">'),
