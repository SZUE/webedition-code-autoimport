...
.logicInput{
		border: #AAAAAA solid 1px; width: 59px; margin-right: 5px;
}
.leftInput{
border: #AAAAAA solid 1px; width: 160px; margin-right: 5px;
}
.middleInput{
		border: #AAAAAA solid 1px; width: 138px; margin-right: 5px;
}
.rightInput{
		border: #AAAAAA solid 1px; width: 160px; margin-right: 5px;
}').
