...
<body class="weDialogBody" style="border-top: 1px solid black;">
	...
	<tr>
	  ...
	  <td>' . $acc_html . '</td>
		...
		$_btn_tbl = we_html_button::position_yes_no_cancel(we_html_button::create_button("save", "javascript:save()"), "", we_html_button::create_button(we_html_button::CANCEL, "javascript:top.content.we_cmd('messaging_start_view','', '" . we_base_request::_(we_base_request::TABLE, "table", "") . "')")
			)
		;
