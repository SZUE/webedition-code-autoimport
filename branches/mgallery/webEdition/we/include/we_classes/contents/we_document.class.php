...
<table border="0" cellpadding="0" cellspacing="0">
	...
	function formCategory(){
		...
		$cats = new we_chooser_multiDir(508, $this->Category, 'delete_cat', we_html_button::create_button_table(array($delallbut, $addbut)), '', 'IF(IsFolder,"folder","we/category")', CATEGORY_TABLE);
