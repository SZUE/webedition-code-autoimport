...
//  If needed - js output for rollover.
	...
	function formProperties(){
		...
		$yuiSuggest->setSelectButton(we_html_button::create_button('select', "javascript:we_cmd('openImgselector',document.we_form.elements['" . $longdesc_id_name . "'].value,'" . FILE_TABLE . "','" . $wecmdenc1 . "','" . $wecmdenc2 . "','" . $wecmdenc3 . "','','','" . we_base_ContentTypes::WEDOCUMENT . "," . we_base_ContentTypes::TEXT . "," . we_base_ContentTypes::HTML . "',1)"));
	...
	function formLink(){
		...
		$but1 = we_html_button::create_button('select', "javascript:we_cmd('openImgselector', document.forms['we_form'].elements['" . $idname . "'].value,'" . FILE_TABLE . "','" . $wecmdenc1 . "','" . $wecmdenc2 . "','" . $wecmdenc3 . "','',0,''," . (permissionhandler::hasPerm("CAN_SELECT_OTHER_USERS_FILES") ? 0 : 1) . ");");
		...
		$but2 = we_html_button::create_button('select', "javascript:we_cmd('openImgselector', document.forms['we_form'].elements['" . $RollOverIDName . "'].value,'" . FILE_TABLE . "','" . $wecmdenc1 . "','" . $wecmdenc2 . "','" . $wecmdenc3 . "','',0,'" . we_base_ContentTypes::IMAGE . "'," . (permissionhandler::hasPerm("CAN_SELECT_OTHER_USERS_FILES") ? 0 : 1) . ");");
		...
		if(defined('OBJECT_TABLE')){
			...
			$butObj = we_html_button::create_button('select', "javascript:we_cmd('openImgselector',document.forms['we_form'].elements['" . $objidname . "'].value,'" . OBJECT_FILES_TABLE . "','" . $wecmdenc1 . "','" . $wecmdenc2 . "','" . $wecmdenc3 . "','','','objectFile'," . (permissionhandler::hasPerm("CAN_SELECT_OTHER_USERS_OBJECTS") ? 0 : 1) . ");");
		}
