...
if(isset($_SESSION['weS']['delete_files_nok']) && is_array($_SESSION['weS']['delete_files_nok'])){
	$table = new we_html_table(array('style' => 'margin:10px;', 'class' => 'defaultfont default'), 0, 4);
...
$buttons = new we_html_table(array('class' => 'default defaultfont', "align" => "right"), 1, 1);
