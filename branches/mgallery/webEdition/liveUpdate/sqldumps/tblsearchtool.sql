...
CREATE TABLE ###TBLPREFIX###tblsearchtool (
  ...
  folderIDMedia int(11) unsigned NOT NULL,
  ...
  searchForTitleMediaSearch tinyint(1) unsigned NOT NULL,
  ...
  anzahlMediaSearch tinyint(4) unsigned NOT NULL,
  ...
  setViewMediaSearch tinyint(1) unsigned NOT NULL,
