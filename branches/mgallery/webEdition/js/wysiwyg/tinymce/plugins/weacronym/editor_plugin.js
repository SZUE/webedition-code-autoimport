 ...
 * $Rev: 8627 $
 * $Author: lukasimhof $
 * $Date: 2014-11-25 14:34:52 +0100 (Di, 25 Nov 2014) $
 *
		...
		init: function (e, f) {
			e.addCommand('mceWeacronym', function () {
				...
				e.windowManager.open({
					file: '/webEdition/dynamic/wysiwyg/acronymDialog.php?we_dialog_args[editor]=tinyMce&we_dialog_args[isFrontend]=' + e.getParam('weIsFrontend'),
					popup_css: false,
