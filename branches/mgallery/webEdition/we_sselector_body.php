	...
	<form name="we_form" target="fscmd" action="we_sselector_cmd.php" method="post" onsubmit="return false;">
		<table class="default"><?php
			...
			if($dir_obj){
				...
				echo we_html_element::jsElement(we_message_reporting::getShowMessageCall(g_l('alert', '[access_denied]'), we_message_reporting::WE_MESSAGE_ERROR)) . '<div class="middlefontgray"  style="padding-top:2em;" align="center">-- ' . g_l('alert', '[access_denied]') . ' --</div>';
			}
