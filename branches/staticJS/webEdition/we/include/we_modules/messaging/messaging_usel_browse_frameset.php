...
<?php
echo we_html_element::htmlBody(array('style' => 'background-color:#bfbfbf;background-repeat:repeat;background-image: url(' . IMAGE_DIR . 'backgrounds/aquaBackground.gif);position:fixed;top:0px;left:0px;right:0px;bottom:0px;border:0px none;')
