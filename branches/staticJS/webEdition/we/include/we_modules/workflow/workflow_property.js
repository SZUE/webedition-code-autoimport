 ...
 * $Rev: 8971 $
 * $Author: mokraemer $
 * $Date: 2015-01-13 18:03:33 +0100 (Di, 13. Jan 2015) $
 *
...
function delStep() {
	if (document.we_form.wsteps.value > 1) {
		...
		top.we_showMessage(g_l.del_last_step, WE_MESSAGE_ERROR, window);
	}
}
...
function delTask() {
	if (document.we_form.wtasks.value > 1) {
		...
		top.we_showMessage(g_l.del_last_task, WE_MESSAGE_ERROR, window);
	}
}
