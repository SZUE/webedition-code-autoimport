...
$this->TypeAttribute = new weTagData_typeAttribute('type', array(
	new weTagDataOption('document', false, '', array($name, $doc, $htmlspecialchars, $format, $sql), array($name)),
	new weTagDataOption('property', false, '', array($name, $doc, $format, $sql), array($name)),
	new weTagDataOption('global', false, '', array($name, $htmlspecialchars, $format, $sql), array($name)),
	...
	new weTagDataOption('request', false, '', array($name, $varType, $htmlspecialchars, $format, $sql), array($name)),
	new weTagDataOption('post', false, '', array($name, $varType, $htmlspecialchars, $format, $sql), array($name)),
