...
function multi_editMulti(parentId, form, itemNum, but, width, editable, minCount) {
	...
	this.toggleMinCount = function () {
		this.minCount = (this.minCount == 1 ? 2 : 1);
	};
