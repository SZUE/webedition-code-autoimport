...
$l_export["txt_manual_selection"] = "Exportiert manuell ausgewählte Dokumente oder Objekte.";
$l_export["txt_manual_selection_csv"] = "Exportiert manuell ausgewählte Objekte.";
...
$l_export["step2"] = "Zu exportierende Elemente auswählen";
$l_export["step3"] = "Generic Export";
$l_export["step10"] = "Export beendet";
$l_export["step99"] = "Fehler während des Exportierens";
$l_export["step99_notice"] = "Export nicht möglich";
...
$l_export["export_xml_cdata"] = "CDATA-Abschnitte hinzufügen";
$l_export["export_xml_entities"] = "Entitäten ersetzen";
...
$l_export["csv_fieldnames"] = "Erste Zeile enthält Feldnamen";
...
$l_export["error_object_module"] = "Der Export von Dokumenten in CSV Dateien wird z.Z. nicht unterstützt!<br><br>Da das DB/Objekt Modul nicht installiert ist, ist der Export in CSV Dateien nicht verfügbar.";
$l_export["error_nothing_selected_docs"] = "Der Export wurde nicht ausgeführt!<br><br>Es wurden keine Dokumente ausgewählt.";
$l_export["error_nothing_selected_objs"] = "Der Export wurde nicht ausgeführt!<br><br>Es wurden keine Dokumente oder Objekte ausgewählt.";
...
$l_export["double_quote"] = "\" {Anführungszeichen}";
$l_export["single_quote"] = "' {einfaches Anführungszeichen}";
...
$l_export["select_export"] ="Markieren Sie im Explorermenü die Einträge, welchen Sie exportieren möchten. Bedenken Sie, dass alle markierten Einträge in allen Bereichen exportiert werden und dass bei einem Verzeichnis alle darin enthaltenen Einträge automatisch mit exportiert werden!";
$l_export["templates"] = "Vorlagen";
$l_export["classes"] = "Klassen";

$l_export['nothing_to_delete'] = "Es gibt nichts zu löschen.";
...
$l_export['delete'] = 'Löschen';
$l_export['quit'] = 'Schließen';
...
$l_export['delete_nok'] = 'FEHLER: Der Export wurde nicht gelöscht';
$l_export['delete_group_ok'] = 'Die Gruppe wurde gelöscht.';
$l_export['delete_group_nok'] = 'FEHLER: Die Gruppe wurde nicht gelöscht';
$l_export['delete_question'] = 'Möchten Sie den aktuellen Export löschen?';
$l_export['delete_group_question'] = 'Möchten Sie die aktuelle Gruppe löschen?';
