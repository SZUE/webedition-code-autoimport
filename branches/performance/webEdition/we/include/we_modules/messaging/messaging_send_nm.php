...
<html>
	...
	<body class="weDialogBody">
		<?php
				...
				<table align="center" cellpadding="7" cellspacing="3" width="100%">
					...
					<tr>
						<td class="defaultfont" valign="top">
							' . g_l('modules_messaging','[s_sent_to]') . ':</td>
					...
					') . (empty($res['failed']) ? '' : '
						<tr>
							<td class="defaultfont" valign="top">
								' . g_l('modules_messaging','[n_sent_to]') . ':</td>
							<td class="defaultfont">
								<ul>
									<li>
					...
					') . (empty($res['err']) ? '' : '
						<tr>
							<td class="defaultfont" valign="top">
								' . g_l('modules_messaging','[occured_errs]') . ':</td>
							<td class="defaultfont">
								<ul>
									<li>
										' . join("</li>\n<li>", $res['err']) . '</li></ul></td>
			...
			echo htmlDialogLayout($tbl, g_l('modules_messaging','[message_send]') . '...',$we_button->create_button("ok", "javascript:window.close()"),"100%","20","","hidden");
		?>
	</body>
