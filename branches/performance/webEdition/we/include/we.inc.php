...
foreach($_we_active_modules as $mod) {
	if (file_exists(
			$_SERVER['DOCUMENT_ROOT'] . '/webEdition/we/include/we_modules/' . $mod . '/we_conf_' . $mod . '.inc.php')) {
		include_once ($_SERVER['DOCUMENT_ROOT'] . '/webEdition/we/include/we_modules/' . $mod . '/we_conf_' . $mod . '.inc.php');
	}
}
