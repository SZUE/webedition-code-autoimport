...
$GLOBALS['weTagWizard']['attribute']['id478_to'] = new weTagData_selectAttribute('478', 'to', array(new weTagDataOption('request', false, ''), new weTagDataOption('post', false, ''), new weTagDataOption('get', false, ''), new weTagDataOption('global', false, ''), new weTagDataOption('session', false, ''), new weTagDataOption('top', false, ''), new weTagDataOption('self', false, ''), new weTagDataOption('object', false, ''), new weTagDataOption('document', false, ''), new weTagDataOption('sessionfield', false, '')), true, '');
...
$GLOBALS['weTagWizard']['attribute']['id481_from'] = new weTagData_selectAttribute('481', 'from', array(new weTagDataOption('request', false, ''),new weTagDataOption('post', false, ''),new weTagDataOption('get', false, ''), new weTagDataOption('global', false, ''), new weTagDataOption('session', false, ''), new weTagDataOption('top', false, ''), new weTagDataOption('self', false, ''), new weTagDataOption('object', false, ''), new weTagDataOption('document', false, ''), new weTagDataOption('sessionfield', false, ''), new weTagDataOption('calendar', false, ''), new weTagDataOption('listview', false, ''), new weTagDataOption('block', false, ''), new weTagDataOption('listdir', false, '')), false, '');
