...
$l_update["connection_error"]["text"] = "Il ne pas possible de joindre le webEdition-Server (update.webedition.org). Essayer le de nouveau à une date ultérieure.<br><br>Si vous êtes branché par un Server-Proxy, controllez les préférences s'il vous plaît.";
