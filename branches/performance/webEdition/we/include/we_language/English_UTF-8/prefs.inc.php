...
$l_prefs = array(
		...
		'language_notice' => "The language change will only take effect everywhere after restarting webEdition.",
		/**
		 * CHARSET
		 */
	...
	Further information can be found in the online documentation.<br/><br/>Allow execution of hooks?",
		...
		'error_errors' => "Errors",
		'error_notices_warning' => 'Option for developers! Do not activate on live-systems.',
		/**
		 * ERROR DISPLAY
		 */
