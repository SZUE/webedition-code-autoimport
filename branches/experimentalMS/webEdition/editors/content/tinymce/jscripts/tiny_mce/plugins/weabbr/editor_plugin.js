		...
		init: function (e, f) {
			e.addCommand('mceWeabbr', function () {
				...
				e.windowManager.open({
					file: f + '/../../../../../wysiwyg/abbrDialog.php?we_dialog_args[editor]=tinyMce&we_dialog_args[isFrontend]=' + e.getParam('weIsFrontend'),
					popup_css: false,
