...
CREATE TABLE ###TBLPREFIX###tblPrefs (
  ...
  weWidth smallint unsigned NOT NULL default '0',
  weHeight smallint unsigned NOT NULL default '0',
  ...
  editorMode enum ('textarea','codemirror2','java') NOT NULL DEFAULT 'codemirror2',
  editorLinenumbers tinyint(1) unsigned NOT NULL default '1',
  editorCodecompletion varchar(255) NOT NULL default '',
